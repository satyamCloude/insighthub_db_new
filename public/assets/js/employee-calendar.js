  ...
  (function () {
    ...
    function eventClick(info) {
      ...
      if (eventToUpdate.url) {
        ...
        if(eventToUpdate.extendedProps.calendar !='Holiday'){
          ...
          eventDescription.value = eventToUpdate.description;
          eventGuests.value = eventToUpdate.guests;
    ...
    $.ajax({
      ...
      let selectedEvents = response.filter(event => calendars.includes(event.extendedProps.calendar.toLowerCase()));
      // Invoke the success callback with the selected events
      successCallback(selectedEvents);
        ...
        function addEvent(eventData) {
          ...
          calendar.refetchEvents();
           // Convert currentEvents array to a string representation for better readability
            const eventsString = JSON.stringify(currentEvents, null, 2);
            ...
            fetch('store', {
                ...
                headers: {
                    ...
                    'X-CSRF-TOKEN': csrfToken, // Use the correct header for Laravel
        ...
        // ------------------------------------------------
        function updateEventInCalendar(updatedEventData, propsToUpdate, extendedPropsToUpdate) {
