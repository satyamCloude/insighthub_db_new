...
(function () {
  ...
  if (typeof wizardValidation !== undefined && wizardValidation !== null) {
    ...
    const wizardValidationFormStep4 = wizardValidationForm.querySelector('#license-links-validation');
    const wizardValidationFormStep5 = wizardValidationForm.querySelector('#Access-links-validation');
