...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('aws_services', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('aws_account_Id')->nullable();
            ...
            $table->longText('aws_notes')->nullable();
            $table->string('aws_login_url')->nullable();
            $table->string('aws_username')->nullable();
            $table->string('aws_password')->nullable();
