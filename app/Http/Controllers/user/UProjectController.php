...
class UProjectController extends Controller
{
       ...
       //home page
            public function home(Request $request)
            {
               $query = Project::select(
                ...
                return view('user.Project.home', compact('Task', 'InProgress', 'Completed', 'OverDue', 'Cancel','search'));
            }
    ...
    {   
        ...
        $Log['url'] = url('/') . '/user/Task/Create';
        $Log['method'] = "Get";
        $Log['browser'] = $browser . "-" . $version;
        LogActivity::create($Log);

        return view('user.Project.create',compact('Vendor','Employee','Client','Project','ProjectCategory','Department')); 
    }
       ...
       public function store(Request $request)
        {
            ...
            return redirect('user/Project/home')->with('success', 'Project added successfully');
        }
    ...
    public function edit(Request $req,$id)
    {
        ...
        $Log['url'] = url('/') . '/user/Task/edit/'.$id;
        $Log['method'] = "Get";
        $Log['browser'] = $browser . "-" . $version;
        LogActivity::create($Log);

        return view('user.Project.edit',compact('Task','Vendor','Employee','Client','Project','ProjectCategory','Department','id'));
    } 
    ...
    public function view(Request $req,$id)
    {
        ...
        return view('user.Project.view',compact('Task','Vendor','Employee','Client','Project','ProjectCategory','Department','id'));
    }
    ...
    public function update(Request $request, $id)
        {
            ...
            $project['team_id'] = $teamMembers;
            Project::create($project);
            return redirect('user/Project/home')->with('success', 'Project updated successfully');
        }
     ...
     public function delete(Request $request,$id)
    {
        ...
        return redirect('user/Project/home')->with('success', "Project Deleted Successfully");
    }
    ...
    public function EXPORTCSV(Request $request)
    {
         $agent = new Agent();
            ...
            $Log['url'] = url('/') . '/user/Task/EXPORTCSV';
            $Log['method'] = "Get";
            $Log['browser'] = $browser . "-" . $version;
            LogActivity::create($Log);
