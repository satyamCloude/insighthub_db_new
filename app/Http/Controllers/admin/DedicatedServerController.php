...
{   
    ...
    public function home(Request $request)
    {
        ...
        return view('admin.Services.DedicatedServer.home', compact('DedicatedServer','Active','Suspended','Terminated','Total','query'));
    }
    ...
    {   
        ...
        $Log['url'] = url('/') . '/admin/DedicatedServer/Create';
        $Log['method'] = "Get";
        $Log['browser'] = $browser . "-" . $version;
        LogActivity::create($Log);


        return view('admin.Services.DedicatedServer.create',compact('Client','Vendor','Product','OperatingSysten','Currency','PaymentMethod','Country','Rack','Status','public_ip','private_ip','Switchs','firewall','Employee')); 
    }
    ...
    // rack id status change  end
        ...
        $Host['url'] = url('/').'/admin/DedicatedServer/store';
        $Host['method'] = "Post";
        ...
        $Log['url'] = url('/') . '/admin/DedicatedServer/store';
        $Log['method'] = "Post";
        $Log['browser'] = $browser . "-" . $version;
        LogActivity::create($Log);

        
        return redirect('admin/DedicatedServer/home')->with('success', "New DedicatedServer Added Successfully");
    }
    ...
    public function edit(Request $req,$id)
    {
        ...
        $Log['url'] = url('/') . '/admin/DedicatedServer/edit/'.$id;
        $Log['method'] = "Get";
        $Log['browser'] = $browser . "-" . $version;
        LogActivity::create($Log);


        return view('admin.Services.DedicatedServer.edit',compact('DedicatedServer','Client','Vendor','Product','OperatingSysten','Currency','PaymentMethod','Country','Rack','Status','public_ip','private_ip','Switchs','firewall','Employee'));
    }
...
public function update(Request $req, $id)
{
    ...
    $data = DedicatedServer::find($id);
        ...
        $Host['product_id'] = $req->product_id;
        $Host['type'] = "DedicatedServer";
        $Host['url'] = url('/').'/admin/DedicatedServer/update/'.$id;
        $Host['method'] = "Post";
        $Host['billing_cycle'] = $req->billing_cycle;
        $Host['singup'] = $req->signup_date;
        $Host['servicestype'] = $req->service_type;
        ...
        $Log['url'] = url('/') . '/admin/DedicatedServer/update/'.$id;
        $Log['method'] = "Post";
        $Log['browser'] = $browser . "-" . $version;
        LogActivity::create($Log);    

        return redirect('admin/DedicatedServer/home')->with('success', "DedicatedServer Edit Successfully");
    }
     ...
     public function delete(Request $request,$id)
    {
        ...
        $Log['url'] = url('/') . '/admin/DedicatedServer/delete/'.$id;
        $Log['method'] = "Get";
        $Log['browser'] = $browser . "-" . $version;
        LogActivity::create($Log);

        return redirect('admin/DedicatedServer/home')->with('success', "DedicatedServer Deleted Successfully");
    }
    ...
    public function EXPORTCSV(Request $request)
        {
            ...
            $Log['url'] = url('/') . '/admin/DedicatedServer/EXPORTCSV';
            $Log['method'] = "Get";
            $Log['browser'] = $browser . "-" . $version;
            LogActivity::create($Log);
