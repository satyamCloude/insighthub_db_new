...
{
    $query = Switchs::select('switchs.id','switchs.status','users.profile_img','users.email','switchs.service_type','products.product_name','users.first_name','i_p_addresses.ip_address','switchs.signup_date')
    ...
    return view('admin.NetworkManagement.Switchs.home', compact('Switchs', 'Active', 'Suspended', 'Terminated','searchTerm','Total'));
}
    ...
    {   
        ...
        $Log['url'] = url('/') . '/admin/Switchs/Create';
        $Log['method'] = "Get";
        $Log['browser'] = $browser . "-" . $version;
        LogActivity::create($Log);


        return view('admin.NetworkManagement.Switchs.create',compact('Country','Client','Product','Vendor','PaymentMethod','Rack','Employee','primary_public_ip','additional_public_ip','primary_private_ip','additional_private_ip')); 
    }
    ...
    public function store(Request $req)
    {
        $agent = new Agent();
            ...
            $Log['url'] = url('/') . '/admin/Switchs/store';
            $Log['method'] = "Post";
            $Log['browser'] = $browser . "-" . $version;
            LogActivity::create($Log);
        ...
        Switchs::create($data);   
        return redirect('admin/Switchs/home')->with('success', "New Switchs Added Successfully");
    }
    ...
    public function edit(Request $req,$id)
    {
        ...
        $Log['url'] = url('/') . '/admin/Switchs/edit/'.$id;
        $Log['method'] = "Get";
        $Log['browser'] = $browser . "-" . $version;
        LogActivity::create($Log);

    return view('admin.NetworkManagement.Switchs.edit',compact('Switchs','Country','PaymentMethod','Client','Vendor','Employee','Product','Rack','primary_public_ip','additional_public_ip','primary_private_ip','additional_private_ip'));
    }
    ...
    public function update(Request $req,$id)
    {
        ...
        $Log['url'] = url('/') . '/admin/Switchs/update/'.$id;
        $Log['method'] = "Post";
        $Log['browser'] = $browser . "-" . $version;
        LogActivity::create($Log);

        return redirect('admin/Switchs/home')->with('success', "Switchs Edited Successfully");
    }
    // delete leads
     public function delete(Request $request,$id)
    {
        ...
        $Log['url'] = url('/') . '/admin/Switchs/delete/'.$id;
        $Log['method'] = "Get";
        $Log['browser'] = $browser . "-" . $version;
        LogActivity::create($Log);

        Switchs::find($id)->delete();
        return redirect('admin/Switchs/home')->with('success', "Switchs Deleted Successfully");
    }
