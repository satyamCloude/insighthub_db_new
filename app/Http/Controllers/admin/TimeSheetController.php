  ...
  public function home(Request $request)
{
    ...
    return view('admin.Humanesources.TimeSheet.home', compact('TimeSheet','searchTerm'));
}
    ...
    {   
        ...
        $Log['url'] = url('/') . '/admin/TimeSheet/Create';
        $Log['method'] = "Get";
        ...
        // return $Project;
        return view('admin.Humanesources.TimeSheet.create',compact('Employee','Task','Project')); 
    }
    ...
    {   
        ...
        TimeSheet::create($data);
            ...
            $Log['url'] = url('/') . '/admin/TimeSheet/store';
            $Log['method'] = "Post";
            $Log['browser'] = $browser . "-" . $version;
            LogActivity::create($Log);        

        return redirect('admin/TimeSheet/home')->with('success', "New TimeSheet Added Successfully");
    }
    ...
    public function edit(Request $req,$id)
    {
        ...
        $Employee = User::select('first_name','id')->where('type',4)->get();
        $Task = Task::select('task_name as project_name','id')->get();
        $Project = Project::select('project_name','id')->get();
        ...
        $Log['url'] = url('/') . '/admin/TimeSheet/edit/'.$id;
        $Log['method'] = "Get";
        $Log['browser'] = $browser . "-" . $version;
        LogActivity::create($Log);

        return view('admin.Humanesources.TimeSheet.edit',compact('TimeSheet','Employee','Task','Project'));
    }
    ...
    public function update(Request $req,$id)
    {
        ...
        $Log['url'] = url('/') . '/admin/TimeSheet/update/'.$id;
        $Log['method'] = "Post";
        $Log['browser'] = $browser . "-" . $version;
        LogActivity::create($Log);

        return redirect('admin/TimeSheet/home')->with('success', "TimeSheet Edit Successfully");
    }
     ...
     public function delete(Request $request,$id)
    {
        ...
        $Log['url'] = url('/') . '/admin/TimeSheet/delete/'.$id;
        $Log['method'] = "Get";
        $Log['browser'] = $browser . "-" . $version;
        LogActivity::create($Log);

        TimeSheet::find($id)->delete();
        return redirect('admin/TimeSheet/home')->with('success', "TimeSheet Deleted Successfully");
    }
