...
{   
    ...
    public function home(Request $request)
    {
        ...
        return view('admin.Services.Azure.home', compact('Azure','Active','Suspended','Terminated','Total','query'));
    }
    ...
    {  
        ...
        $Log['url'] = url('/') . '/admin/Azure/Create';
        $Log['method'] = "Get";
        $Log['browser'] = $browser . "-" . $version;
        LogActivity::create($Log);

        return view('admin.Services.Azure.create',compact('Client','Vendor','Product','OperatingSysten','Currency','PaymentMethod','Country','Rack','Status','public_ip','private_ip','Switchs','firewall','Employee')); 
    }
    ...
    public function store(Request $req)
    {
        ...
        $Host['type'] = "Azure";
        $Host['url'] = url('/').'/admin/Azure/store';
        $Host['method'] = "Post";
        ...
        return redirect('admin/Azure/home')->with('success', "New Azure Added Successfully");
    }
    ...
    public function edit(Request $req,$id)
    {
        ...
        $Log['url'] = url('/') . '/admin/Azure/edit/'.$id;
        $Log['method'] = "Get";
        $Log['browser'] = $browser . "-" . $version;
        LogActivity::create($Log);


        return view('admin.Services.Azure.edit',compact('Azure','Azure2','Client','Vendor','Product','OperatingSysten','Currency','PaymentMethod','Country','Rack','Status','public_ip','private_ip','Switchs','firewall','Employee'));
    }
...
public function update(Request $req, $id)
{
    $url = url('/').'/public/images/';
        ...
        $Host['product_id'] = $req->product_id;
        $Host['type'] = "Azure";
        $Host['url'] = url('/').'/admin/Azure/update/'.$id;
        $Host['method'] = "Post";
        $Host['billing_cycle'] = $req->billing_cycle;
        $Host['singup'] = $req->signup_date;
        $Host['servicestype'] = $req->service_type;
        ...
        $Log['url'] = url('/') . '/admin/Azure/update/'.$id;
        $Log['method'] = "Post";
        $Log['browser'] = $browser . "-" . $version;
        LogActivity::create($Log);  

        return redirect('admin/Azure/home')->with('success', "Azure Edit Successfully");
    }
     ...
     public function delete(Request $request,$id)
    {
        ...
        $Log['url'] = url('/') . '/admin/Azure/delete/'.$id;
        $Log['method'] = "Get";
        $Log['browser'] = $browser . "-" . $version;
        LogActivity::create($Log);

        return redirect('admin/Azure/home')->with('success', "Azure Deleted Successfully");
    }
    ...
    public function EXPORTCSV(Request $request)
        {
            ...
            $Log['url'] = url('/') . '/admin/Azure/EXPORTCSV';
            $Log['method'] = "Get";
            $Log['browser'] = $browser . "-" . $version;
            LogActivity::create($Log);
