...
{   
    ...
    public function Store(Request $req)
    {
        ...
        $Log['url'] = url('/') . '/admin/PerformanceCategory/store';
        $Log['method'] = "Post";
        $Log['browser'] = $browser . "-" . $version;
        LogActivity::create($Log);

         return view('admin.Humanesources.PerformanceCategory.latestdatat_get', compact('PerformanceCategory'));
    }
    ...
    public function edit(Request $req)
    {
        ...
        $Log['url'] = url('/') . '/admin/PerformanceCategory/edit/'.$req->id;
        $Log['method'] = "Get";
        $Log['browser'] = $browser . "-" . $version;
        LogActivity::create($Log);

         return view('admin.Humanesources.PerformanceCategory.latestdatat_edit', compact('PerformanceCategory'));
    }
    ...
    public function update(Request $req)
    {
        ...
        $Log['url'] = url('/') . '/admin/PerformanceCategory/update/'.$req->id;
        $Log['method'] = "Post";
        $Log['browser'] = $browser . "-" . $version;
        LogActivity::create($Log);
     ...
     public function delete(Request $request)
    {
        ...
        $Log['url'] = url('/') . '/admin/PerformanceCategory/delete/'.$request->id;
        $Log['method'] = "Get";
        $Log['browser'] = $browser . "-" . $version;
        LogActivity::create($Log);
