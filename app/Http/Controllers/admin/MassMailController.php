...
class MassMailController extends Controller
{
    ...
    public function home(Request $request)
    {
        ...
        $Name = '{!!$Name!!}';
        $Email = '{!!$Email!!}';
        return view('admin.sales.MassMail.home', compact('Template','MassMail','Email','Name','Trash','Sent','Draft','query','Star','Client','schedule'));
    }
    ...
    {
        return view('admin.sales.MassMail.add', compact('Client'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if($request->id == '' || $request->id == null)
        {
           ...
           if ($request->has('send') && $request->send == 'public') {
            ...
            MassMail::create($storeData);
             ...
             return redirect('admin/MassMail/home')->with('success', "MassMail Send Successfully");
            ...
            return redirect('admin/MassMail/home')->with('success', "MassMail Save to Draft Successfully");
            }
            ...
            return redirect('admin/MassMail/home')->with('success', "MassMail Scheduled Successfully");
            } 
        }
        ...
        return redirect('admin/MassMail/home')->with('success', "New MassMail Added Successfully");
    }
    ...
    public function show(Request $request)
    {
         ...
         $Header = $Template->template;
         $Footer = $Template->template2;
         return view('admin.sales.MassMail.ViewMails', compact('Show','Header','Footer'));
    }
    ...
    public function update(Request $request,$id)
    {
        ...
        $Update['description'] = $request->description;
        $Update->save();
        return redirect('admin/MassMail/home')->with('success', "MassMail Update Successfully");
    }
   ...
   public function delete(Request $request)
    ...
    {   
        ...
        return view('admin.sales.MassMail.Trash', compact('Trash'));
    }
   ...
   public function SentMails(Request $request)
    {
        ...
        return view('admin.sales.MassMail.SentMails', compact('SentMails'));
    }
    ...
    public function DraftMails(Request $request)
    {
       ...
       return view('admin.sales.MassMail.DraftMails', compact('DraftMails'));
    }
    ...
    public function StarMails(Request $request)
    {
       ...
       return view('admin.sales.MassMail.StarMails', compact('StarMails'));
    }
    ...
    public function Schedule(Request $request)
    {
       ...
       return view('admin.sales.MassMail.Schedule', compact('Schedule'));
    }
    ...
    public function LoadMore(Request $request)
    {
        if($request->type == 'draft'){
         $DraftMails = MassMail::select('subject','star','id','status','to_id','created_at')->where('status',2)->orderBy('created_at', 'desc')->paginate(10);
         return view('admin.sales.MassMail.DrafMore', compact('DraftMails'));
        }

        if($request->type == 'star'){
         $StarMails = MassMail::select('subject','star','id','status','to_id','created_at')->where('star',1)->orderBy('created_at', 'desc')->paginate(10);
         return view('admin.sales.MassMail.StarMore', compact('StarMails'));
        }

        if($request->type == 'trash'){
          $Trash = MassMail::onlyTrashed()->orderBy('created_at', 'desc')->paginate(10); 
          return view('admin.sales.MassMail.TrashMore', compact('Trash'));
        }

        if($request->type == 'schedule'){
          $Schedule = MassMail::select('subject','schedule_date','star','id','status','to_id','created_at')->where('status',3)->where('schedule_date','!=',null)->orderBy('created_at', 'desc')->paginate(10);
            return view('admin.sales.MassMail.ScheduleMore', compact('Schedule'));
        }
        ...
        if($request->type == 'sent'){
           $SentMails = MassMail::select('subject', 'star', 'id', 'status', 'to_id', 'created_at')
            ...
            return view('admin.sales.MassMail.SentMore', compact('SentMails'));
        }
    }
