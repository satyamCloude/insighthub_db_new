...
public function home(Request $request)
{
    ...
    return view('admin.Services.GoogleWorkSpace.home', compact('GoogleWorkSpace', 'Total', 'Active', 'Suspended', 'Terminated', 'searchTerm'));
}
    ...
    {   
        ...
        $Log['url'] = url('/') . '/admin/GoogleWorkSpace/Create';
        $Log['method'] = "Get";
        $Log['browser'] = $browser . "-" . $version;
        LogActivity::create($Log);


        return view('admin.Services.GoogleWorkSpace.create',compact('Client','Vendor','Product','Currency','PaymentMethod','Status','Employee')); 
    }
    ...
    public function store(Request $req)
    {
        ...
        $Host['url'] = url('/').'/admin/GoogleWorkSpace/store';
        $Host['method'] = "Post";
        ...
        $Log['url'] = url('/') . '/admin/GoogleWorkSpace/store';
        $Log['method'] = "Post";
        $Log['browser'] = $browser . "-" . $version;
        LogActivity::create($Log);

        return redirect('admin/GoogleWorkSpace/home')->with('success', "New GoogleWorkSpace Added Successfully");
    }
    ...
    public function edit(Request $req,$id)
    {
        ...
        $Log['url'] = url('/') . '/admin/GoogleWorkSpace/edit/'.$id;
        $Log['method'] = "Get";
        $Log['browser'] = $browser . "-" . $version;
        LogActivity::create($Log);

        return view('admin.Services.GoogleWorkSpace.edit',compact('GoogleWorkSpace','Client','Vendor','Product','Currency','PaymentMethod','Status','Employee'));
    }
...
public function update(Request $req, $id)
{
        ...
        $Host['product_id'] = $req->product_id;
        $Host['type'] = "GoogleWorkSpace";
        $Host['url'] = url('/').'/admin/GoogleWorkSpace/update/'.$id;
        $Host['method'] = "Post";
        $Host['billing_cycle'] = $req->billing_cycle;
        $Host['singup'] = $req->signup_date;
        $Host['servicestype'] = $req->service_type;
        ...
        $Log['url'] = url('/') . '/admin/GoogleWorkSpace/update/'.$id;
        $Log['method'] = "Post";
        $Log['browser'] = $browser . "-" . $version;
        LogActivity::create($Log);    

        return redirect('admin/GoogleWorkSpace/home')->with('success', "GoogleWorkSpace Edit Successfully");
    }
     ...
     public function delete(Request $request,$id)
    {
        ...
        $Log['url'] = url('/') . '/admin/GoogleWorkSpace/delete/'.$id;
        $Log['method'] = "Get";
        $Log['browser'] = $browser . "-" . $version;
        LogActivity::create($Log);

        return redirect('admin/GoogleWorkSpace/home')->with('success', "GoogleWorkSpace Deleted Successfully");
    }
    ...
    public function EXPORTCSV(Request $request)
        {
            ...
            $Log['url'] = url('/') . '/admin/GoogleWorkSpace/EXPORTCSV';
            $Log['method'] = "Get";
            $Log['browser'] = $browser . "-" . $version;
            LogActivity::create($Log);
