...
public function QuotesModuleStore(Request $request,$id)
{
    ...
    return redirect('admin/Settings/home')->with('success', "Template Updated Successfully");
}
...
public function LoginRegisterModuleStore(Request $request,$id)
{
    $url = url('/').'/public/images/';
    $logo_attachmentname = 'logo_attachment.jpg';
...
public function InOfficeModuleStore(Request $request,$id)
{
    $url = url('/').'/public/images/';
    $logo_attachmentname = 'logo_attachment.jpg';
