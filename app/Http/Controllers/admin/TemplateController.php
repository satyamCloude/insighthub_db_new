...
public function home(Request $request)
{
    ...
    {   
        ...
        $Log['url'] = url('/') . '/admin/Template/Create';
        $Log['method'] = "Get";
    ...
    public function store(Request $req)
    {
        ...
        Template::create($data);
            ...
            $Log['url'] = url('/') . '/admin/Template/store';
            $Log['method'] = "Post";
            $Log['browser'] = $browser . "-" . $version;
            LogActivity::create($Log);
    

        return redirect()->back()->with('success', "New Template Added Successfully");
    }
    ...
    public function edit(Request $req,$id)
    {
        ...
        $Log['url'] = url('/') . '/admin/Template/edit/'.$id;
        $Log['method'] = "Get";
        $Log['browser'] = $browser . "-" . $version;
        LogActivity::create($Log);

        $Template = Template::find($id);
        return view('admin.settings.Template.edit',compact('Template'));
    }
    ...
    public function update(Request $req,$id)
    {
        ...
        $Log['url'] = url('/') . '/admin/Template/update/'.$id;
        $Log['method'] = "Post";
        $Log['browser'] = $browser . "-" . $version;
        LogActivity::create($Log);

        return redirect()->back()->with('success', "Template Edit Successfully");
    }
     ...
     public function delete(Request $request,$id)
    {
        ...
        $Log['url'] = url('/') . '/admin/Template/delete/'.$id;
        $Log['method'] = "Get";
        $Log['browser'] = $browser . "-" . $version;
        LogActivity::create($Log);
    ...
    {
        $template = Template::select('template', 'template2')->first($id);
