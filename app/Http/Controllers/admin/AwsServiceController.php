...
{   
    ...
    public function home(Request $request)
    {
        ...
        return view('admin.Services.AwsService.home', compact('AwsService','Active','Suspended','Terminated','query','Total'));
    }
    ...
    {   
        ...
        $Log['url'] = url('/') . '/admin/AwsService/Create';
        $Log['method'] = "Get";
        $Log['browser'] = $browser . "-" . $version;
        LogActivity::create($Log);

        return view('admin.Services.AwsService.create',compact('Client','Vendor','Product','OperatingSysten','Currency','PaymentMethod','Country','Rack','Status','public_ip','private_ip','Switchs','firewall','Employee')); 
    }
    ...
    public function store(Request $req)
    {
        ...
        $Host['url'] = url('/').'/admin/AwsService/store';
        $Host['method'] = "Post";
        ...
        $Log['url'] = url('/') . '/admin/AwsService/store';
        $Log['method'] = "Post";
        $Log['browser'] = $browser . "-" . $version;
        LogActivity::create($Log);

        
        return redirect('admin/AwsService/home')->with('success', "New AwsService Added Successfully");
    }
    ...
    public function edit(Request $req,$id)
    {
        ...
        $Log['url'] = url('/') . '/admin/AwsService/edit/'.$id;
        $Log['method'] = "Get";
        $Log['browser'] = $browser . "-" . $version;
        LogActivity::create($Log);
        ...
        return view('admin.Services.AwsService.edit',compact('AwsService','AwsService2','Client','Vendor','Product','OperatingSysten','Currency','PaymentMethod','Country','Rack','Status','public_ip','private_ip','Switchs','firewall','Employee'));
    }
...
public function update(Request $req, $id)
{
    $url = url('/').'/public/images/';
       ...
       $Host = Host::where('service_id', $id)->where('type', 'AwsService')->first();
        ...
        if ($Host) {
            ...
            $Host->product_id = $req->product_id;
            $Host->type = "AwsService";
            $Host->url = url('/').'/admin/AwsService/update/'.$id;
            $Host->method = "Post";
            $Host->billing_cycle = $req->billing_cycle;
            $Host->singup = $req->signup_date;
            $Host->servicestype = $req->service_type;
        ...
        $Log['url'] = url('/') . '/admin/AwsService/update/'.$id;
        $Log['method'] = "Post";
        $Log['browser'] = $browser . "-" . $version;
        LogActivity::create($Log);  


        return redirect('admin/AwsService/home')->with('success', "AwsService Edit Successfully");
    }
     ...
     public function delete(Request $request,$id)
    {
        ...
        $Log['url'] = url('/') . '/admin/AwsService/delete/'.$id;
        $Log['method'] = "Get";
        $Log['browser'] = $browser . "-" . $version;
        LogActivity::create($Log);


        return redirect('admin/AwsService/home')->with('success', "AwsService Deleted Successfully");
    }
    ...
    public function EXPORTCSV(Request $request)
        {
            ...
            $Log['url'] = url('/') . '/admin/AwsService/EXPORTCSV';
            $Log['method'] = "Get";
            $Log['browser'] = $browser . "-" . $version;
            LogActivity::create($Log);
