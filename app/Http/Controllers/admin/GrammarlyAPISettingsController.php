...
class GrammarlyAPISettingsController extends Controller
{   
     //home page
  public function home(Request $request)
{
    ...
    return view('admin.settings.GramerlyApiSettings.home', compact('Complete','Bulk'));
}
...
public function confirm_password(Request $request)
{
    ...
    public function store(Request $req)
    {
        ...
        return redirect('admin/Security/home')->with('success', "New Security Added Successfully");
    }
