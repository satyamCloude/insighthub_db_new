...
class BuisnessAddressController extends Controller
{
  //home page
  public function home(Request $request)
{
       $CurrencySettings = Currency::get();
        ...
        return view('admin.settings.BuisnessAddress.home', compact('Complete','user_details','CurrencySettings','country'));
}
    ...
    {   
        ...
        $Log['url'] = url('/') . '/admin/BuisnessAddress/Create';
        $Log['method'] = "Get";
        $Log['browser'] = $browser . "-" . $version;
        LogActivity::create($Log);

        return view('admin.settings.BuisnessAddress.create'); 
    }
    ...
    public function store(Request $req)
    {
            ...
            $Log['browser'] = $browser . "-" . $version;
            LogActivity::create($Log);
        return redirect('admin/CurrencySettings/home')->with('success', "New Security Added Successfully");
    }
    ...
    public function edit(Request $req,$id)
    {
        ...
        $Log['url'] = url('/') . '/admin/CurrencySettings/edit/'.$id;
        $Log['method'] = "Get";
        $Log['browser'] = $browser . "-" . $version;
        LogActivity::create($Log);

       $tax = Currency::find($id);
   ...
   public function update(Request $req, $id)
{
    ...
    return redirect('admin/CurrencySettings/home')->with('success', "Currency Settings Edit Successfully");
}
     ...
     public function delete(Request $request,$id)
    {
        ...
        return redirect('admin/CurrencySettings/home')->with('success', "Currency Settings Deleted Successfully");
    }
