   ...
   public function home()
    {
        ...
        return view('admin.Humanesources.Calendar.home', compact('Calendar','Employee'));
    }
    ...
    public function fetchData(Request $req)
    {
        ...
        $calendarEvents = Calendar::all(); // Assuming Calendar is your model
        
        // Fetch events from the Holiday model
        $holidayEvents = Holiday::all(); // Assuming Holiday is your model
        ...
        $formattedHolidayEvents = $holidayEvents->map(function ($event) {
            return [
                ...
                'start' => $event->date,
                'end' => $event->date,
                'allDay' => false, // Assuming all holiday events are all-day events
                'extendedProps' => [
                    'calendar' => 'Holiday',
                    'description' => 'description',
                    'guests' => 'guests',
