...
{  
    ...
    public function store(Request $req)
    {
     ...
     return redirect('admin/Leads/view/'.$req->leads_id)->with('success', 'New File(s) Added Successfully');
     ...
     public function delete(Request $request,$id,$leads_id)
    {
        ...
        return redirect('admin/Leads/view/'.$leads_id)->with('success', 'File Deleted Successfully');
    }
}
