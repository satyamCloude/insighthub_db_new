...
class ELeadsFollowupController extends Controller
{   
    ...
    public function store(Request $req)
        {
            ...
            $Log['url'] = url('/') . '/Employee/LeadsFollowup/store';
            $Log['method'] = "Post";
            $Log['browser'] = $browser . "-" . $version;
            LogActivity::create($Log);
            return redirect('Employee/Leads/home')->with('success', "New Leads Followups Added Successfully");
        }
    ...
    public function edit(Request $request)
    {
        ...
        return view('Employee.sales.Leads.editFollowUp',compact('LeadsFollowup'));
    }
