...
class ESecurityController extends Controller
{   
    //home page
  public function home(Request $request)
{
    ...
    return view('Employee.settings.Security.home', compact('Security','active','Inactive','searchTerm','Total'));
}
    ...
    {   
        ...
        return view('Employee.settings.Security.create'); 
    }
    ...
    public function edit(Request $req,$id)
    {
        ...
        return view('Employee.settings.Security.edit',compact('Security'));
    }
