...
{   
    //home page
         public function home(Request $request)
        {
            ...
            return view('Employee.settings.Role.home', compact('Role', 'active', 'Inactive','Total','searchTerm'));
        }
    ...
    {  
        ...
        $Log['url'] = url('/') . '/Employee/Role/Create';
        $Log['method'] = "Get";
        $Log['browser'] = $browser . "-" . $version;
        LogActivity::create($Log); 

        $Permission = Permission::select('name','guard_name','id')->get();
        return view('Employee.settings.Role.create',compact('Permission')); 
    }
    ...
    public function store(Request $req)
    {
        ...
        foreach ($req->permission_id as $key => $value) {
            ...
            $Log['url'] = url('/') . '/Employee/Role/store';
            $Log['method'] = "Post";
            $Log['browser'] = $browser . "-" . $version;
            LogActivity::create($Log);

        return redirect('Employee/Role/home')->with('success', "New Role Added Successfully");
    }
    ...
    public function edit(Request $req,$id)
    {
        ...
        $Log['url'] = url('/') . '/Employee/Role/edit/'.$id;
        $Log['method'] = "Get";
        $Log['browser'] = $browser . "-" . $version;
        LogActivity::create($Log);
        ...
        $RoleAccess = RoleAccess::
                        ...
                        ->get();
        $Permission = Permission::select('name','guard_name','id')->get();
        return view('Employee.settings.Role.edit',compact('Role','Permission','RoleAccess'));
    }
    ...
    { 
        ...
        $Log['url'] = url('/') . '/Employee/Role/update/'.$id;
        $Log['method'] = "Post";
        $Log['browser'] = $browser . "-" . $version;
        LogActivity::create($Log);


        return redirect('Employee/Role/home')->with('success', "Role Edit Successfully");
    }
     ...
     public function delete(Request $request,$id)
    {
        ...
        $Log['url'] = url('/') . '/Employee/Role/delete/'.$id;
        $Log['method'] = "Get";
        $Log['browser'] = $browser . "-" . $version;
        LogActivity::create($Log);
        ...
        Role::find($id)->delete();
        RoleAccess::where('role_id',$id)->delete();
        return redirect('Employee/Role/home')->with('success', "Role Deleted Successfully");
    }
}
