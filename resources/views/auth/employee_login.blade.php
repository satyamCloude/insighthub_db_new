@php $AppSetting =  \App\Models\AppSetting::select('CompanyLogo','welcometextEmployee','CompanyBannerEmployee')->where('id','1')->first() @endphp
<!DOCTYPE html>
...
<html
  ...
  <head>
    ...
    <style>
      .auth-cover-bg{
        background-image: url('{{$AppSetting->CompanyBannerEmployee}}');
          ...
          <div class="w-px-400 mx-auto">
            ...
            <!-- Logo -->
              <div class="app-brand justify-content-center mb-4 mt-2">
                <a href="{{url('/Employee')}}" class="app-brand-link">
                  <img width="100%" src="{{$AppSetting->CompanyLogo}}">
                </a>
              </div>
              <!-- /Logo -->
              <span class="mb-4" id="welcometext">{!!$AppSetting->welcometextEmployee!!}</span>
    ...
    $(document).ready(function(){
        ...
        $('#welcometext').on('selectstart', function(e) {
            e.preventDefault();
              ...
              @endif
               <form id="formAuthentication" class="mb-3" action="{{url('employee_Login')}}" method="POST">
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3 form-password-toggle">
                  <div class="d-flex justify-content-between">
                    ...
                    <a href="{{url('get-forgot-password')}}">
