...
<div class="app-brand justify-content-center mb-4 mt-2">
    @if($AppSetting)
    <img width="100%" src="{{ $AppSetting->CompanyLogo }}" alt="Company Logo">
    @endif
</div>
<!-- /Logo -->
...
<script>
    $(document).ready(function(){
        $('#welcometext').on('keydown paste mousedown selectstart', function(e) {
            e.preventDefault();
              ...
              @endif
            <form id="formAuthentication" class="mb-3" action="{{url('admin_Login')}}" method="POST">
                @csrf
                <div class="mb-3">
   ...
   <!-- <a href="{{url('/admin/google')}}" class="btn btn-icon btn-label-google-plus me-3">
