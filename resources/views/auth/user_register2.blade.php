      ...
      <div class="authentication-inner row">
        ...
        <div class="d-flex col-12 col-lg-5 align-items-center p-sm-5 p-4">
          <div class="w-px-400 mx-auto">
            ...
            @endif
               <form id="formAuthentication" class="mb-3 my-3" action="{{url('/Resgister')}}" method="POST">
              @csrf
                  <div class="mb-3">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="tel" class="form-control" id="phone" name="phone" placeholder="Enter your Phone" maxlength="12" required />
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" id="companyName" name="company_name" placeholder="Enter your Company Name" required />
                    </div>
