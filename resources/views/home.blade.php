...
<html
  ...
  <head>
    ...
    <link rel="stylesheet" href="{{url('public/assets/vendor/css/pages/front-page.css')}}" />
    <!-- Vendors CSS -->
    <link rel="stylesheet" href="{{url('public/assets/vendor/libs/node-waves/node-waves.css')}}" />

    <link rel="stylesheet" href="{{url('public/assets/vendor/libs/nouislider/nouislider.css')}}" />
    <link rel="stylesheet" href="{{url('public/assets/vendor/libs/swiper/swiper.css')}}" />

    <!-- Page CSS -->

    <link rel="stylesheet" href="{{url('public/assets/vendor/css/pages/front-page-landing.css')}}" />
  ...
  <body>
    <script src="{{url('public/assets/vendor/js/dropdown-hover.js')}}"></script>
    <script src="{{url('public/assets/vendor/js/mega-dropdown.js')}}"></script>
        ...
        <div class="navbar navbar-expand-lg landing-navbar px-3 px-md-4">
          ...
          <div class="navbar-brand app-brand demo d-flex py-0 py-lg-2 me-4">
            ...
            <a href="{{url('/')}}" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bold ms-2 ps-1"><img src="{{url('public/logo/company.png')}}" width="150"></span>
            </a>
          </div>
                  ...
                  <div class="row gy-4">
                    ...
                    <div class="col-lg-4 d-none d-lg-block">
                      <div class="bg-body nav-img-col p-2">
                        <img
                          src="{{url('public/assets/img/front-pages/misc/nav-item-col-img.png')}}"
            ...
            <div class="hero-text-box text-center">
              ...
              <div class="landing-hero-btn d-inline-block position-relative">
                <span class="hero-btn-item position-absolute d-none d-md-flex text-heading"
                  >Join community
                  <img
                    src="{{url('public/assets/img/front-pages/icons/Join-community-arrow.png')}}"
            ...
            <div id="heroDashboardAnimation" class="hero-animation-img">
              <a href="../vertical-menu-template/app-ecommerce-dashboard.html" target="_blank">
                <div id="heroAnimationImg" class="position-relative hero-dashboard-img">
                  <img
                    src="{{url('public/assets/img/front-pages/landing-page/hero-dashboard-light.png')}}"
                    alt="hero dashboard"
                    class="animation-img"
                    data-app-light-img="front-pages/landing-page/hero-dashboard-light.png"
                    data-app-dark-img="front-pages/landing-page/hero-dashboard-dark.png" />
                  <img
                    src="{{url('public/assets/img/front-pages/landing-page/hero-elements-light.png')}}"
                    alt="hero elements"
          ...
          <div class="features-icon-wrapper row gx-0 gy-4 g-sm-5">
            <div class="col-lg-4 col-sm-6 text-center features-icon-box">
              <div class="text-center mb-3">
                <img src="{{url('public/assets/img/front-pages/icons/laptop.png')}}" alt="laptop charging" />
              </div>
            ...
            <div class="col-lg-4 col-sm-6 text-center features-icon-box">
              <div class="text-center mb-3">
                <img src="{{url('public/assets/img/front-pages/icons/rocket.png')}}" alt="transition up" />
              </div>
            ...
            <div class="col-lg-4 col-sm-6 text-center features-icon-box">
              <div class="text-center mb-3">
                <img src="{{url('public/assets/img/front-pages/icons/paper.png')}}" alt="edit" />
              </div>
            ...
            <div class="col-lg-4 col-sm-6 text-center features-icon-box">
              <div class="text-center mb-3">
                <img src="{{url('public/assets/img/front-pages/icons/check.png')}}" alt="3d select solid" />
              </div>
            ...
            <div class="col-lg-4 col-sm-6 text-center features-icon-box">
              <div class="text-center mb-3">
                <img src="{{url('public/assets/img/front-pages/icons/user.png')}}" alt="lifebelt" />
              </div>
            ...
            <div class="col-lg-4 col-sm-6 text-center features-icon-box">
              <div class="text-center mb-3">
                <img src="{{url('public/assets/img/front-pages/icons/keyboard.png')}}" alt="google docs" />
              </div>
                    ...
                    <div class="swiper-slide">
                      <div class="card h-100">
                        <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                          <div class="mb-3">
                            <img
                              src="{{url('public/assets/img/front-pages/branding/logo-1.png')}}"
                              alt="client logo"
                          ...
                          <div class="d-flex align-items-center">
                            <div class="avatar me-2 avatar-sm">
                              <img src="{{url('public/assets/img/avatars/1.png')}}" alt="Avatar" class="rounded-circle" />
                            </div>
                            <div>
                    ...
                    <div class="swiper-slide">
                      <div class="card h-100">
                        <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                          <div class="mb-3">
                            <img
                              src="{{url('public/assets/img/front-pages/branding/logo-2.png')}}"
                              alt="client logo"
                              class="client-logo img-fluid" />
                          </div>
                          <p>
                          ...
                          <div class="d-flex align-items-center">
                            <div class="avatar me-2 avatar-sm">
                              <img src="{{url('public/assets/img/avatars/2.png')}}" alt="Avatar" class="rounded-circle" />
                            </div>
                            <div>
                    ...
                    <div class="swiper-slide">
                      <div class="card h-100">
                        <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                          <div class="mb-3">
                            <img
                              src="{{url('public/assets/img/front-pages/branding/logo-3.png')}}"
                              alt="client logo"
                              class="client-logo img-fluid" />
                          </div>
                          <p>
                          ...
                          <div class="d-flex align-items-center">
                            <div class="avatar me-2 avatar-sm">
                              <img src="{{url('public/assets/img/avatars/3.png')}}" alt="Avatar" class="rounded-circle" />
                            </div>
                            <div>
                    ...
                    <div class="swiper-slide">
                      <div class="card h-100">
                        <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                          <div class="mb-3">
                            <img
                              src="{{url('public/assets/img/front-pages/branding/logo-4.png')}}"
                              alt="client logo"
                              class="client-logo img-fluid" />
                          </div>
                          <p>
                          ...
                          <div class="d-flex align-items-center">
                            <div class="avatar me-2 avatar-sm">
                              <img src="{{url('public/assets/img/avatars/4.png')}}" alt="Avatar" class="rounded-circle" />
                            </div>
                            <div>
                    ...
                    <div class="swiper-slide">
                      <div class="card h-100">
                        <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                          <div class="mb-3">
                            <img
                              src="{{url('public/assets/img/front-pages/branding/logo-5.png')}}"
                              alt="client logo"
                              class="client-logo img-fluid" />
                          </div>
                          <p>
                          ...
                          <div class="d-flex align-items-center">
                            <div class="avatar me-2 avatar-sm">
                              <img src="{{url('public/assets/img/avatars/5.png')}}" alt="Avatar" class="rounded-circle" />
                            </div>
                            <div>
                              <h6 class="mb-0">Eugenia Moore</h6>
                              <p class="small text-muted mb-0">Founder of Hubspot</p>
                    ...
                    <div class="swiper-slide">
                      <div class="card h-100">
                        <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                          <div class="mb-3">
                            <img
                              src="{{url('public/assets/img/front-pages/branding/logo-6.png')}}"
                              alt="client logo"
                              class="client-logo img-fluid" />
                          </div>
                          <p>
          ...
          <div class="swiper-logo-carousel py-4 my-lg-2">
            <div class="swiper" id="swiper-clients-logos">
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <img
                    src="{{url('public/assets/img/front-pages/branding/logo_1-light.png')}}"
                    alt="client logo"
                    class="client-logo"
                ...
                <div class="swiper-slide">
                  <img
                    src="{{url('public/assets/img/front-pages/branding/logo_2-light.png')}}"
                    alt="client logo"
                    class="client-logo"
                ...
                <div class="swiper-slide">
                  <img
                    src="{{url('public/assets/img/front-pages/branding/logo_3-light.png')}}"
                    alt="client logo"
                    class="client-logo"
                ...
                <div class="swiper-slide">
                  <img
                    src="{{url('public/assets/img/front-pages/branding/logo_4-light.png')}}"
                    alt="client logo"
                    class="client-logo"
                ...
                <div class="swiper-slide">
                  <img
                    src="{{url('public/assets/img/front-pages/branding/logo_5-light.png')}}"
                    alt="client logo"
                    class="client-logo"
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="card mt-3 mt-lg-0 shadow-none">
                <div class="bg-label-primary position-relative team-image-box">
                  <img
                    src="{{url('public/assets/img/front-pages/landing-page/team-member-1.png')}}"
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="card mt-3 mt-lg-0 shadow-none">
                <div class="bg-label-info position-relative team-image-box">
                  <img
                    src="{{url('public/assets/img/front-pages/landing-page/team-member-2.png')}}"
                    class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl"
                    alt="human image" />
                </div>
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="card mt-3 mt-lg-0 shadow-none">
                <div class="bg-label-danger position-relative team-image-box">
                  <img
                    src="{{url('public/assets/img/front-pages/landing-page/team-member-3.png')}}"
                    class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl"
                    alt="human image" />
                </div>
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="card mt-3 mt-lg-0 shadow-none">
                <div class="bg-label-success position-relative team-image-box">
                  <img
                    src="{{url('public/assets/img/front-pages/landing-page/team-member-4.png')}}"
                    class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl"
                    alt="human image" />
                </div>
          ...
          <div class="text-center mb-5">
            <div class="position-relative d-inline-block pt-3 pt-md-0">
              ...
              <div class="pricing-plans-item position-absolute d-flex">
                <img
                  src="{{url('public/assets/img/front-pages/icons/pricing-plans-arrow.png')}}"
          ...
          <div class="row gy-4 pt-lg-3">
              ...
              <div class="card">
                <div class="card-header">
                  <div class="text-center">
                    <img
                      src="{{url('public/assets/img/front-pages/icons/paper-airplane.png')}}"
            ...
            <div class="col-xl-4 col-lg-6">
              <div class="card border border-primary shadow-lg">
                <div class="card-header">
                  <div class="text-center">
                    <img src="{{url('public/assets/img/front-pages/icons/plane.png')}}" alt="plane icon" class="mb-4 pb-2" />
            ...
            <div class="col-xl-4 col-lg-6">
              <div class="card">
                <div class="card-header">
                  <div class="text-center">
                    <img
                      src="{{url('public/assets/img/front-pages/icons/shuttle-rocket.png')}}"
          ...
          <div class="row gy-3">
            <div class="col-sm-6 col-lg-3">
              <div class="card border border-label-primary shadow-none">
                <div class="card-body text-center">
                  <img src="{{url('public/assets/img/front-pages/icons/laptop.png')}}" alt="laptop" class="mb-2" />
            ...
            <div class="col-sm-6 col-lg-3">
              <div class="card border border-label-success shadow-none">
                <div class="card-body text-center">
                  <img src="{{url('public/assets/img/front-pages/icons/user-success.png')}}" alt="laptop" class="mb-2" />
            ...
            <div class="col-sm-6 col-lg-3">
              <div class="card border border-label-info shadow-none">
                <div class="card-body text-center">
                  <img src="{{url('public/assets/img/front-pages/icons/diamond-info.png')}}" alt="laptop" class="mb-2" />
            ...
            <div class="col-sm-6 col-lg-3">
              <div class="card border border-label-warning shadow-none">
                <div class="card-body text-center">
                  <img src="{{url('public/assets/img/front-pages/icons/check-warning.png')}}" alt="laptop" class="mb-2" />
        ...
        <div class="container">
          ...
          <div class="row gy-5">
            <div class="col-lg-5">
              <div class="text-center">
                <img
                  src="{{url('public/assets/img/front-pages/landing-page/faq-boy-with-logos.png')}}"
        ...
        <div class="container">
          <div class="row align-items-center gy-5 gy-lg-0">
            ...
            <div class="col-lg-6 pt-lg-5 text-center text-lg-end">
              <img
                src="{{url('public/assets/img/front-pages/landing-page/cta-dashboard.png')}}"
                alt="cta dashboard"
                class="img-fluid" />
            </div>
          </div>
          ...
          <div class="row gy-4">
            <div class="col-lg-5">
              <div class="contact-img-box position-relative border p-2 h-100">
                <img
                  src="{{url('public/assets/img/front-pages/landing-page/contact-customer-service.png')}}"
          ...
          <div class="row gx-0 gy-4 g-md-5">
            ...
            <div class="col-lg-3 col-md-4">
              ...
              <a href="javascript:void(0);" class="d-block footer-link mb-3 pb-2"
                ><img src="{{url('public/assets/img/front-pages/landing-page/apple-icon.png')}}" alt="apple icon"
              /></a>
              <a href="javascript:void(0);" class="d-block footer-link"
                ><img src="{{url('public/assets/img/front-pages/landing-page/google-play-icon.png')}}" alt="google play icon"
              /></a>
            </div>
          </div>
        </div>
        ...
        <div
          ...
          <div>
            <a href="https://github.com/pixinvent" class="footer-link me-3" target="_blank">
              <img
                src="{{url('public/assets/img/front-pages/icons/github-light.png')}}"
                alt="github icon"
            ...
            <a href="https://www.facebook.com/pixinvents/" class="footer-link me-3" target="_blank">
              <img
                src="{{url('public/assets/img/front-pages/icons/facebook-light.png')}}"
                alt="facebook icon"
            ...
            <a href="https://twitter.com/pixinvents" class="footer-link me-3" target="_blank">
              <img
                src="{{url('public/assets/img/front-pages/icons/twitter-light.png')}}"
                alt="twitter icon"
            ...
            <a href="https://www.instagram.com/pixinvents/" class="footer-link" target="_blank">
              <img
                src="{{url('public/assets/img/front-pages/icons/instagram-light.png')}}"
                alt="google icon"
    ...
    <!-- Vendors JS -->
    <script src="{{url('public/assets/vendor/libs/nouislider/nouislider.js')}}"></script>
    <script src="{{url('public/assets/vendor/libs/swiper/swiper.js')}}"></script>

    <!-- Main JS -->
    <script src="{{url('public/assets/js/front-main.js')}}"></script>

    <!-- Page JS -->
    <script src="{{url('public/assets/js/front-page-landing.js')}}"></script>
  </body>
</html>
