            ...
            <div class="card-body">
              ...
              <div class="row mb-4"> 
                <div class="col-md-6">
                      ...
                      <input type="text" class="form-control" name="first_name" placeholder="ABC" required/>
                </div>
                <div class="col-md-6">
                      <label for="last_name" class="form-label">Last name <span class="text-danger">*</span></label>
                      <input type="text" class="form-control" name="last_name" placeholder="+ABC" required/>
                </div>
              </div>
              <div class="row mb-4"> 
                <div class="col-md-6">
                      ...
                      <select name="customer_name" class="form-select" required>
                          @foreach($vendor as $vendors)
                              <option value="{{ $vendors->id }}">
                                  {{ $vendors->first_name }} {{ $vendors->last_name }} -> {{ $vendors->email }}
                              </option>
                          @endforeach
                      </select>
                </div>
              ...
              <div class="row newa1 mb-4"> 
                ...
                <!-- <div class="col-md-1">
                      ...
                      <input type="number"  class="form-control" name="total[]" placeholder="01" required/>
                </div> -->
                <div class="col-md-1">
        ...
        <div class="modal-body">
          <div class="row">
            <div class="col mb-3">
              ...
              <select name="Products_id" class="form-select" id="productservices" required>
          ...
          <div class="row g-2">
            <div class="col mb-3">
              ...
              <select name="billing_cycle" id="mod_billing_cycle" class="form-select" required>
