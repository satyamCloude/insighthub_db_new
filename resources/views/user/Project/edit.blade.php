        ...
        <div class="card">
          <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row">
            ...
            <div class="action-btns">
              <a href="{{url('user/Project/home')}}" class="btn btn-label-primary me-3">
                <span class="align-middle"> Back</span>
              </a>
            </div>
          </div>
         <form action="{{ url('user/Project/update/'.$id) }}" method="post" enctype="multipart/form-data">
             @csrf
            <div class="card-body">
              ...
              <div class="row mb-4"> 
                <div class="col-md-6">
                      ...
                      <input type="text" class="form-control" name="project_name" @if($Task && $Task->project_name) value="{{$Task->project_name}}" @endif required/>
                </div>
               <div class="col-md-6">
                      <label for="start_date" class="form-label">Start Date <span class="text-danger">*</span></label>
                      <!-- <input type="date" class="form-control" name="start_date"  required/> -->
                      <input type="date" class="form-control" name="start_date"  @if($Task && $Task->project_name) value="{{ $Task->start_date }}" @endif required/>
              ...
              <div class="row mb-4"> 
                <div class="col-md-6 " id="deadline_date">
                      ...
                      <input type="date" class="form-control" name="deadline"  @if($Task && $Task->project_name) value="{{ $Task->deadline }}" @endif required/>
              ...
              <div class="row mb-4"> 
                ...
                <div class="col-md-4">
                      ...
                      <div class="input-group">
                                     <select class="form-control select-picker" name="department_id" id="user_department" data-live-search="true">
                                      <option value="">--</option>
          ...
          <div class="row mb-4"> 
                <div class="col-md-6">
                    ...
                    <div class="editor-container" style="height:100px">
                        <div class="full-editor geteditor">{!! $Task ? $Task->project_summary : '' !!}</div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="editor-container">
                        <div class="full-editor geteditor">{!! $Task ? $Task->notes : '' !!}</div>
              ...
              <div class="row mb-4"> 
                <div class="col-md-12" id="add_project_mem">
                      <label for="Document"class="form-label">Add Project Members</label>
                      <div class="input-group">
                       <select class="form-control form-select select2" name="team_id[]" multiple="multiple" required>
                          @foreach($user as $emp)
                              <option value="{{ $emp->id }}" {{ in_array($emp->id, explode(',', $Task->team_id)) ? 'selected' : '' }}>
                                  {{ $emp->first_name }}
                              </option>
                          @endforeach
                      </select>
              ...
              <div class="row mb-4"> 
                     ...
                     <i class="fa fa-caret-down" id="caret_icon"></i> Other Details
                        ...
                        @if($Task && $Task->document)
                            <p>Current File: <a href="{{ $Task->document }}" target="_blank">{{ basename($Task->document) }}</a></p>
                        @endif
                    </div>
            ...
            <div class="card-footer">
              <div class="row mb-4"> 
                <div class="col-md-6 text-end" >
                  <a href="{{url('user/Task/home')}}" type="button" class="btn btn-outline-danger">Discard</a>
                </div>
                <div class="col-md-6">
