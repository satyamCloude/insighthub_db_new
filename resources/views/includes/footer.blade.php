...
<!--/tostr-->
    ...
    <script src="{{url('public/assets/vendor/libs/dropzone/dropzone.js')}}"></script>
    <script src="{{url('public/assets/vendor/libs/sweetalert2/sweetalert2.js')}}"></script>
    <script src="{{url('public/assets/vendor/libs/block-ui/block-ui.js')}}"></script>
    <script src="{{url('public/assets/vendor/libs/quill/katex.js')}}"></script>
    <script src="{{url('public/assets/vendor/libs/quill/quill.js')}}"></script>
    <script src="{{url('public/assets/vendor/libs/autosize/autosize.js')}}"></script>
    <script src="{{url('public/assets/vendor/libs/bootstrap-maxlength/bootstrap-maxlength.js')}}"></script>
    <script src="{{url('public/assets/vendor/libs/jquery-repeater/jquery-repeater.js')}}"></script>
    <script src="{{url('public/assets/vendor/libs/bs-stepper/bs-stepper.js')}}"></script>
    <script src="{{url('public/assets/vendor/libs/bootstrap-select/bootstrap-select.js')}}"></script>
    <script src="{{url('public/assets/vendor/libs/fullcalendar/fullcalendar.js')}}"></script>
    ...
    <script src="{{url('public/assets/vendor/libs/jquery-timepicker/jquery-timepicker.js')}}"></script>
    <script src="{{url('public/assets/vendor/libs/pickr/pickr.js')}}"></script>


    <!-- Main JS -->
    <script src="{{url('public/assets/js/main.js')}}"></script>
    <!-- <script src="{{url('public/assets/js/app-ecommerce-dashboard.js')}}"></script> -->
    <script src="{{url('public/assets/vendor/libs/moment/moment.js')}}"></script>
    <script src="{{url('public/assets/vendor/libs/select2/select2.js')}}"></script>
    ...
    <script src="{{url('public/assets/vendor/libs/chartjs/chartjs.js')}}"></script>
    <script src="{{url('public/assets/vendor/libs/toastr/toastr.js')}}"></script>
    <!-- Page JS -->
    <script src="{{url('public/assets/js/dashboards-analytics.js')}}"></script>
    <script src="{{url('public/assets/js/app-user-list.js')}}"></script>
    <script src="{{url('public/assets/js/forms-file-upload.js')}}"></script>
   
    <script src="{{url('public/assets/js/modal-edit-user.js')}}"></script>
    <!-- <script src="{{url('public/assets/js/app-user-view.js')}}"></script> -->
    <script src="{{url('public/assets/js/app-user-view-account.js')}}"></script>
    <script src="{{url('public/assets/js/app-user-view-security.js')}}"></script>
  
    <script src="{{url('public/assets/js/ui-toasts.js')}}"></script>
    <script src="{{url('public/assets/js/extended-ui-blockui.js')}}"></script>
    <script src="{{url('public/assets/js/forms-editors.js')}}"></script>
    <script src="{{url('public/assets/js/forms-extras.js')}}"></script>
    <script src="{{url('public/assets/js/form-wizard-numbered.js')}}"></script>
    <script src="{{url('public/assets/js/form-wizard-validation.js')}}"></script>
    <script src="{{url('public/assets/js/app-email.js')}}"></script>
    <script src="{{url('public/assets/js/forms-pickers.js')}}"></script>
    <script src="{{url('public/assets/js/ui-carousel.js')}}"></script>

    <script src="{{url('public/assets/js/charts-chartjs.js')}}"></script>
    
    <script src="{{url('public/assets/js/employee-calendar.js')}}"></script>
 

    <script>
      $.fn.dataTable.ext.errMode = 'throw';
    </script>
    <script src="{{url('public/assets/js/app-chat.js')}}"></script>
     <script src="{{url('public/assets/js/wizard-ex-checkout.js')}}"></script>
...
generatedLeadsChartConfig = {
 ...
 series: [{{$completeEfficiency}},{{$inProgressEfficiency}}],
 colors: [
