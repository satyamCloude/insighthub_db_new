		...
		<!-- User Sidebar -->
					...
					<div class="info-container">
						<ul class="list-unstyled">
							...
							<div class="d-flex justify-content-center">
								<a href="{{url('admin/Client/edit/'.$id)}}"
			...
			<div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
                ...
                <div class="row mt-4">
					...
					<!--		<div class="card-body">-->
				 <!--               <form class="formChangePassword2" id="formChangePassword2" method="POST" action="{{ url('admin/Client/changePassword/'.$id) }}">-->
     <!--                               @csrf-->
        						        ...
        						        @foreach($teamMembers as $team)
        							        <tr >
												...
												<td class="text-truncate ">
												    ...
												    <a href="javascript:void(0)" class="delete_debtcase" url="{{url('admin/Client/deleteTeam/'.$team->id)}}" ><i class="fa fa-trash"></i></a>
												</td>
											</tr>
        							    @endforeach
							        </tbody>
			...
			<div class="row">
				<div class="col-xl-12 col-lg-12 col-md-12 order-1 order-md-0">
					<div class="card mb-4">
						<div class="card-header d-flex justify-content-between">
						    <h5>Recent Quotes</h5>
						    <a href="{{url('admin/Quotes/add')}}" class="btn btn-primary">Create Quote</a>
						</div>
				...
				<div class="col-xl-12 col-lg-12 col-md-12 order-1 order-md-0">
					<div class="card mb-4">
					    <div class="card-header d-flex justify-content-between">
						    ...
						    <a class="btn btn-primary" href="{{url('admin/Invoices/add')}}" class="card-header">Create Invoice</a>
					    </div>
						<div class="card-body">
					...
					<div class="card mb-4">
						...
						<div class="card-body">
                               ...
                               @if($user && $user->google2fa_enabled)
                                    <a href="{{url('admin/Client/2fa/disable?id='.$user->id)}}" >
                                        <button class="btn btn-danger">Disable</button>
                                    </a>
                                    @else
                                     <a href="{{url('admin/Client/2fa/enable?id='.$user->id)}}" >
...
<div class="modal fade" id="add-member" tabindex="-1" aria-labelledby="paymentModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content ">
            <form action="{{url('admin/Client/storeTeam')}}" method="post" enctype="multipart/form-data">
                @csrf
...
<div class="modal fade" id="add-credits" tabindex="-1" aria-labelledby="paymentModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content ">
            <form action="{{url('admin/Client/Credits/store')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="modal-header">
...
<div class="modal fade" id="edit-member" tabindex="-1" aria-labelledby="paymentModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content ">
            <form action="{{url('admin/Client/updateTeam')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="modal-header">
...
<script>
    ...
    $('#editTeam').click(function(){
        ...
        $.ajax({
            url: "{{url('admin/Client/editTeam')}}/"+id,
