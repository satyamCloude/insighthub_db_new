              ...
              <tr class="odd">
                  ...
                  <td>
                    <div class="btn-group">
                          ...
                          <ul class="dropdown-menu dropdown-menu-end" style="">
                            <li><a class="dropdown-item" onclick="EditProductSettings({{$user->id}})">Edit</a></li>
                            <li><button class="dropdown-item delete_1" url="{{url('admin/Product/delete/'.$user->id)}}" id="{{$user->id}}">Delete</button></li>
                          </ul>
                      </div>
                  </td>
              </tr>
