    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <form action="{{url('admin/Notice/update/'.$edit->id)}}" method="post" enctype="multipart/form-data"> 
            @csrf
            <div class="card-body">
            ...
            <div class="card-footer">
              <div class="row mb-4"> 
                <div class="col-md-6 text-end" >
                  <a href="{{url('admin/Notice/home')}}" type="button" class="btn btn-outline-danger">Discard</a>
                </div>
                <div class="col-md-6">
