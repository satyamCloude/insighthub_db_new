                ...
                <tbody><tr class="inv-unpaid">
                    <td class="f-14 text-dark">
                        ...
                        <td align="right" class="mt-2 mt-lg-0 mt-md-0">
                            @if ($Quotes->is_payment_received == 0)
                            <span class="unpaid rounded f-15">Unpaid</span>
                            @elseif ($Quotes->is_payment_received == 1)
                                                        ...
                                                        <td colspan="5" class="border-bottom-0">
                                                            rty
                                                                                            ...
                                                                                            <table class="inv-note" width="100%">
                                                                                                <tbody><tr>
                                                                                                    <td align="end" height="30" colspan="2"><img src="{{$Quotes->signature}}"  class="mt-2 mb-2" height="70" width="15%"></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td>Note</td>
                                                 ...
                                                 $(window).on('load', function() {
                                                     setTimeout(function() {
                                                         ...
                                                         if (window.matchMedia('print').matches) {
                                                             window.location.href = '{{url("admin/Quotes/home")}}';
                                                         } else {
                                                             window.location.href = '{{url("admin/Quotes/home")}}';
                                                         }
                                                     }, 1000); // Delaying execution for 1 second (adjust if needed)
                                                 });
                                                 </script>
                                            </body>
                                            </html>
