              ...
              <div class="col-8">
                <div class="me-2">
                  <h6 class="mb-1 color_head">My Performance</h6>
                    ...
                    $shiftHours = $workingHoursData->shift_hours ?? 1;
                                        ...
                                        if ($attendanceDays >= 2 && $attendanceDays <= 10) {
                                            ...
                                            $attendanceRating = 50;
                                        } elseif ($attendanceDays >= 20 && $attendanceDays <= 25) {
                                            $attendanceRating = 75;
                                        } elseif ($attendanceDays >= 26) {
        ...
        <div id="DataTables_Table_3_wrapper" class="dataTables_wrapper dt-bootstrap5">
          <div class="row">
            <div class="col-sm-12 col-md-6">
                                 <form id="filterForm" action="{{ url('admin/Performance/view/'.$id) }}" method="GET">
            ...
            @if(count($Performance) > 0)
                @foreach($Performance as $key => $user)
                    <tr class="odd">
                        ...
                        <!--         width="30"-->
                        <!--         alt="User avatar" />-->
                        <!--    <a href="{{ url('admin/Performance/view/'.$user->id) }}">{{ $user->first_name }}</a>-->
...
if ($workingHoursData && $workingHoursData->working_days > 0) {
    ...
    if ($shiftHours > 0) {
      ...
      <div class="col-lg-8 mb-4 order-md-0 order-lg-0 mt-4">
        <div class="card h-100">
...
<script>
                            $(document).ready(function () {
                               ...
                               var calpercnt = {{ $calpercnt }}; 
                                var color = '#FF5733'; // Example color
                                var show = 'true'; // or 'false'
    ...
    const radialBarChartOpt = {
        ...
        series: [calpercnt], // Ensure this is correct
