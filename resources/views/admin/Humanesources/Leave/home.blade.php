...
<div class="container-xxl flex-grow-1 container-p-y">
   ...
   <div class="row g-4 mb-4 d-flex" style="justify-content:center;">
      <div class="col-sm-3 col-xl-3">
         <a href="{{url('admin/Leave/home?status=0')}}">
            <div class="card">
               <div class="card-body">
      ...
      <div class="col-sm-3 col-xl-3">
         <a href="{{url('admin/Leave/home?status=1')}}">
            <div class="card">
               <div class="card-body">
                  <div class="d-flex align-items-start justify-content-between">
                     <div class="content-left">
      ...
      <div class="col-sm-3 col-xl-3">
         <a href="{{url('admin/Leave/home?status=2')}}">
            <div class="card">
               <div class="card-body">
                  <div class="d-flex align-items-start justify-content-between">
                     <div class="content-left">
      ...
      <div class="col-sm-3 col-xl-3">
         <a href="{{url('admin/Leave/home?status=3')}}">
            <div class="card">
               <div class="card-body">
                  <div class="d-flex align-items-start justify-content-between">
                     <div class="content-left">
   ...
   <div class="card mt-2">
      <div class="row">
         ...
         <div class="col-md-6 text-end">
            <a href="{{url('admin/Leave/home')}}" class="btn btn-warning mt-3 m-3"><i class="fas fa-sync-alt"></i></a>
            <a href="{{url('admin/Leave/add')}}" class="btn btn-primary mt-3 m-3">Add Leave</a>
         </div>
      </div>
...
<div class="modal fade" id="backDropModal" data-bs-backdrop="static" tabindex="-1" style="display: none;" aria-modal="true" role="dialog">
   <div class="modal-dialog">
      <form class="modal-content" action="{{url('admin/LeaveType/store')}}" method="post">
         @csrf
