...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <!--                                @if($key > 4)-->
    <!--                                <a class="fs-6 me-1 text-danger delete_debtcase" url="{{url('admin/Department/delete/'.$department->id)}}"><i class="fa fa-trash"></i></a>-->
    <!--                                @endif-->
    <!--                            </div>-->
    <!--                        </div>-->
    <!--                    </div>-->
...
<div class="modal fade" id="edit-department" data-bs-backdrop="static" tabindex="-1" style="display: none;" aria-modal="true" role="dialog">
  <div class="modal-dialog">
    <form class="modal-content" action="{{url('admin/Department/update')}}" method="post" enctype="multipart/form-data">
      @csrf
