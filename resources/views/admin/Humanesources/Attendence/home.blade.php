      ...
      <div class="col-lg-3">
         <div class="card h-100">
            <div class="card-body">
               ...
               <p class="mb-2 mt-1">{{$averageWorkingHours}}</p>
               <div class="pt-1">
      ...
      <div class="col-lg-3">
         <div class="card h-100">
            <div class="card-body">
               ...
               <!--<small class="text-muted">Last week</small>-->
               <p class="mb-2 mt-1">{{$totalOvertime}}</p>
               <div class="pt-1">
      ...
      <div class="col-lg-3">
         <div class="card h-100">
            <div class="card-body">
               ...
               <!--<small class="text-muted">Last week</small>-->
               <p class="mb-2 mt-1">{{$onTimeArrivals}}</p>
               <div class="pt-1">
      ...
      <div class="col-lg-3">
         <div class="card h-100">
            <div class="card-body">
               ...
               <!--<small class="text-muted">Last week</small>-->
               <p class="mb-2 mt-1">{{$totalProductionHours}}</p>
               <div class="pt-1">
   ...
   <div class="card mt-4">
      <div class="row">
         ...
         <div class="col-md-6 text-end">
            <!-- <a href="{{url('admin/Attendence/home')}}" class="btn btn-warning mt-3 m-3"><i class="fas fa-sync-alt"></i></a> -->
            <form action="{{ url('admin/Attendence/fetch') }}" method="POST" class="d-inline">
                @csrf
            ...
            <a href="{{url('admin/Attendence/add')}}" class="btn btn-primary mt-3 m-3">Add</a>
         </div>
      </div>
                  ...
                  <tr>
                     ...
                     <td>
                        <div class="parent d-flex">
                           ...
                           <div class="child2">
                              <a href="{{ url('admin/Attendence/View/'.$user->emp_id) }}">
                     ...
                     <td>
                        {{ isset($user->break_seconds) ? floor($user->break_seconds / 3600) . 'h ' . floor(($user->break_seconds % 3600) / 60) . 'min ' . ($user->break_seconds % 60) . 'sec' : '0h 0min 0sec' }}
                     </td>
                     <td>
                        {{ isset($totalOvertimeFormatted) ? $totalOvertimeFormatted : '0h 0min 0sec' }}
                     </td>
                     <td>
                        {{ isset($totalProductionFormatted) ? $totalProductionFormatted : '0h 0min 0sec' }}
                     </td>
                     <td><a href="{{ url('admin/Attendence/View/'.$user->emp_id) }}"><i class="fa fa-eye"></i></a></td>
                  </tr>
                  @endforeach
                  @else
                  <tr>
                        ...
                        <tr>
                           ...
                           <td>
                              <div class="d-flex align-items-center">
                                 <img class="rounded-circle me-2" src="{{ $user->profile_img }}" alt="User avatar" width="30" height="30">
                                 <div>
                                    <a href="{{ url('admin/Attendence/View/'.$user->emp_id) }}">{{ $user->first_name.' '.$user->last_name }}</a>
                                    <div class="small text-muted">{{ $jobrole->name ?? '' }}</div>
                                 </div>
                              </div>
                           </td>
                           <td>
                              ...
                              <div class="small text-muted">
                                 ({{ \Carbon\Carbon::parse($user->ts_working_hrs)->format('G:i').'Hr' }})
                              </div>
                           </td>
                           <td>{{ $totalWorkedHours }}</td>
                           <td>{{ $totalBreakTime }}</td>
                           <td>{{ $totalOvertime }}</td>
                           <td>{{ $totalProductionTime }}</td>
                           <td><a href="{{ url('admin/Attendence/View/'.$user->emp_id) }}"><i class="fa fa-eye"></i></a></td>
                        </tr>
                     @endforeach
                  @else
