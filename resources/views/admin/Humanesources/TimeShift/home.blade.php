  ...
  <div class="card">
    <div class="row">
      ...
      <div class="col-md-6 text-end">
            <a href="{{url('admin/TimeShift/roaster')}}" class="btn btn-info mt-3 m-3">Shift Roaster</a>
            <a href="{{url('admin/TimeShift/add')}}" class="btn btn-primary mt-3 m-3">Add</a>
            <a href="{{url('admin/TimeShift/home')}}" class="btn btn-warning mt-3 m-3"><i class="fas fa-sync-alt"></i></a>
                        ...
                        <td>
                            <div class="btn-group">
                              ...
                              <ul class="dropdown-menu dropdown-menu-end" style="">
                                <li><a class="dropdown-item" href="{{url('admin/TimeShift/edit/'.$user->id)}}">Edit</a></li>
                                <li><button class="dropdown-item delete_debtcase" url="{{url('admin/TimeShift/delete/'.$user->id)}}" id="{{$user->id}}">Delete</button></li>
                              </ul>
                            </div>
                        </td>
                    </tr>
