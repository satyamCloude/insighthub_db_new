  ...
  <div class="card">
    <div class="row">
      ...
      <div class="col-md-6 text-end">
         <a href="{{url('admin/TimeSheet/home')}}" class="btn btn-warning mt-3 m-3"><i class="fas fa-sync-alt"></i></a>
          <a href="{{url('admin/TimeSheet/add')}}" class="btn btn-primary mt-3 m-3">Add</a>
      </div>
    </div>
