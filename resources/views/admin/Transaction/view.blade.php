                        ...
                        <table width="100%">
                            ...
                            <tr class="inv-num">
                                <td class="f-14 text-dark">
                                    <p class="mt-3 mb-0">{{$InvoiceDetails->company_name}}<br>
                                         @if($InvoiceSettings->show_client_company_name ==1)
                                                {{$Company->company_name}}
                                            @endif<br> 
                                           
                                        {{$Company->contact_no}}<br></p><br>
                                </td>
                                <td align="right">
                            ...
                            <tbody><tr class="inv-unpaid">
                               <td class="f-14 text-dark">
                                        <p class="mb-0 text-left">
                                            ...
                                            {{ $InvoiceDetails->pincode }}<br>
                                        </p>
                                    </td>
                                    <td align="right" class="mt-2 mt-lg-0 mt-md-0">
                                            @if($InvoiceSettings->show_status==1)
                                                    <input type="hidden" value="{{ $InvoiceDetails->is_payment_recieved }}" id="is_payment_recieved">
                                                    @if ($InvoiceDetails->is_payment_recieved == 0)
                                                    <span class="unpaid rounded f-15">Unpaid</span>
                                                    @elseif ($InvoiceDetails->is_payment_recieved == 1)
                                    ...
                                    <table class="inv-detail f-14 table-responsive-sm" width="100%">
                                       ...
                                       @foreach($InvoiceDetailsAll as $order)
                                                    <tr class="text-dark font-weight-semibold f-13">
                                                        ...
                                                        <td align="right">
                                                        @php 
                                                            $Tax = \App\Models\TaxSetting::whereIn('id', explode(',',$order->taxes))->get(); 
