                  ...
                  <div class="col-md-4">
                      <select class="form-control select2" name="services_id" required id="services">
                          ...
                          @foreach($ProductNew as $Employee)
                              <option @if($SelectedOrders && $SelectedOrders->product_id == $Employee->id) selected @endif value="{{ $Employee->id }}">{{ $Employee->product_name }}</option>
                          @endforeach
                      </select>
                  </div>
                  ...
                  <div class="col-md-4" id="get_service_orders">
                      <select name="services_type" id="services_type" required class="form-control select2" style="display: none;">
                          ...
                          @foreach($orders as $order)
                              <option @if($selected_order_id == $order->id) selected @endif value="{{ $order->id }}">
                                  Order ID - {{ $order->id }}
                              </option>
                          @endforeach
                      </select>
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td class="border-bottom-0 btrr-mbl btlr">
                              ...
                              placeholder="Item Name" autocomplete="off" @if($SelectedOrders && $SelectedOrders->order_type == 'client_order') value="{{$SelectedOrders->product_name}} + Acronis" @endif  required>
                            </td>
                            ...
                            <td class="border-bottom-0">
                                <input type="number" min="1" class="f-14 border-0 w-100 text-right cost_per_item form-control"
                                       value="@if($SelectedOrders && $SelectedOrders->total_amt){{ $SelectedOrders->total_amt }}@else 0.00 @endif"
