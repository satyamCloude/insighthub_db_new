                    ...
                    <a href="{{url('admin/Client/view/'.$Inventor->id)}}">   
                          ...
                          <div class="child2">{{ $Inventor->first_name }} {{ $Inventor->last_name }}   ({{$Inventor->users_id}}) <br>{{ $Inventor->companys_name }}</div>
                                    ...
                                    <td>
                                        ...
                                        @if($Inventor && $Inventor->amtWithoutGST) 

                                        {{ number_format($Inventor->amtWithoutGST,2) }} 
                                  ...
                                  @foreach ($taxes as $tax)
                                                ...
                                                <td width="10%" align="left" valign="top"
                                                    style="padding:2px 0;">
                                                    <span
                                                        style="margin-left:4px;">{{ $rate > 0 ? number_format(($Inventor->amtWithoutGST * $rate) / 100, 2) : '0.00' }}
                                                         </span>
                                                </td>
                                            @endforeach
                           </tr>
