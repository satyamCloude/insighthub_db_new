                              ...
                              <table class="inv-num-date text-dark f-13 mt-3">
                                 <tbody>
                                    <tr>
                                       ...
                                       <td class="border-left-0">@if($Invoice && $Invoice->invoice_number1 && $Invoice->invoice_number2) {{$Invoice->invoice_number1.$Invoice->invoice_number2}}@endif</td>
                                    </tr>
                                    <tr>
                                       <td class="bg-light-grey border-right-0 f-w-500">Invoice Date</td>
                                       <td class="border-left-0">@if($Invoice && $Invoice->issue_date){{$Invoice->issue_date}} @endif</td>
                                    </tr>
                                    @if($InvoiceDetails && $InvoiceDetails->is_payment_recieved == 0)
                                    <tr>
                                       <td class="bg-light-grey border-right-0 f-w-500">Due Date</td>
                                       <td class="border-left-0">@if($Invoice && $Invoice->due_date){{$Invoice->due_date}}@endif</td>
                                    </tr>
                                    @endif
                                 </tbody>
                              </table>
                        ...
                        <tr class="inv-unpaid">
                           <td class="f-14 text-dark">
                              <p class="mb-0 text-left">
                                 ...
                                 <br>@if($InvoiceDetails && $InvoiceDetails->first_name && $InvoiceDetails && $InvoiceDetails->last_name){{$InvoiceDetails->first_name}} {{ $InvoiceDetails->last_name }}@endif<br>
                                @if($InvoiceDetails && $InvoiceDetails->email) {{ $InvoiceDetails->email}}@endif<br>
                                 @if($InvoiceDetails && $InvoiceDetails->address_1){{ $InvoiceDetails->address_1}}@endif<br>
                                 @if($InvoiceDetails && $InvoiceDetails->address_2){{ $InvoiceDetails->address_2}}@endif<br>
                                 @if($InvoiceDetails && $InvoiceDetails->pincode){{ $InvoiceDetails->pincode}}@endif<br>
                              </p>
                           </td>
                           ...
                           <td colspan="2">
                              <table class="inv-detail f-14 table-responsive-sm" width="100%">
                                 <tbody>
                                    ...
                                    @php  
                                      $taxSetting = DB::table('tax_settings')->where('id',$order->taxes)->select('tax_name','rate')->first();
                                    ...
                                    <tr class="text-dark font-weight-semibold f-13">
                                       ...
                                       <td align="right">{{ $taxSetting->tax_name }}:{{ $taxSetting->rate }}</td>
                                    ...
                                    <tr>
                                       ...
                                       <td class="p-0 border-left-0" align="right">
                                          <table width="100%">
                                             <tbody>
                                                <tr class="text-dark-grey" align="right">
                                                   <td align="right" class="border-top-0 border-right-0 sub_total">  {{number_format($orderAmount,2)}}</td>
                                                </tr>
                                                <tr class=" text-dark-grey font-weight-bold" align="right">
                                                ...
                                                <tr class="bg-light-grey text-dark f-w-500 f-16" align="right">
                                                    @if($InvoiceDetails && $InvoiceDetails->is_payment_recieved == 0) {{number_format($orderAmount,2)}} @endif
                     ...
                     <tbody>
                        ...
                        <tr>
                           <td style="vertical-align: text-top">
                              <p class="text-dark-grey">@if($InvoiceDetails && $InvoiceDetails->recipient_notes){{$InvoiceDetails->recipient_notes}}@endif</p>
                           </td>
