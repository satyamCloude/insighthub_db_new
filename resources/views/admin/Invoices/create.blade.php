          ...
          <div class="card-body">
            ...
            <div class="row mb-4">
              <div class="col-md-4">
                ...
                <input type="hidden" name="client_id" id="set_client_id">
            </div>
              ...
              <div class="col-md-4">
                ...
                <select class="form-control select2" name="project_id" id="project_id1" onchange="getProjectDetails(this.value)" >
              ...
              <div class="col-md-4">
                ...
                <select class="form-control select2" name="calc_tax" id="when_calc_tax" required onchange="CalculateTax()">
                  <option value="0" selected>Before Discount</option>
            ...
            <div class="row mb-4">
              ...
              <div class="col-md-4">
                ...
                <!-- <select class="form-control select2" name="generated_by" readonly required >
            ...
            <div class="row mb-4">
              <div class="col-md-4">
                <!--<select class="form-control select2" name="services_id[]" onChange="getProduct(this.value)" required id="servicess">-->
            ...
            <div class="content-wrapper">
              ...
              <div id="sortable" >
                <div class="d-flex c-inv-desc item-row" id="append_div_copy1">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td class="border-bottom-0 btrr-mbl btlr">
                            <input type="text" class="form-control f-14 border-0 w-100 item_name" id="item_name" name="item_name[]" placeholder="Item Name" autocomplete="off" @if($SelectedOrders && $SelectedOrders->order_type == 'client_order') value="{{$SelectedOrders->product_name}} + Acronis" @endif required>
                          </td>
                          <td class="border-bottom-0 d-block d-lg-none d-md-none">
                            <textarea class="form-control f-14 border-0 w-100 mobile-description form-control item_summary" id="item_summary" name="item_summary" placeholder="Enter Description (optional)"  >@if($SelectedOrders && $SelectedOrders->order_type == 'client_order') {{$SelectedOrders->products_desc}} @endif </textarea>
                          </td>
                          <td class="border-bottom-0">
                            <input type="number" min="1" class="form-control f-14 border-0 w-100 text-right quantity mt-3" value="1" name="quantity[]" autocomplete="off" id="qty1">
                          ...
                          <td class="border-bottom-0">
                            <input type="number" min="1" class="f-14 border-0 w-100 text-right cost_per_item form-control" value="@if($SelectedOrders && $SelectedOrders->total_amt){{ $SelectedOrders->total_amt }}@else 0.00 @endif" name="cost_per_item" autocomplete="off" id="cost_per_item1" readonly required>
                          </td>

                          <td class="border-bottom-0">
                            <div class="select-others height-35 rounded border-0">
                              <div class="dropdown bootstrap-select show-tick select-picker type customSequence border-0">
                                <select id="multiselect11" name="taxes" multiple="multiple" onchange="CalculateTax(`1`, this.selectedOptions)" class="select-picker type customSequence1 border-0 multiselect" data-size="3">
                                  @foreach($Tax as $Taxs)
                                  <option data-rate1="{{ $Taxs->tax_name }}" data-tax1="{{ $Taxs->tax_name . ':' . $Taxs->rate }}" value="{{$Taxs->id}}">{{ $Taxs->tax_name . ':' . $Taxs->rate }}</option>
                                  @endforeach
                        ...
                        <tr class="d-none d-md-table-row d-lg-table-row">
                          <td colspan="3" class="dash-border-top bblr border-right-0">
                            <textarea class="f-14 border p-3 px-1  rounded w-100 desktop-description form-control item_summary" id="item_summary" name="item_summary" placeholder="Enter Description (optional)" style="margin:unset; border: unset!important;box-shadow: unset !important;height: 120px;"></textarea>
                          </td>
                            ...
                            <tr>
                              ...
                              <td width="42.7%"  style="padding: 5px;">
                               ...
                               <td>
                                ...
                                <input type="hidden" name="discount_amount" class="discount_amount1">
                              </td>
                            </tr>
                            <tr>
                              <td>Tax</td>
...
<script>
 ...
 function calcDiscount() {
    ...
    if (discount_type == 'percent') {
        ...
        $('.discount_amount1').val(disc_value);
    } else {
  ...
  function removeSection(button) {
   ...
   function removeSection2(button) {
    $('#project_id1').val(null).trigger('change'); // Reset Select2 dropdown
    $(button).closest('.item-row').remove();
    calculateTotal(numberCount);
    calcDiscount();
}
