        ...
        <div class="card">
          <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row">
            ...
            <div class="action-btns">
              <button type="button" onclick="Tab(value)" value="Notice" class="btn btn-primary">Back</button>
            </div>
          </div>
            ...
            <div class="card-footer">
              <div class="row mb-4"> 
                <div class="col-md-6 text-end" >
                  <button type="button" onclick="Tab(value)" value="Notice" type="button" class="btn btn-outline-danger">Discard</button>
                </div>
                <div class="col-md-6">
