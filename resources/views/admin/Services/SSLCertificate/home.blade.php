  ...
  <div class="card">
    <div class="row">
      ...
      <div class="col-md-6 text-end">
         <a href="{{url('admin/SSLCertificate/EXPORTCSV')}}" class="btn btn-info mt-3 m-3"><i class="fa-solid fa-file-csv"></i></a>
          <a href="{{url('admin/SSLCertificate/home')}}" class="btn btn-warning mt-3 m-3"><i class="fas fa-sync-alt"></i></a>
          <!--<a href="{{url('admin/SSLCertificate/add')}}" class="btn btn-primary mt-3 m-3">Add</a>-->
      </div>
    </div>
                  ...
                  <td>
                    <div class="btn-group">
                          ...
                          <ul class="dropdown-menu dropdown-menu-end" style="">
                            <li><a class="dropdown-item" href="{{url('admin/SSLCertificate/edit/'.$SSLCertificates->id)}}">Edit</a></li>
                            <li><button class="dropdown-item delete_debtcase" url="{{url('admin/SSLCertificate/delete/'.$SSLCertificates->id)}}" id="{{$SSLCertificates->id}}">Delete</button></li>
                          </ul>
                      </div>
                  </td>
              </tr>
