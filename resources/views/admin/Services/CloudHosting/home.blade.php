  ...
  <div class="card">
    <div class="row">
      ...
      <div class="col-md-6 text-end">
          <a href="{{url('admin/CloudHosting/EXPORTCSV')}}" class="btn btn-info mt-3 m-3"><i class="fa-solid fa-file-csv"></i></a>
          <a href="{{url('admin/CloudHosting/home')}}" class="btn btn-warning mt-3 m-3"><i class="fas fa-sync-alt"></i></a>
          <!--<a href="{{url('admin/CloudHosting/add')}}" class="btn btn-primary mt-3 m-3">Add</a>-->
      </div>
    </div>
                  ...
                  <td>
                    <div class="btn-group">
                          ...
                          <ul class="dropdown-menu dropdown-menu-end" style="">
                            <li><a class="dropdown-item" href="{{url('admin/CloudHosting/edit/'.$CloudHostings->id)}}">Edit</a></li>
                            <li><button class="dropdown-item delete_debtcase" url="{{url('admin/CloudHosting/delete/'.$CloudHostings->id)}}" id="{{$CloudHostings->id}}">Delete</button></li>
                          </ul>
                      </div>
                  </td>
              </tr>
