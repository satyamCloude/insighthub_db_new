  ...
  <div class="card">
    <div class="row">
      ...
      <div class="col-md-6 text-end">
        <a href="{{url('admin/Rack/home')}}" class="btn btn-warning mt-3 m-3"><i class="fas fa-sync-alt"></i></a>
          <a href="{{url('admin/Rack/add')}}" class="btn btn-primary mt-3 m-3">Add</a>
      </div>
    </div>
              ...
              <tr class="odd">
                  ...
                  <td>
                     @if($user->profile_img)
                            ...
                            alt="User avatar" />
                                                                                @endif
                   {{$user->first_name }} {{$user->last_name }} (#{{$user->user_id}})<div style="font-size:12px;margin-left: 46px;margin-top: -11px;">{{$user->email}}</div>
                          </td>
                          <td>@if($user && $user->rack_id) {{ $user->rack_id }} @endif</td>
                  ...
                  <td>
                    <div class="btn-group">
                          ...
                          <ul class="dropdown-menu dropdown-menu-end" style="">
                            <li><a class="dropdown-item" href="{{url('admin/Rack/edit/'.$user->id)}}">Edit</a></li>
                            <li><button class="dropdown-item delete_debtcase" url="{{url('admin/Rack/delete/'.$user->id)}}" id="{{$user->id}}">Delete</button></li>
                          </ul>
                      </div>
                  </td>
              </tr>
