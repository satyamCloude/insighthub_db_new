      ...
      <div class="col-12">
          <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row">
            ...
            <div class="action-btns">
              <button  onclick="Tab(value)" value="Currency" class="btn btn-label-primary me-3">
             ...
             <div class="card-body text-dark">
              <div class="row mt-4"> 
                <div class="col-md-6 mb-4">
                  ...
                  <input type="text" id="name" class="form-control" value="{{$tax->name}}" name="name" >
                </div>
                <div class="col-md-6 mb-4">
                  <label for="rate" class="form-label">Currency Symbol<span class="text-danger">*</span></label>
                  <input type="text" id="prefix" class="form-control" value="{{$tax->prefix}}" name="prefix" >
                </div> 
                <div class="col-md-3 mb-4">
                  <label for="rate" class="form-label">Currency Code<span class="text-danger">*</span></label>
                  <input type="text" id="code" class="form-control" value="{{$tax->code}}" name="code" >
                </div>
                <div class="col-md-3 mb-4">
                    <label for="rate" class="form-label">Is Cryptocurrency <span class="text-danger">*</span></label><br>
                    <div class="form-check form-check-inline">
                        <input type="radio" id="is_cryptocurrency_yes" class="form-check-input" value="{{$tax->is_cryptocurrency}}" name="is_cryptocurrency" value="1">
                        <label class="form-check-label" for="is_cryptocurrency_yes">Yes</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input type="radio" id="is_cryptocurrency_no" class="form-check-input" value="{{$tax->is_cryptocurrency}}" name="is_cryptocurrency" value="0">
                ...
                <div class="col-md-6">
                      ...
                      <input type="text" class="form-control" value="{{$tax->exchange_rate}}" name="exchange_rate" required /><br>
                </div> 
                ...
                <div class="col-md-6 mb-4">
                      ...
                      <input type="text" class="form-control" value="{{$tax->thousand_separator}}" name="thousand_separator" required />
                </div> 
                <div class="col-md-6 mb-4">
                      <label for="rate" class="form-label"><h5>Decimal Separator <span class="text-danger">*</span></h5></label>
                      <input type="text" class="form-control" value="{{$tax->decimal_separator}}" name="decimal_separator" required />
                </div>
                <div class="col-md-6 mb-4">
                      <label for="rate" class="form-label"><h5>Number of Decimals <span class="text-danger">*</span></h5></label>
                      <input type="number" class="form-control" value="{{$tax->no_of_decimals}}" name="no_of_decimals" required />
                </div>
                <hr/>
