  ...
  <div class="card">
    <div class="row">
      ...
      <div class="col-md-6 text-end">
        <button type="button" onclick="Tab(value)" value="SecurityIP" class="btn btn-warning mt-3 m-3"><i class="fas fa-sync-alt"></i></button>
                  ...
                  <td>
                    <div class="btn-group">
                          ...
                          <ul class="dropdown-menu dropdown-menu-end" style="">   
                            <li><a class="dropdown-item" onclick="EditSecuritySettings({{$user->id}})">Edit</a></li>
                            <li><button class="dropdown-item delete_debtcase" url="{{url('admin/Security/delete/'.$user->id)}}" id="{{$user->id}}">Delete</button></li>
                          </ul>
                      </div>
                  </td>
              </tr>
...
<script>
 ...
 function EditSecuritySettings(id) {
    $.ajax({
        url: `{{ url('admin/Security/edit/') }}/${id}`,
        method: 'GET',
        data: { id: id },
