...
<div class="card">
   ...
   <div class="card my-5">
      <div class="row">
         ...
         <!-- <div class="col-md-6 text-end">
            <a href="{{url('admin/ETemplatesettings/TicketEmailSetting/add')}}" class="btn btn-primary mt-3 m-3">Add Quotes</a>
         </div> -->
      </div>
      <div class="card-datatable table-responsive">
         <div id="DataTables_Table_3_wrapper" class="dataTables_wrapper dt-bootstrap5">
  ...
  <!--  <div class="card my-5">
      <div class="row">
         ...
         <!-- <div class="col-md-6 text-end">
            <a href="{{url('admin/ETemplatesettings/ClientSettings/add')}}" class="btn btn-primary mt-3 m-3">Add Quotes</a>
         </div> -->
      <!-- </div>
      <div class="card-datatable table-responsive">
         <div id="DataTables_Table_3_wrapper" class="dataTables_wrapper dt-bootstrap5">
