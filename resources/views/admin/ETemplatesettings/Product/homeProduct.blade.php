                  ...
                  <td>
                    <div class="btn-group">
                          ...
                          <ul class="dropdown-menu dropdown-menu-end" style="">
                            <li><a class="dropdown-item" href="#" id="{{$Cat->id}}" onclick="EditProductSettings({{$Cat->id}})">Edit</a></li>
                            <li><button class="dropdown-item delete_debtcase1" url="{{url('admin/Product/delete/'.$Cat->id)}}" id="{{$Cat->id}}">Delete</button></li>
                          </ul>
                      </div>
                  </td>
              </tr>
