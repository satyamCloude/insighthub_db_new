  ...
  <div class="card">
    <div class="row">
      ...
      <div class="col-md-6 text-end">
         <a href="{{url('admin/SpecialOffers/home')}}" class="btn btn-warning mt-3 m-3"><i class="fas fa-sync-alt"></i></a>
          <a href="{{url('admin/SpecialOffers/add')}}" class="btn btn-primary mt-3 m-3">Add Offers</a>
      </div>
    </div>
                  ...
                  <td>
                    <div class="btn-group">
                          ...
                          <ul class="dropdown-menu dropdown-menu-end" style="">
                            <li><a class="dropdown-item" href="{{url('admin/SpecialOffers/edit/'.$user->id)}}">Edit</a></li>
                            <li><button class="dropdown-item delete_debtcase" url="{{url('admin/SpecialOffers/delete/'.$user->id)}}" id="{{$user->id}}">Delete</button></li>
                          </ul>
                      </div>
                  </td>
              </tr>
