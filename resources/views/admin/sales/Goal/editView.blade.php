        ...
        <div class="card">
          <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row">
            ...
            <div class="action-btns">
              <a href="{{url('admin/Goal/home')}}" class="btn btn-label-primary me-3">
                <span class="align-middle"> Back</span>
              </a>
            </div>
          </div>
          <form action="{{url('admin/Goal/update/'.$Goal->id)}}" method="post" enctype="multipart/form-data"> 
            @csrf
            <div class="card-body">
              ...
              <div class="row mb-4"> 
                ...
                <div class="col-md-6">
                  ...
                  <select name="job_role_id" class="form-control select2" disabled>
              ...
              <div class="row mb-4"> 
                <div class="col-md-6">
                  ...
                  <input type="number" class="form-control" @if($Goal && $Goal->goal_value) value="{{$Goal->goal_value}}" @endif name="goal_value" placeholder="12"  disabled />
                </div>
                <div class="col-md-6">
                  <label for="archieved_value" class="form-label">Achieved Value <span class="text-danger">*</span></label>
                  <input type="number" class="form-control" @if($Goal && $Goal->archieved_value) value="{{$Goal->archieved_value}}" @endif name="archieved_value" placeholder="12" disabled />
                </div>
              </div> 
              <div class="row mb-4"> 
                <div class="col-md-6">
                  <label for="months_id" class="form-label">Months <span class="text-danger">*</span></label>
                  <select name="months_id" class="form-control select2" id="months" disabled>
            ...
            <div class="card-footer">
              <div class="row mb-4"> 
                <!-- <div class="col-md-6 text-end" >
                  <a href="{{url('admin/Goal/home')}}" type="button" class="btn btn-outline-danger">Discard</a>
                </div>
                <div class="col-md-6">
