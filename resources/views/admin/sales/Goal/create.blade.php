   ...
   <div class="row">
      <div class="col-12">
         <div class="card">
            ...
            <form action="{{url('admin/Goal/store')}}" method="post" enctype="multipart/form-data">
               @csrf
               <div class="card-body">
...
<script>
   $(document).ready(function(){
       $('#employee_id').change(function(){
           ...
           $.ajax({
             type: 'GET',
             url: "{{url('admin/Employee/getEmployeeRole')}}/"+emp_id,
   ...
   function selectClient2(id) {
       ...
       $.ajax({
           type: 'GET',
           url: "{{url('admin/Invoices/getEmployeeDetails')}}/"+id,
           success: function(res) {
