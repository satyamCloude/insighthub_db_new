    ...
    <input type="tel" name="phone_number" id="phone_number" class="inpt form-control" required placeholder="+1234567890" pattern="[0-9+]{1,10}" maxlength="10" oninput="this.value = this.value.replace(/[^0-9+]/g, '').slice(0, 10);">
              ...
              <div class="row mb-4"> 
                ...
                <div class="col-md-6">
                        ...
                        <!--</select>-->
                <div class="dropdown">
                  <button class="dropbtn" type="button" id="selected_client_btn">Select <i class="fa fa-angle-down" style="font-size:24px"></i></button>
              ...
              <div class="row mb-4"> 
                   ...
                   <div class="col-md-6">
                    <label for="action_schedule" class="form-label">Action Schedule <span class="text-danger">*</span></label>
                    <select name="action_schedule" id="action_schedulef" class="form-control " required>
                        <option value="">Select</option>
                        <option value="Call"><i class="fa fa-solid fa-circle-up color2"></i> Call</option>
                        <option value="Email"><i class="fa fa-solid fa-circle-up color2"></i> Email</option>
                    </select>
                </div>
              ...
              <h5 class="mb-4">4. Other</h5>
               <div class="row mb-4"> 
                ...
                <div class="dropdown">
                  <button class="dropbtn" type="button" id="selected_client_btn2">AssignedTo <i class="fa fa-angle-down" style="font-size:24px"></i></button>
                  <div class="dropdown-content">
                ...
                <!--</div>-->
                <div class="col-md-3">
                      <label for="RequirementAmt" class="form-label">Amount</label>
                      <input type="text" class="form-control" name="requirement_amt" placeholder="2000" />
                </div>
                  <div class="col-md-3">
                      <label for="RequirementAmt" class="form-label">Add File</label>
