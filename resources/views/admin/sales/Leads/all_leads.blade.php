<div id="DataTables_Table_3_wrapper" class="dataTables_wrapper dt-bootstrap5">
    <div class="row">
        ...
        <div class="col-sm-12 col-md-2">
            <!--<a href="https://crm1.cloudtechtiq.com/admin/Leads/add" class="btn btn-primary waves-effect waves-light">Add Leads</a>-->
        </div>
 ...
 <table class="dt-responsive table dataTable dtr-column" id="DataTables_Table_3" aria-describedby="DataTables_Table_3_info">
    ...
    // Set the current month and year as the selected option for all selectors with the respective class
