                  ...
                  <div class="modal-dialog m-0 me-md-4 mb-4 modal-lg">
                    <div class="modal-content p-0">
                      ...
                      <div class="modal-body flex-grow-1 pb-sm-0 p-4 py-2">
                        <form class="email-compose-form" action="{{url('admin/MassMail/store')}}" method="POST">
                          @csrf
...
<script>
  ...
  $(document).ready(function () {
    ...
    function fetchTemplates(templateId) {
      $.get("{{url('admin/get-template')}}/" + templateId, function (data) {
...
<!-- <option data-avatar="{{url('public/logo/remove.png')}} "value="removeall">Remove All</option> -->
<script>
 ...
 var datetimeInput = $('#html5-datetime-local-input');
  ...
  function Sent(user_id){
     $.ajax({
                url: "{{ url('admin/MassMail/SentMails') }}",
                method: 'GET',
 ...
 $.ajax({
                url: "{{ url('admin/MassMail/DraftMails') }}",
                method: 'GET',
                data: { id: id },
                success: function (data) {
                    if (data.length > 0) {
    ...
    function Schedule(id) {
              $.ajax({
                url: "{{ url('admin/MassMail/Schedule') }}",
                method: 'GET',
                data: { id: id },
                success: function (data) {
                    if (data.length > 0) {
 ...
 $.ajax({
                url: "{{ url('admin/MassMail/StarMails') }}",
                method: 'GET',
                data: { id: id },
                success: function (data) {
                    if (data.length > 0) {
    ...
    function StarUpdate(id) {
        $.ajax({
          url: "{{ url('admin/MassMail/StarUpdate') }}",
          method: 'GET',
          data: { id: id },
          success: function () {
               location.reload();
    ...
    function Restore(id) {
      ...
      bootbox.confirm({
        ...
        callback: function (result) {
            if (result) {
               $.ajax({
                  url: "{{ url('admin/MassMail/Restore') }}",
                  method: 'GET',
                  data: { id: id },
                  success: function () {
                       location.reload();
    ...
    function ForceDelete(id) {
      bootbox.confirm({
        ...
        callback: function (result) {
            if (result) {
              $.ajax({
                url: "{{ url('admin/MassMail/ForceDelete') }}",
                method: 'GET',
                data: { id: id },
                success: function () {
                     location.reload();
...
function LoadMore(button) {
    ...
    $.ajax({
        type: "get",
        data: { type: type },
        url: "{{ url('admin/MassMail/LoadMore') }}?page=" + page,
        success: function (data) {
            if (data != '') {
                $('.email-list').html(data);
