...
<div class="row ProfileScreen" >
  ...
  <div class="col-xl-12 col-lg-12 col-md-5 order-1 order-md-0">
      ...
      <div class="card-body">
        <div class="row">
          <div class="col-sm-6 mb-4">
            <span class="text-muted me-1">Full name</span>
          </div>
          <div class="col-sm-6 mb-4">
       ...
       <div class="col-sm-6 mb-4">
        <span class="text-muted me-1">Action Schedule</span>
      </div>
      <div class="col-sm-6 mb-4">
    ...
    @php
    $assignedto =  \App\Models\User::select('id','first_name','profile_img')->where('id',$user->assignedto)->first();           
    $generated_by =  \App\Models\User::select('id', 'first_name','profile_img')->where('id',$user->generated_by)->first();      

    @endphp
    <div class="col-sm-6 mb-4">
      <span class="text-muted me-1">Generated By</span>
    </div>
    <div class="col-sm-6 mb-4">
     ...
     "><span>{{$generated_by->first_name}} {{$generated_by->last_name}} | emp_{{ $generated_by->id }}</span></div></div>
   </div>
   <div class="col-sm-6 mb-4">
  ...
  <div class="col-sm-6 mb-4">
    ...
    <div class="outer_box1" style=" display: flex;"><div class="inner_img" style="display: flex;align-items: center;border-radius: 50%;">
      ...
      <img src="{{$assignedto->profile_img}}" style="width: 41px;border-radius: 50%;"></div><div class="inner_txt" style="display: flex;flex-direction: column;justify-content: space-between;"><span>{{$assignedto->first_name}} {{$assignedto->last_name}} | Junior</span></div></div>
    @else
  ...
  <div class="col-sm-6 mb-4">
                            ...
                            @endphp
                                <span class="badge bg-label-primary">{{ucfirst($lead_status->lead_status)}}</span>

                            
   
  </div>
  <div class="col-sm-6 mb-4">
    <span class="text-muted me-1">Contact</span>
  </div>
  <div class="col-sm-6 mb-4">
  ...
  <div class="col-sm-6 mb-4">
    <span>@if($user && $user->requirement){!!$user->requirement!!} @else -- @endif </span>
  </div>
</div>
</div>
</div>
  ...
  <div class="col-xl-12 col-lg-12 col-md-5 order-1 order-md-0">
    ...
    <div class="card mb-4">
        <div class="card-header d-flex justify-content-between">
            ...
            <a href="#" onclick="EditNotesUp({{$user->id}})"><i class="fa-solid fa-edit"></i></a>
            &nbsp;&nbsp;
        </div>
        <div class="card-body">
            <div id="noteDisplay">
