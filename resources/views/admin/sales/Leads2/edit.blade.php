              ...
              <div class="row mb-4"> 
                <div class="col-md-6">
                  <label for="date" class="form-label">Lead Source  <span class="text-danger">*</span></label>
                    <select name="lead_source" class="form-control select2">
                ...
                <div class="col-md-6 ">
                  ...
                  <select name="action_schedule" class="form-control select2">
              ...
              <h5 class="mb-4">4. Other</h5>
               <div class="row mb-4"> 
                ...
                <div class="col-md-3">
                      ...
                      <input type="text" class="form-control" name="requirement_amt" @if($user && $user->requirement_amt) value="{{$user->requirement_amt}}" @endif placeholder="2000" required/>
                </div>
                  <div class="col-md-3">
