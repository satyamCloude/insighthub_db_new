...
<h4 class="py-3 mb-4"><span class="text-muted fw-light">Hosting /</span> Add</h4>
<!-- Sticky Actions -->
<div class="row">
   <div class="col-12">
      <div class="card">
         ...
         <form action="{{url('admin/HostingPanel/store')}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
               ...
               <div class="row">
                  <div class="col-md-6">
                     ...
                     <input type="text" class="form-control" name="hosting_name" placeholder="Hosting name name" required/>
                  </div>
                  <div class="col-md-6 ">
                  ...
                  <div>
                     ...
                     <div class="row mb-4">
                        <div class="col-md-6 mt-4">
                           ...
                           <input type="text" class="form-control" name="price" placeholder="hosting price" required/>
                        </div>
                        <!-- <div class="col-md-6">
                           <label for="status" class="form-label">Status<span class="text-danger">*</span></label>
                           <input type="text" class="form-control" name="status" placeholder="hosting status" required/>
                           </div> -->
                        <div class="col-md-6  mt-4">
                           <label for="plan_type" class="form-label">Plan Type<span class="text-danger">*</span></label>
                           <select class="form-control select2 height-35 f-15" name="currency_id">
