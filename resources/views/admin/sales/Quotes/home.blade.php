      ...
      <div class="row">
         ...
         <div class="col-md-6 text-end">
            <form id="downloadPDFForm" method="POST">
               ...
               <a href="{{ url('admin/Quotes/add') }}" class="btn btn-primary mt-3 m-3">Add</a>
            </form>
         </div>
      </div>
                     ...
                     <tr class="odd">
                        ...
                        <td  >
                           <div class="d-flex">
                              ...
                              <img class="rounded-circle"  src="{{ $user_data->profile_img }}" height="30" width="30" alt="User avatar" style="width:45px;border-radius:50%;height:auto;">
                              @else
...
<script>
   ...
   function downloadPDF() {
       ...
       if (selectedIds.length > 0) {
           ...
           window.location.href = "{{ url('admin/Quotes/downloadPDF') }}?ids=" + selectedIds.join(',');
       } else {
   ...
   function submitForm() {
       ...
       form.action = "{{ url('admin/Quotes/downloadPDF') }}"; // Set action to download PDF route
       form.submit();
   }
</script>
<script>
   ...
   $.ajaxSetup({
       ...
       $.ajax({
         type: 'POST',
         url: "{{url('admin/Quotes/changeQuotesStatus')}}",
         data: {
             userId: userId,
             status: status
         },
