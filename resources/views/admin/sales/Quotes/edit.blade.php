               ...
               <div class="row mb-4 mt-4 mb-3">
                  ...
                  <div class="row newa{{$key+1}} mb-4">
                     <div class="col-md-3">
                        ...
                        <textarea class="form-control" id="description" name="description[]" placeholder="...."  rows="1">@if($Quot && $Quot->description) {{$Quot->description}} @endif </textarea>
                     </div>
                     <div class="col-md-2">
                     ...
                     <div class="col-md-2">
                        ...
                        <input type="number"  class="form-control unit_price" @if($Quot && $Quot->unit_price) value="{{$Quot->unit_price}}" @endif id="unit_price" name="unit_price[]"  placeholder="01"/>
                     </div>
                     <div class="col-md-2">
                     ...
                     <div class="col-md-1">
                        ...
                        <input type="number" class="form-control taxs" name="tax_rate[]"  @if($Quot && $Quot->tax_rate) value="{{$Quot->tax_rate}}" @endif  id="unit_tax" placeholder="0"  required/>
                        <input type="hidden" name="tax[]" id="unit_tax_id"  @if($Quot && $Quot->tax) value="{{$Quot->tax}}" @endif  class="form-control tax"  >
                     </div>
                     <div class="col-md-2">
                        <label for="total" class="form-label">Total <span class="text-danger">*</span></label>
                        <input type="number"  class="form-control total" @if($Quot && $Quot->total) value="{{$Quot->total}}" @endif  name="total[]" placeholder="01" step="0.01"/>
                     </div>
