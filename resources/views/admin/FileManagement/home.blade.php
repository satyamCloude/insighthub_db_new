    ...
    <div id="inner_content_two" style="margin-top:10px;">
        <div class="container-fluid" style="padding:0;">
                                                        ...
                                                        <div class="collapse show" id="employee-folder-collapse">
                                                            <div class="card border-0 shadow-none ps-2 mb-0">
                                                                <ul class="list-unstyled mb-0">
                                                                    ...
                                                                    @foreach($empfolders as $folder)
                                                                    <li>
                                                                        <a href="#" class="text-body d-flex align-items-center open-files" data-id="{{$folder->id}}">
                                                                            <i class="mdi mdi-file font-size-20 text-warning me-2"></i><span class="me-auto">{{ str_replace('_', ' ', $folder->folder_name) }}</span>
                                                                        </a>
                                                                    </li>
                                                                    @endforeach
                                                                </ul>
                                                        ...
                                                        <div class="collapse show" id="department-folder-collapse">
                                                            <div class="card border-0 shadow-none ps-2 mb-0">
                                                                <ul class="list-unstyled mb-0">
                                                                    ...
                                                                    @foreach($department_folders as $folder)
                                                                    <li>
                                                                        <a href="#" class="text-body d-flex align-items-center open-files" data-id="{{$folder->id}}">
                                                                            <i class="mdi mdi-file font-size-20 text-warning me-2"></i><span class="me-auto">{{ substr(str_replace('_', ' ', $folder->folder_name), 0, 22) }}</span>
                                                                        </a>
                                                                    </li>
                                                                    @endforeach
                                                                </ul>
                                ...
                                <h5 class="font-size-16 me-3 mb-0 mt-4" id="div_name">Department Folders</h5>
                                    <div class="row mt-4" id="folders-container">
                                       ...
                                       @foreach($department_folders as $department_folder)
                                                    @if($department_folder->id >= 1 && $department_folder->id <= 5)
                                                        @php
                                                        ...
                                                        <div class="card-body p-3">
                                                            <div class="dropdown float-end">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end">
                                                                    <a class="dropdown-item edit-folder" href="#" data-id="{{ $department_folder->id }}" data-name="{{ $department_folder->folder_name }}" data-bs-target="#edit-folder" data-bs-toggle="modal">Edit</a>
                                                                    <a class="dropdown-item share-folders" href="#" data-id="{{ $department_folder->id }}" data-name="{{ $department_folder->folder_name }}" data-bs-target="#share-folder" data-bs-toggle="modal">Share</a>
                                                            ...
                                                            <div class="mt-3 pt-1 open-files" data-id="{{$department_folder->id}}">
                                                                <h5 class="font-size-15 mb-1 text-truncate">{{ substr(str_replace('_', ' ', $department_folder->folder_name), 0, 22) }}</h5>
                                                             ...
                                                             @if($department_folder && $department_folder->share_ids)
                                                                    ...
                                                                    @foreach($users as $user)
                                                                        <div class="avatar-group-item">
                                                                            <a href="javascript: void(0);" class="d-inline-block">
                                                                                @if($user->profile_img)
                                                                                <img src="{{$user->profile_img}}" alt="" class="rounded-circle avatar-xs">
                                                                                @else
            ...
            @endif
                                    ...
                                    @if(count($shared_folders) > 0)
                                        @foreach($shared_folders as $sharedEmployee)
                                            ...
                                            <div class="col-xl-6 col-sm-6 mt-4">
                                                <div class="card">
                                                    <div class="card-body p-3">
                                                        <div class="open-files" data-id="{{$sharedEmployee->id}}">
                                                            <div class="d-flex justify-content-between align-items-center">
                                                                <div>
                                                            ...
                                                            <div class="d-flex mt-3">
                                                                <div class="overflow-hidden me-auto">
                                                                    <h5 class="font-size-15 text-truncate mb-1"><a href="javascript: void(0);" class="text-body">{{ substr(str_replace('_', ' ', $sharedEmployee->folder_name), 0, 22) }}</a></h5>
                               ...
                               <div class="row mt-4">
                                    @if(count($shared_sub_folders) > 0)
                                        @foreach($shared_sub_folders as $sharedEmployee)
                                              @php
...
<div class="modal fade" id="add-folder" tabindex="-1" aria-labelledby="paymentModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered ">
        <div class="modal-content ">
            <form action="{{url('admin/FileManagement/store-folder')}}" method="POST">
                @csrf
...
<div class="modal fade" id="edit-folder" tabindex="-1" aria-labelledby="paymentModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form action="{{ url('admin/FileManagement/update-folder') }}" method="POST">
                @csrf
                <div class="modal-header">
                    <h4>Edit Folder</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
...
<div class="modal fade" id="add-sub-folder" tabindex="-1" aria-labelledby="paymentModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form action="{{ url('admin/FileManagement/store-sub-folder') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <select class="form-control" name="folder_id">
                        ...
                        @foreach($folders as $folder1)
                            <option value="{{ $folder1->id }}">{{ str_replace('_', ' ', $folder1->folder_name) }}</option>
                        @endforeach
                    </select>
                </div>
...
<div class="modal fade" id="add-file" tabindex="-1" aria-labelledby="paymentModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form action="{{ url('admin/FileManagement/store-file') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-header">
                    <h4>Create File</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                ...
                <div class="modal-body">
                    ...
                    <!--        <option value="{{ $folder->id }}">{{ $folder->sub_folder_name }}</option>-->
                    <!--    @endforeach-->
                    </select>
                </div>
...
$(document).on('change', '#my_folder', function (e) {
    ...
    $.ajax({
        url: '{{ url('admin/FileManagement/get-sub-folders') }}',
        type: 'GET',
        data: {
            _token: '{{ csrf_token() }}',
            folder_id: folderId
...
$(document).on('click', '.share-sub-folders', function (e) {
    ...
    $(document).on('click', '.open-files', function (e) {
        e.preventDefault();
        var folderId = $(this).data('id');
        var url = "{{url('/')}}"+'/admin/FileManagement/view-folder-files/' + folderId;
        $.ajax({
            url: url,
            type: 'GET',
            data: {
    ...
    $(document).on('click', '.open-all-files', function (e) {
        e.preventDefault();
        var url = "{{url('/')}}"+'/admin/FileManagement/view-all-files';
        $.ajax({
            url: url,
            type: 'GET',
            data: {
   ...
   $(document).on('click', '.open-subfolders-files', function (e) {
        e.preventDefault();
        var folderId = $(this).data('id');
        var url = "{{url('/')}}"+'/admin/FileManagement/view-subfolder-files/' + folderId;
        $.ajax({
            url: url,
            type: 'GET',
            data: {
