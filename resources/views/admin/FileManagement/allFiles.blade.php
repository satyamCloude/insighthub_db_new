        ...
        <div class="modal-content">
            <form action="{{ url('admin/FileManagement/share-file') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <select class="form-control emp_id select2" name="share_ids[]" multiple id="share_file_emp_id"></select>
                </div>
...
<div class="modal fade" id="edit-sub-folder" tabindex="-1" aria-labelledby="paymentModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form action="{{ url('admin/FileManagement/update-sub-folder') }}" method="POST">
                @csrf
                <div class="modal-header">
                    <h4>Edit Folder</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
...
$(document).on('click', '.delete-file', function (e) {
 ...
 $(document).on('click', '.open-subfolders-files', function (e) {
        ...
        var url = '/admin/FileManagement/view-subfolder-files/' + folderId;
        $.ajax({
            url: url,
            type: 'GET',
            data: {
