  ...
  <div class="card">
    <div class="row">
      ...
      <div class="col-md-6 text-end">
         <a href="{{url('admin/Inventory/EXPORTCSV')}}" class="btn btn-info mt-3 m-3"><i class="fa-solid fa-file-csv"></i></a>
          <a href="{{url('admin/Inventory/home')}}" class="btn btn-warning mt-3 m-3"><i class="fas fa-sync-alt"></i></a>
          <a href="{{url('admin/Inventory/add')}}" class="btn btn-primary mt-3 m-3">Add</a>
      </div>
    </div>
              ...
              <tr class="odd">
                  ...
                  <td>
                    <img 
                            ...
                            height="30"
                            width="30"
                            alt="User avatar" />{{ $Inventor->first_name }}<div style="font-size:12px;margin-left: 46px;margin-top: -11px;">{{$Inventor->email}}</div></td>
                  ...
                  <td>
                    <div class="btn-group">
                          ...
                          <ul class="dropdown-menu dropdown-menu-end" style="">
                            <li><a class="dropdown-item" href="{{url('admin/Inventory/edit/'.$Inventor->id)}}">Edit</a></li>
                            <li><button class="dropdown-item delete_debtcase" url="{{url('admin/Inventory/delete/'.$Inventor->id)}}" id="{{$Inventor->id}}">Delete</button></li>
                          </ul>
                      </div>
                  </td>
              </tr>
