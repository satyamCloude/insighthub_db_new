...
<html
  ...
  <head>
    ...
    <title>Mail Otp Verifications</title>
    ...
    <div class="authentication-wrapper authentication-cover authentication-bg">
      <div class="authentication-inner row">
        ...
        <div class="d-flex col-12 col-lg-5 align-items-center p-4 p-sm-5">
          ...
          @endif
           <div>
            <h4 class="mb-1">Mail Otp Verification</h4>
            <p class="text-start mb-4">
              Enter the code received on you registered mail id.
            </p>
            <p class="mb-0 fw-medium">Enter the 6-digit authentication code:</p>
           
                    <form method="POST" action="{{ url('mailOtp/admin-verify') }}">
                        @csrf
                        ...
                        <!-- Pass the user id in hidden field -->
                        <input type="hidden" name="user_id" value="{{ session('mailOtp:user:id') }}">
                    </form>
          </div>
          </div>
        </div>
