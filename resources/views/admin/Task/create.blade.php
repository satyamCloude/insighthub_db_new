    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <form action="{{url('admin/Task/store')}}" method="post" enctype="multipart/form-data"> 
            @csrf
            <div class="card-body">
              ...
              <div class="row "> 
                ...
                <div class="col-sm-12 mb-4">
                      ...
                      <select class="form-select select2" name="AssignedTo[]" multiple required>
                          ...
                          <option value="{{$Employee->id}}">{{$Employee->first_name}} {{$Employee->last_name}} (#{{$Employee->id}}) <br>| {{$Employee->jobrole}}</option>
                          @endforeach
                      </select>
                </div>
                <div class="col-sm-12 mb-4">
