    ...
    <div class="col-md-12">
        <form action="{{ url('admin/InvoiceSettings/store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="card-body">
                    ...
                    <div class="col-md-6 d-flex">
                        ...
                        <div class="col-md-5 text-center">
                            @if ($chk_exst && $chk_exst->invoice_logo)
                                <img src="{{ url($chk_exst->invoice_logo) }}" style="width:100%">
                            @else
                                <img src="{{ url('public/logo/company.png') }}" style="width:100%">
                            @endif
                        </div>
                    </div>
                    <div class="col-md-6 d-flex">
                ...
                <div class="row mb-4">
                        ...
                        <div class="input-group">
                            <div class="form-group mb-0 border-right-0">
                                ...
                                <select required name="reminder_type" id="reminder_type" class="form-control " style="border-radius: 5px 0px 0px 5px;">
                                    <option value="0" @if($chk_exst && $chk_exst->reminder_type == 0) selected @endif >Send Reminder Before</option>
                                    <option value="1" @if($chk_exst && $chk_exst->reminder_type == 1) selected @endif>Send Reminder After</option>
                                </select>
                            </div>
                            <input type="number" required name="reminder_days" id="reminder_days" class="form-control height-35 f-14" min="0" autocomplete="off"
                            @if($chk_exst && $chk_exst->reminder_type == 0) 
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            <input type="number"
                                @if ($chk_exst && $chk_exst->reminder_frequency) value="{{ $chk_exst->reminder_frequency }}" @endif
                ...
                <div class="row mb-4">
                    <div class="col-lg-4 mt-4">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="show_status" @if($chk_exst && $chk_exst->show_status) checked="" @endif
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 mt-3">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="show_client_name" @if($chk_exst && $chk_exst->show_client_name) checked="" @endif
                    ...
                    <div class="col-lg-4 mt-3">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="show_client_email" @if($chk_exst && $chk_exst->show_client_email) checked="" @endif
                    ...
                    <div class="col-lg-4 mt-3">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="show_client_phone" @if($chk_exst && $chk_exst->show_client_phone) checked="" @endif
                    ...
                    <div class="col-lg-4 mt-3">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="show_client_company_name"
                                @if($chk_exst && $chk_exst->show_client_company_name) checked="" @endif id="show_client_company_name" autocomplete="off">
                            <label
                                class="form-check-label form_custom_label text-dark-grey pl-2 mr-3 justify-content-start cursor-pointer checkmark-20 pt-1 text-wrap"
                    ...
                    <div class="col-lg-4 mt-3">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="show_client_company_address"
                                @if($chk_exst && $chk_exst->show_client_company_address) checked="" @endif id="show_client_company_address" autocomplete="off">
                            <label
                                class="form-check-label form_custom_label text-dark-grey pl-2 mr-3 justify-content-start cursor-pointer checkmark-20 pt-1 text-wrap"
                    ...
                    <div class="col-lg-12 mt-3">
                        <div class="form-group my-3">
                            <div class="form-group my-3 mr-0 mr-lg-2 mr-md-2">
                                ...
                                <textarea class="form-control f-14 pt-2" rows="3" required placeholder="Enter invoice terms" name="invoice_terms" id="invoice_terms">@if ($chk_exst && $chk_exst->invoice_terms){{ $chk_exst->invoice_terms }}@endif</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12 ">
                        <div class="form-group my-3">
                            <div class="form-group my-3 mr-0 mr-lg-2 mr-md-2">
                                ...
                                <textarea class="form-control f-14 pt-2" required rows="3" placeholder="Enter Other Information" name="other_info" id="other_info">@if ($chk_exst && $chk_exst->other_info){{ $chk_exst->other_info }}@endif</textarea>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card-footer">
                <div class="row mb-4">
                    <!-- <div class="col-md-6 text-end">
                        <a href="{{ url('admin/InvoiceSettings/home') }}" type="button"
