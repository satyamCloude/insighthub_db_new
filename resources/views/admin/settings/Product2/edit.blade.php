        ...
        <div class="card">
          ...
          <form action="{{url('admin/Product/updatenew/'.$Product->id)}}" method="post" enctype="multipart/form-data">
            ...
            <div class="card-body">
              ...
              <div class="row mb-4">
                ...
                <div class="col-md-3">
                  <label for="one_time" class="form-label">
                    <input type="radio" <?php echo ($Product && $Product->payment_type == 2)  ? 'checked' : ''; ?> onclick="onetime()" name="payment_type" value="2" />&nbsp;&nbsp;One Time
                  </label>
                </div>
                <div class="col-md-3">
              ...
              <div class="row mb-4">
                <div class="col-md-6">
                  <label for="payment_method" class="form-label">Addon<span class="text-danger">*</span></label>
                  <select name="addon_id[]" class="form-control select2" required multiple>
                    <option value="">Select Method</option>
                    @foreach($Products as $Method)
                    <option @if($Product->addon->contains('addon_id', $Method->id)) selected @endif value="{{ $Method->id }}">{{ $Method->product_name }}</option>
                    @endforeach
                  </select>
                </div>
              </div>
