  ...
  <div class="col-md-12">
    <div class="card">
      ...
      <div class="card-body">
          ...
          <div class="row ">
            ...
            <div class="col-md-12 mt-2 d-flex  align-self-baseline">
              <select name="leadsetting" onchange="Taber(this.value)" class="form-control">
                ...
                @if($department->allow_for_ticket)
        ...
        <form action="{{url('admin/TicketEmailSetting/update/'.$department->id)}}" method="post"
...
<script>
  ...
  function Taber(value) {
    ...
    $.ajax({
      url: "{{url('admin/Settings/smtp-details')}}/" + value, // Specify the URL to your API endpoint
