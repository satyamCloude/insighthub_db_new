                ...
                <div class="card-body">
                            ...
                            <div class="col-md-12">
                                <div class="d-flex align-items-start align-items-sm-center gap-4">
                                    <img alt="user-avatar" class="d-block w-px-100  rounded" id="uploadedProfile"
                                        @if ($user_details->profile_img) src="{{ $user_details->profile_img }}" @else src="{{ url('/') }}/public/images/default_profile.jpg" @endif>
                        ...
                        <div class="col-md-12 d-flex mt-4">
                                <div class="d-flex align-items-start align-items-sm-center gap-4">
                                    <img alt="user-avatar" class="d-block   rounded" id="uploadedBanner" style="width:38%"
                                        @if ($user_details->banner) src="{{ $user_details->banner }}" @else src="https://demos.pixinvent.com/vuexy-html-admin-template/assets/img/pages/profile-banner.png" @endif>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-4">
                            ...
                            <div class="form-group mb-0">
                                <input type="text" name="first_name" id="first_name"
                                    value="{{ $user_details->first_name }}" required class="form-control "
                                    autocomplete="off">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group mb-0">
                                <input type="text" name="last_name" id="last_name"
                                    value="{{ $user_details->last_name }}" required class="form-control "
                                    autocomplete="off">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group mb-0">
                                <input type="email" name="email" id="email" value="{{ $user_details->email }}"
                        ...
                        <div class="col-md-4 mt-4">
                            ...
                            <input type="number" value="{{ $user_details->phone_number }}" name="phone_number"
                        ...
                        <div class="col-md-4 mt-4">
                            ...
                            <select name="gender" id="gender" class="form-control">
                                ...
                                <option value="male" {{ $user_details->gender == 'male' ? 'selected' : '' }}>Male
                                </option>
                                <option value="female" {{ $user_details->gender == 'female' ? 'selected' : '' }}>Female
                                </option>
                                <option value="other" {{ $user_details->gender == 'other' ? 'selected' : '' }}>Other
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-4 mt-4">
                            ...
                            <select name="merital_status" id="merital_status" class="form-control">
                                ...
                                <option value="single"
                                    {{ $user_details->merital_status == 'single' ? 'selected' : '' }}>
                                    Single</option>
                                <option value="merried"
                                    {{ $user_details->merital_status == 'merried' ? 'selected' : '' }}>
                                    Married</option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-4 mt-4">
                            ...
                            <select name="country" id="country" class="form-control select2">
                                @foreach ($country as $countrs)
                                    <option value="{{ $countrs->id }}"
                                        {{ $user_details->country_id == $countrs->id ? 'selected' : '' }}>
                                        {{ $countrs->name }}</option>
                                @endforeach
                            </select>
                        </div>
