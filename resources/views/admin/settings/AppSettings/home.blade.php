            ...
            <div class="card-body">
              ...
              <div class="row"> 
                ...
                <div class="col-md-12 row mb-4">
                    ...
                    <div class="col-md-6">
                        <div class="avatar-preview">
                           <img id="comapnyLogoPreview" width="100"  @if($pSe && $pSe->CompanyLogo) src="{{$pSe->CompanyLogo}}" @endif alt="Preview" />
                        </div>
                  </div>
                  <div class="col-md-6">
                ...
                <div class="col-md-12 row mb-4">
                    ...
                    <div class="col-md-6">
                        <div class="avatar-preview">
                           <img id="CompanyBannerPreview" width="100"  @if($pSe && $pSe->CompanyBanner) src="{{$pSe->CompanyBanner}}" @endif alt="Preview" />
                        </div>
                  </div>
                  <div class="col-md-6">
                      <div class="avatar-upload">
                ...
                <div class="col-md-12 row mb-4">
                    ...
                    <div class="col-md-6">
                        <div class="avatar-preview">
                           <img id="CompanyBannerEmployeePreview" width="100"   @if($pSe && $pSe->CompanyBannerEmployee) src="{{$pSe->CompanyBannerEmployee}}" @endif alt="Preview" />
                        </div>
                  </div>
                  <div class="col-md-6">
                      <div class="avatar-upload">
                ...
                <div class="col-md-12 row mb-4">
                    ...
                    <div class="col-md-6">
                        <div class="avatar-preview">
                           <img id="CompanyBannerClientPreview" width="100"    @if($pSe && $pSe->CompanyBannerClient) src="{{$pSe->CompanyBannerClient}}" @endif alt="Preview" />
                        </div>
                  </div>
                  <div class="col-md-6">
                      <div class="avatar-upload">
