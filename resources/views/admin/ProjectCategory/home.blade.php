  ...
  <div class="card">
    <div class="row">
      ...
      <div class="col-md-6 text-end">
         <a href="{{url('admin/ProjectCategory/EXPORTCSV')}}" class="btn btn-info mt-3 m-3"><i class="fa-solid fa-file-csv"></i></a>
                  ...
                  <td>@if($Inventor && $Inventor->category_name) {{ $Inventor->category_name }} @endif</td>
                    ...
                    <div class="btn-group">
                          ...
                          <ul class="dropdown-menu dropdown-menu-end" style="">
                            <li><a class="dropdown-item" onclick="EditProjectCategory({{$Inventor->id}})">Edit</a></li>
                            <li><button class="dropdown-item delete_debtcase" url="{{url('admin/ProjectCategory/delete/'.$Inventor->id)}}" id="{{$Inventor->id}}">Delete</button></li>
                          </ul>
                      </div>
                  </td>
              </tr>
...
function EditProjectCategory(id) {
    $.ajax({
        url: `{{ url('admin/ProjectCategory/edit/') }}/${id}`,
        method: 'GET',
        data: { id: id },
