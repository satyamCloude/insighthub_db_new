                           ...
                           <div class="btn-group">
                              ...
                              <div class="dropdown-menu">
                                 ...
                                 <a class="dropdown-item"
                                    href="{{url('admin/Ticket/update/'.$ticket->id)}}?department_id={{$department->id}}"
                        ...
                        <div class="d-flex">
                           ...
                           <div class="btn-group">
                              ...
                              <div class="dropdown-menu">
                                 ...
                                 <!-- Status 1 anchor -->
                                 <a class="dropdown-item" href="{{ url('admin/Ticket/update/'.$ticket->id) }}?status=1"
                                    onclick="selectDepartment(1, 'Status 1')">Open</a>

                                 <!-- Status 2 anchor -->
                                 <a class="dropdown-item" href="{{ url('admin/Ticket/update/'.$ticket->id) }}?status=2"
                                    onclick="selectDepartment(2, 'Status 2')">In Progress</a>

                                 <!-- Status 4 anchor -->
                                 <a class="dropdown-item" href="{{ url('admin/Ticket/update/'.$ticket->id) }}?status=3"
                                    onclick="selectDepartment(3, 'Status 3')">On Hold</a>

                                 <!-- Status 5 anchor -->
                                 <a class="dropdown-item" href="{{ url('admin/Ticket/update/'.$ticket->id) }}?status=4"
                                    onclick="selectDepartment(4, 'Status 4')">Resolved</a>

                                 <!-- Status 6 anchor -->
                                 <a class="dropdown-item" href="{{ url('admin/Ticket/update/'.$ticket->id) }}?status=5"
      ...
      <div class="col-lg-8 col-xl-9 primary-content">
         ...
         <div class="card d-print-none mt-2" id="ticketReplyContainer">
            <div class="card-body">
               ...
               <form action="{{url('admin/Ticket/chatInsert')}}" enctype="multipart/form-data" id="formId"
                  method="post">
                  @csrf
                  ...
                  <div class="form-group mt-3">
                      <label for="inputMessage" id="inputLabel">Message</label>
   ...
   function getStatus(val, ticketId) {
      bootbox.confirm({
         ...
         callback: function (result) {
            if (result == true) {
               $.ajax({
                  url: "{{url('admin/Ticket/markAsClosed')}}",
                  type: 'post',
