        ...
        <tbody>
          ...
          <tr class="inv-num">
            <td class="f-14 text-dark">
              ...
              @if($Quotes && $Quotes->company_name) {{$Quotes->company_name}} @endif
               @endif<br> 
              @if($Quotes && $Quotes->contact_no) {{$Quotes->contact_no}} @endif <br>
              @if($Quotes && $Quotes->billing_address) {{$Quotes->billing_address}} @endif
             </p> 
           </td>
           <td align="right">
            <table class="inv-num-date text-dark f-13 mt-3">
              <tbody>
                <tr>
                  ...
                  <td class="border-left-0">  @if($Quotes && $Quotes->invoice_number1) {{$Quotes->invoice_number1}} @endif @if($Quotes && $Quotes->invoice_number2) {{$Quotes->invoice_number2}} @endif </td>
                </tr>
                <tr>
                    ...
                    <tbody>
                        <tr>
                            <td align="end" height="30" colspan="2">
                                <img src="@if($Quotes && $Quotes->signature) {{$Quotes->signature}} @endif" class="mt-2 mb-2" height="70" width="15%">
                            </td>
                        </tr>
                        <tr>
                            <td>Note</td>
