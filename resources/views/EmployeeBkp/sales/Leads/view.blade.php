  ...
  <div class="col-xl-12 col-lg-12 col-md-5 order-1 order-md-0">
    ...
    <div class="card mb-4">
       <div class="card-header d-flex justify-content-between">
        ...
        <div class="parent">
        <a href="{{url('Employee/Leads/edit/'.$user->id)}}"class="btn btn-primary me-3" style="width: 0px;height:fit-content;"><i class="fas fa-edit"></i></a>
        <a href="{{url('Employee/Leads/home')}}"class="btn btn-success me-3" style="width: 0px;height:fit-content;"><i class="fas fa-arrow-left"></i></a>
        </div>
      </div>
      <div class="card-body">
        <div class="row">
        ...
        <table class="table table-hover bg-white rounded">
          ...
          <tbody>
            ...
            <tr>
              ...
              &nbsp;&nbsp; <a class="delete_debtcase" url="{{url('Employee/Leads/File/delete/'.$File->id.'/'.$user->id)}}" id="{{$File->id}}"><i class="fa-solid fa-trash"></i></a></td>
            </tr>
            @endforeach
            @else
            <tr>
...
<script>
    document.getElementById('noteDisplay').setAttribute('tabindex', '-1');
            ...
            <div id="noteEdit" style="display:none">
                <form id="noteForm" action="{{url('Employee/Leads/LeadNotesUpdate')}}" method="post">
                    @csrf
...
<div class="modal fade" id="FileModal" data-bs-backdrop="static" tabindex="-1" style="display: none;" aria-modal="true" role="dialog">
  <div class="modal-dialog">
    <form class="modal-content" action="{{url('Employee/Leads/File/store')}}" method="post" enctype="multipart/form-data">
      @csrf
      <div class="modal-header">
