                      ...
                      <div class="info-container">
                        <ul class="list-unstyled">
                          ...
                          <li class="mb-2 pt-1">
                            ...
                            @php
							                $assignedto =  \App\Models\User::select('id','first_name')->where('id',$user->assignedto)->first();           
                          ...
                          <li class="mb-2 pt-1">
                            ...
                            <span>@if($generated_by && $generated_by->first_name) {{$generated_by->first_name}} @endif</span>
                          </li>
                          <li class="mb-2 pt-1">
                            <span class="fw-medium me-1">Assigned To:</span>
                            <span>@if($assignedto && $assignedto->first_name) {{$assignedto->first_name}} @endif</span>
                          </li>
                          <li class="mb-2 pt-1">
