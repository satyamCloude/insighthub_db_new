      ...
      <div class="emails-list-header p-3 py-lg-3 py-2">
        ...
        <div class="d-flex justify-content-between align-items-center mb-2">
          <div class="d-flex align-items-center">
            ...
            <i class="ti ti-rotate-clockwise ti-sm rotate-180 scaleX-n1-rtl cursor-pointer me-2 email-list-restore"></i>
          ...
          <div
            ...
            <i class="email-prev ti ti-chevron-left ti-sm scaleX-n1-rtl cursor-pointer text-muted me-2" onclick="LoadBack(this)" data-type="trash"></i>
            <span class="d-sm-block d-none mx-3 text-muted" id="trashCount">1</span>
            <i class="email-next ti ti-chevron-right ti-sm scaleX-n1-rtl cursor-pointer" onclick="LoadMore(this)" data-type="trash"></i>
          </div>
        </div>
      </div>
...
$('.email-list-restore').click(function () {
