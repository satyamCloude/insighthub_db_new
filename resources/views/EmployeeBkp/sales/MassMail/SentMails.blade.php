          ...
          @if(count($SentMails) > 0)
           ...
           @php
               ...
               <div class="email-list-item-meta ms-auto d-flex align-items-center">
                 <span class="email-list-item-label badge badge-dot  @if($Send && $Send->status == '4') bg-danger @else bg-success @endif  d-md-inline-block me-2" data-label="important"></span>
