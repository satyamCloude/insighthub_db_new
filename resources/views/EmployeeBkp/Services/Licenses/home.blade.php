  ...
  <div class="card">
    <div class="row">
      ...
      <div class="col-md-6 text-end">
         <!--<a href="{{url('Employee/Licenses/EXPORTCSV')}}" class="btn btn-info mt-3 m-3"><i class="fa-solid fa-file-csv"></i></a>-->
          <a href="{{url('Employee/Licenses/home')}}" class="btn btn-warning mt-3 m-3"><i class="fas fa-sync-alt"></i></a>
          <!--<a href="{{url('Employee/Licenses/add')}}" class="btn btn-primary mt-3 m-3">Add</a>-->
      </div>
    </div>
                     ...
                     @if(in_array('Licenses', array_column($RoleAccess, 'per_name')))
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" style="">
                                ...
                                @if($RoleAccess[array_search('Licenses', array_column($RoleAccess, 'per_name'))]['update'] == 1)
                                     <li><a class="dropdown-item" href="{{url('Employee/Licenses/edit/'.$Licensess->id)}}">Edit</a></li>
                                @endif
                                @if($RoleAccess[array_search('Licenses', array_column($RoleAccess, 'per_name'))]['delete'] == 1)
                                    <li><button class="dropdown-item delete_debtcase" url="{{url('Employee/Licenses/delete/'.$Licensess->id)}}" id="{{$Licensess->id}}">Delete</button></li>
                                @endif
                            </ul>
                        </div>
                    @endif
