...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-3 mb-4"><span class="text-muted fw-light">Monthly Management /</span> Add</h4>
                <div class="col-12 mb-4"1>
                  <div id="wizard-validation" class="bs-stepper mt-2">
                      ...
                      <div class="step" data-target="#personal-info-validation">
                        <button type="button" class="step-trigger">
                          ...
                          <span class="bs-stepper-label">
                            <span class="bs-stepper-title">To Do</span>
                            <span class="bs-stepper-subtitle">Details</span>
                          </span>
                        </button>
                      </div>
                    ...
                    <div class="bs-stepper-content">
                      <form id="wizard-validation-form" method="post" action="{{url('Employee/MonthelySetup/store')}}" enctype="multipart/form-data">
                        @csrf
                        <!-- Account Details -->
                        <div id="account-details-validation" class="content">
                          ...
                          <div class="content-header mb-3">
                            ...
                            <div class="col-sm-12">
                              <label class="form-label" for="onetimesetup_notes">Monthly Management Notes</label>
                              <div class="editor-container">
                                    <div class="full-editor geteditor"></div>
                                    <input type="hidden" name="onetimesetup_notes" class="hidden-field">
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="personal-info-validation" class="content">
                          ...
                          <div class="row g-3">
                             <div class="col-sm-12">
                              ...
                              <div class="editor-container">
                                    <div class="full-editor geteditor"></div>
                                    <input type="hidden" name="todo_notes" class="hidden-field">
                                </div>
                            </div>
                            <div class="col-12 d-flex justify-content-between">
                        ...
                        <div id="social-links-validation" class="content">
                          ...
                          <div class="row g-3">
                            <div class="col-sm-6">
                              ...
                              <input type="text"name="control_panel_login_url" class="form-control"/>
                            </div>
                            <div class="col-sm-6">
                            ...
                            <div class="col-sm-6">
                              ...
                              <input type="text"name="control_panel_url" class="form-control"/>
                            </div>
                             <hr>
                            <div class="content-header mb-3">
