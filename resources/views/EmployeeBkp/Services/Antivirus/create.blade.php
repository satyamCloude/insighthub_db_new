                ...
                <div class="col-12 mb-4"1>
                  <div id="wizard-validation" class="bs-stepper mt-2">
                    ...
                    <div class="bs-stepper-content">
                      <form id="wizard-validation-form" method="post" action="{{url('Employee/Antivirus/store')}}" enctype="multipart/form-data">
                        @csrf
                        <!-- Account Details -->
                          ...
                          <div class="row g-3">
                            ...
                            <div class="col-sm-12">
                              ...
                              <div class="editor-container">
                                    ...
                                    <input type="hidden" name="antivirus_note" class="hidden-field">
                                </div>
                            </div>
                          ...
                          <div class="row g-3">
                            ...
                            <div class="col-sm-6">
                              <label class="form-label" for="valid_domain_upto">Valid Up to Domain  <span class="text-danger">*</span></label>
                                <input type="date" class="form-control" name="valid_domain_upto" required>
                            </div>
