...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-3 mb-4"><span class="text-muted fw-light">CloudServices /</span> Add</h4>
                <div class="col-12 mb-4">
                  <div id="wizard-validation" class="bs-stepper mt-2">
                    ...
                    <div class="bs-stepper-content">
                      <form id="wizard-validation-form" method="post" action="{{url('Employee/CloudServices/store')}}" enctype="multipart/form-data">
                        @csrf
                        <!-- Account Details -->
                        <div id="account-details-validation" class="content">
                          ...
                          <div class="col-sm-6">
                              ...
                              <select class="form-control" name="bare_metal_id">
                                    ...
                                    <option value="{{$BareMetals->id}}">{{$BareMetals->product_name}}</option>
                                    @endforeach
                              </select>
                            </div> 
                            <div class="col-sm-6">
                            ...
                            <div class="col-sm-12">
                              <label class="form-label" for="vps_notes">VPS Notes</label>
                               <div class="editor-container">
                                    ...
                                    <input type="hidden" name="vps_notes"  class="hidden-field">
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="personal-info-validation" class="content">
                          ...
                          <div class="row g-3">
                            <div class="col-sm-6">
                              ...
                              <input type="text"name="ip_kvm_console" class="form-control"/>
                            </div>
                            <div class="col-sm-6">
                              <label class="form-label" for="ip_kvm_username">User Name</label>
                              <input type="text"name="ip_kvm_username" class="form-control"/>
                            </div>
                            <div class="col-sm-6">
