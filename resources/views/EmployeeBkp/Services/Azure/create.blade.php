...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-3 mb-4"><span class="text-muted fw-light">Azure /</span> Add</h4>
                <div class="col-12 mb-4">
                  <div id="wizard-validation" class="bs-stepper mt-2">
                    ...
                    <div class="bs-stepper-content">
                      <form id="wizard-validation-form" method="post" action="{{url('Employee/Azure/store')}}" enctype="multipart/form-data">
                        @csrf
                        <!-- Account Details -->
                        <div id="account-details-validation" class="content">
                          ...
                          <div class="content-header mb-3">
                            ...
                            <div class="col-sm-6">
                              ...
                              <input type="text"name="azure_account_Id" class="form-control"/>
                            </div>
                            <div class="col-sm-6">
                            ...
                            <div class="col-sm-12">
                              ...
                              <div class="editor-container">
                                    ...
                                    <input type="hidden" name="azure_notes" class="hidden-field">
                                </div>
                            </div>
                          </div>
                        ...
                        <div id="personal-info-validation" class="content">
                          ...
                          <div class="row g-3">
                            <div class="col-sm-6">
                              ...
                              <input type="text"name="azure_login_url" class="form-control"/>
                            </div>
                            <div class="col-sm-6">
                              <label class="form-label" for="azure_username">Azure User Name <span class="text-danger">*</span></label>
                              <input type="text"name="azure_username" class="form-control"/>
                            </div>
                            <div class="col-sm-6">
