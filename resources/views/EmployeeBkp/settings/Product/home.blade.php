...
@section('title', 'Service Automation')
@section('content')
  ...
  <div class="card">
    <div class="row">
      ...
      <div class="col-md-6 text-end">
        <a href="{{url('Employee/Product/home')}}" class="btn btn-warning mt-3 m-3"><i class="fas fa-sync-alt"></i></a>
          ...
          <a href="{{url('Employee/Product/add')}}" class="btn btn-primary mt-3 m-3">Add Product</a>
      </div>
    </div>
                  ...
                  <td>
                    <div class="btn-group">
                          ...
                          <ul class="dropdown-menu dropdown-menu-end" style="">
                            ...
                            <li><button class="dropdown-item delete_debtcase1" url="{{url('Employee/Category/delete/'.$Cat->id)}}" id="{{$Cat->id}}">Delete</button></li>
                          </ul>
                      </div>
                  </td>
              </tr>
               @foreach($Cat->products as $key=> $user)
              <tr class="odd">
                  <td>{{ $key+1 }} </td>
                  ...
                  <td>
                    <div class="btn-group">
                          ...
                          <ul class="dropdown-menu dropdown-menu-end" style="">
                            <li><a class="dropdown-item" href="{{url('Employee/Product/edit/'.$user->id)}}">Edit</a></li>
                            <li><button class="dropdown-item delete_1" url="{{url('Employee/Product/delete/'.$user->id)}}" id="{{$user->id}}">Delete</button></li>
                          </ul>
                      </div>
                  </td>
              </tr>
...
<div class="modal fade" id="backDropModal" data-bs-backdrop="static" tabindex="-1" style="display: none;" aria-modal="true" role="dialog">
    <div class="modal-dialog">
      <form class="modal-content" action="{{url('Employee/Category/store')}}" method="post">
        @csrf
...
function editCategory(element) {
    ...
    $.ajax({
        url: "{{ url('Employee/Category/edit') }}",
        method: 'GET',
        data: { id: cate_id },
