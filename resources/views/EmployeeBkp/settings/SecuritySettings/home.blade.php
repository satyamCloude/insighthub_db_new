...
<div class="container-xxl flex-grow-1 container-p-y">
  <h4 class="py-3 mb-4"><span class="text-muted fw-light">Security Settings /</span> Home</h4>
      ...
      <div class="card-datatable table-responsive">
       ...
       <div class="row">
                ...
                <div class="border-grey mt-3 p-4 rounded-top">
                    <div class="row justify-content-center">
                        <div class="col-md-1 d-flex justify-content-center align-self-baseline">
                            <img src="https://demo-saas.worksuite.biz/img/google-authenticator-2.svg" width="27" alt="">
                        </div>
                        <div class="col-md-11">
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-md-11">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <input type="radio" name="mail2" id="cMicrosoft" value="microsoft" @if($Complete && $Complete->microsoft == "1") checked @endif   onclick="Completemailsetup(value)"  >
                                        <label for="radio3">Via Microsoft Office</label>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="modal fade" id="backDropModal" data-bs-backdrop="static" tabindex="-1">
                ...
                <form method="POST" id="reset-password-form" action="{{ url('Employee/SecuritySettings/confirm_password') }}" class="ajax-form modal-content" autocomplete="off">
                    @csrf
...
<script>
    function checkPass() {
        ...
        // Perform AJAX request to check the password on the server side
          $.ajax({
            url: "{{ url('Employee/SecuritySettings/confirm_password') }}",
            type: "POST",
...
function BulkMail(value)
{
    var type = "Bulk"; 
     $.ajax({
                url: "{{ url('Employee/MailSettings/MailViaUpdate') }}",
                type: "get",
