                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    ...
                                                    <p class="text-muted mb-0">{{$docxCount}} files</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div> <!--end col-->
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    ...
                                                    <p class="text-muted mb-0">{{$imageCount}} images</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div> <!--end col-->
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    ...
                                                    <p class="text-muted mb-0">{{$videoCount}} videos</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div> <!--end col-->
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    ...
                                                    <p class="text-muted mb-0">{{$audioCount}} files</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div> <!--end col-->
...
<div class="modal fade" id="share-folder" tabindex="-1" aria-labelledby="paymentModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form action="{{ url('admin/FileManagement/share-folder') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-header">
                    <h4>Share Folder</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form action="{{ url('Employee/FileManagement/e-store-sub-folder') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <label>Employee</label>
                    <select class="form-control select2" name="share_ids[]" multiple>
...
<script>
   $(document).ready(function() {
    $('#file_folder_id').on('change', function() {
        ...
        // Clear previous subfolder options
    ...
    $(document).on('click', '.delete-sub-folder', function (e) {
        ...
        var url = '/Employee/FileManagement/e-delete-sub-folder/' + folderId;
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            employeeSelect.select2({
                dropdownParent: $('#share-folder') // Ensure the dropdown is displayed within the modal
            });
        },
        error: function (xhr) {
            console.error('An error occurred:', xhr.responseText);
...
// Ensure select2 is initialized on document ready for any pre-existing elements
$(document).ready(function() {
    $('.select2').select2({
        dropdownParent: $('#share-folder') // Ensure the dropdown is displayed within the modal
    });
