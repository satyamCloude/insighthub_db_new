...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-3 mb-4"><span class="text-muted fw-light">Employee /</span> Payroll</h4>
    <!-- <a href="{{url('Employee/PayRoll/home2')}}" class="btn btn-label-primary me-3">
    ...
    <div class="row mt-4 mb-4">
        ...
        <div class="col-md-8" style="text-align: end;">
            <div class="btn-group justify-content-center" >
                ...
                <!--<a href="{{url('Employee/PayRoll/EXPORTCSV')}}" class="btn btn-secondary buttons-collection btn-label-primary waves-effect waves-light" tabindex="0" aria-controls="DataTables_Table_0" type="button" aria-haspopup="dialog" aria-expanded="false">-->
                <!--    <span>-->
                        <!-- <i class="ti ti-file-export me-sm-1"></i> -->
                <!--        <span class="d-none d-sm-inline-block">Export</span>-->
                <!--    </span>-->
                <!--</a>-->
                <a href="{{url('Employee/PayRoll/GenerateSellary')}}" class="btn btn-info">
                	<span>
                        <!-- <i class="fas fa-sync-alt"></i> -->
                        <span class="d-none d-sm-inline-block">Generate</span>
                    </span></a>
                <!-- <a href="{{url('Employee/PayRoll/home')}}" class="btn btn-secondary"><i class="fas fa-sync-alt"></i></a> -->
            </div>
        </div>
	</div>
	<div class="row">
                            ...
                            <table class="dt-responsive table dataTable dtr-column" id="DataTables_Table_3" aria-describedby="DataTables_Table_3_info">
                                ...
                                <tbody id="result">
                                    ...
                                    <tr class="odd">
                                        <td>{{ $key+1 }} </td>
                                        <td>
                                            <img class="rounded-circle" style="margin-right: 15px;margin-top: 10px;" src="{{isset($user->profile_img) ? $user->profile_img : url('public/images/21104.png')}}" height="30" width="30" alt="User avatar" />{{ $user->first_name }}
                                        ...
                                        <td>
                                            ...
                                            <a href="{{url('Employee/PayRoll/view/'.$user->user_id)}}" class="text-info" ><i class="fas fa-eye pointer-cursor"></i></a>&nbsp;&nbsp;
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" action="{{url('Employee/PayRoll/Rules/update/'.$Rules->id)}}">
                            @csrf
                            <div class="row">
    ...
    <script type="text/javascript">
            ...
            function fetchData() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#empTotalPercent').html(applyColor(data.data.empTotalPercent));

                        $('#totalWorkingHours').text(data.data.totalWorkingHours);
                        $('#empTotalWorkHrs').html(applyColor(data.data.empTotalWorkHrs));
                        $('#totalPayrollCost').text(data.data.totalPayrollCost);
                        $('#payrollCostChange').html(applyColor(data.data.payrollCostChange));
                        $('#totalNetSalary').text(data.data.totalNetSalary);
                        $('#netSalaryChange').html(applyColor(data.data.netSalaryChange));
                        $('#totalNetDeduction').text(data.data.totalNetDeduction);
                        $('#netDeductionChange').html(applyColor(data.data.netDeductionChange));
                        $('#totalNetTds').text(data.data.totalNetTds);
                        $('#netTdsChange').html(applyColor(data.data.netTdsChange));
                    },
                    error: function() {
        ...
        function Salary() {
            $.ajax({
                url: "{{ url('Employee/PayRoll/Salary') }}",
                method: 'GET',
                success: function(data) {
                    // Handle the successful response
        ...
        function Deduction() {
            $.ajax({
                url: "{{ url('Employee/PayRoll/Deduction') }}",
                method: 'GET',
                success: function(data) {
                    // Handle the successful response
                    $('#newpayroll').empty(); // Clear previous content
