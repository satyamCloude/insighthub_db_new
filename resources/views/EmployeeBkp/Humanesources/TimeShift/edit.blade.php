        ...
        <div class="card">
          <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row">
            ...
            <div class="action-btns">
              <a href="{{url('Employee/TimeShift/home')}}" class="btn btn-label-primary me-3">
                <span class="align-middle"> Back</span>
              </a>
            </div>
          </div>
          <form action="{{url('Employee/TimeShift/update/'.$TimeShift->id)}}" method="post" enctype="multipart/form-data"> 
            @csrf
            <div class="card-body">
            ...
            <div class="card-footer">
              <div class="row mb-4"> 
                <div class="col-sm-6 mb-4 text-end" >
                  <a href="{{url('Employee/TimeShift/home')}}" type="button" class="btn btn-outline-danger">Discard</a>
                </div>
                <div class="col-sm-6 mb-4">
