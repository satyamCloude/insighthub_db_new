    ...
    <div class="card-body">
        ...
        <hr>
              ...
              <div class="row mb-4"> 
                ...
                <!--            @foreach($Teamlead as $Team)-->
                <!--            <option @if($EmployeeDetail && $EmployeeDetail->team_lead_id == $Team->id) selected @endif value="{{$Team->id}}">{{$Team->first_name}}</option>-->
                <!--            @endforeach-->
                <!--    </select>-->
                <!--</div>-->
                
                    <div class="col-md-4" id="team_lead_section"      @if($EmployeeDetail && $EmployeeDetail->team_lead == '1') style="display: none;" @endif>
                <label for="client_id" class="form-label">Team Lead <span class="text-danger">*</span></label>
                <div class="dropdown">
                  <button class="dropbtn"  type="button" id="selected_client_btn">Select Team Lead <i class="fa fa-angle-down" style="font-size:24px"></i></button>
                ...
                <input type="hidden" name="team_lead_id" id="set_client_id">
            </div>
                <div class="col-md-6 ">
