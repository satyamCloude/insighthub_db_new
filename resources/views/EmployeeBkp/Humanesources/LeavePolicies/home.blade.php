  ...
  <div class="card">
    <div class="row">
      ...
      <div class="col-md-6 text-end">
          <!--<a href="{{url('Employee/LeavePolicies/add')}}" class="btn btn-primary mt-3 m-3">Add Policies</a>-->
      </div>
    </div>
  </div>
      ...
      <div class="card mt-3">
        ...
        <div class="card-body">
          ...
          <div class="col-md-6">
              ...
              <!--<a href="{{url('Employee/LeavePolicies/edit/'.$Leave->id)}}" class="btn btn-primary waves-effect waves-float waves-light text-white"><i class="fa-regular fa-pen-to-square"></i></a>-->
              <!--<a  url="{{url('Employee/LeavePolicies/delete/'.$Leave->id)}}" id="{{$Leave->id}}" class="btn btn-danger waves-effect waves-float waves-light text-white delete_debtcase"><i class="fa-solid fa-trash"></i></a>-->
...
function viewplecy(element) {
    ...
    $.ajax({
        url: "{{ url('Employee/LeavePolicies/view') }}",
        method: 'GET',
        data: { id: cate_id },
