  ...
  <div class="card">
    <div class="row">
      ...
      <div class="col-md-6 text-end">
         <a href="{{url('Employee/Project/EXPORTCSV')}}" class="btn btn-info mt-3 m-3"><i class="fa-solid fa-file-csv"></i></a>
          <a href="{{url('Employee/Project/home')}}" class="btn btn-warning mt-3 m-3"><i class="fas fa-sync-alt"></i></a>
          @if($RoleAccess[array_search('Project', array_column($RoleAccess, 'per_name'))]['add'] == 1)
          <a href="{{url('Employee/Project/add')}}" class="btn btn-primary mt-3 m-3">Add</a>
          @endif
      </div>
    </div>
                      ...
                      <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" class="avatar pull-up" data-bs-original-title="{{$teaml->first_name}}">
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" style="">
                                @if($RoleAccess[array_search('Project', array_column($RoleAccess, 'per_name'))]['view'] == 1 || $RoleAccess[array_search('Project', array_column($RoleAccess, 'per_name'))]['view'] == 2)
                                    <li><a class="dropdown-item" href="{{url('Employee/Project/edit/'.$Inventor->id)}}">Edit</a></li>
                                @endif
                                @if($RoleAccess[array_search('Project', array_column($RoleAccess, 'per_name'))]['update'] == 1)
                                    <li><a class="dropdown-item" href="{{url('Employee/Project/view/'.$Inventor->id)}}">View</a></li>
                                @endif
                                @if($RoleAccess[array_search('Project', array_column($RoleAccess, 'per_name'))]['delete'] == 1)
                                   <li><button class="dropdown-item delete_debtcase" url="{{url('Employee/Project/delete/'.$Inventor->id)}}" id="{{$Inventor->id}}">Delete</button></li>
                                @endif
                            </ul>
                        </div>
                    @endif
...
function updatepro(status,value,id){
  $.ajax({
        url: "{{ url('Employee/Project/UpdateStatus') }}",
        method: 'GET',
        data: { id: id,
                status_pro: value, 
                status : status
