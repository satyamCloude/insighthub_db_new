    ...
    <input type="tel" name="phone_number" id="phone_number" class="inpt form-control" required placeholder="+1234567890" pattern="[0-9+]{1,10}" maxlength="10" oninput="this.value = this.value.replace(/[^0-9+]/g, '').slice(0, 10);">
                        ...
                        <div class="row mb-4"> 
                          <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" name="gstin" id="exampleFormControlInput1" placeholder="GSTIN" required/>
                          </div>
                          <div class="col-md-3">
                          ...
                          <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" name="tds" id="exampleFormControlInput1" placeholder="TDS" required/>
                          </div>
                          <div class="col-md-3">
                         ...
                         <div class="col-md-6">
                          ...
                          <div class="col-md-6">
                            <label for="exampleFormControlInput1" class="form-label">Document for Verification</label>
                                  <input type="file" name="doc_verify" class="form-control" id="inputGroupFile01" required >
                          </div>
                        </div>
            </div>
