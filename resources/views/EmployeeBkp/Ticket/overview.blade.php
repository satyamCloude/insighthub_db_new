...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="col-lg-4 col-xl-4 col-sm-6 mb-4">
        <div class="card h-100">
            <div class="card-body pb-0">
                ...
                <h5 class="mb-0">{{ $averageResolutionTime }} Hrs</h5>
            </div>
    ...
    <div class="col-xl-4 col-lg-4 col-sm-6 mb-4">
        <div class="card h-100">
            <div class="card-header pb-0">
                ...
                <h5 class="mb-0">{{ $averageResponseTime }} Hrs</h5>
            </div>
  ...
  <div class="row">
    ...
    <div class="col-12 col-xl-6 mb-4 order-1 order-lg-0">
            ...
            <div class="card-header flex-column flex-md-row">
              ...
              <div class="dt-action-buttons text-end pt-3 pt-md-0">
                ...
                <div class="dt-buttons btn-group flex-wrap">
                  ...
                  <a class="btn btn-secondary create-new btn-primary waves-effect waves-light" tabindex="0" aria-controls="DataTables_Table_0" href="{{url('/Employee/Ticket/add')}}">
    ...
    <tr class="odd">
        ...
        <td>{{$department->average_time_spent}}</td>
    </tr>
    @endforeach
</tbody>
...
<script type="text/javascript">
  document.addEventListener("DOMContentLoaded", function() {
    ...
    const earningReportsChart = {!! $ticketCounts !!};
