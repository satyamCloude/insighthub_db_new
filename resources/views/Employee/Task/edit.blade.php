        ...
        <div class="card">
          <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row">
            ...
            <div class="action-btns">
              <a href="{{url('Employee/Task/home')}}" class="btn btn-label-primary me-3">
                <span class="align-middle"> Back</span>
              </a>
            </div>
          </div>
          <form action="{{url('Employee/Task/update/'.$Task->id)}}" method="post" enctype="multipart/form-data"> 
            @csrf
            <div class="card-body">
              ...
              <div class="row "> 
                ...
                <div class="col-sm-6 mb-4">
                      ...
                      <select class="form-select" name="Taskcategory_id">
                ...
                <div class="col-sm-12 mb-4">
                      ...
                      <select class="form-select select select2" name="AssignedTo[]" multiple required>
                          ...
                          <option value="{{$Employee->id}}" @if($Task && $Task->AssignedTo == $Employee->id) selected @endif>{{$Employee->first_name}}</option>
                          @endforeach
                      </select>
                </div>
                <div class="col-sm-12 mb-4">
