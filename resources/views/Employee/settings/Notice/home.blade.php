...
<div class="container-xxl flex-grow-1 container-p-y">
  <h4 class="py-3 mb-4"><span class="text-muted fw-light">Notice /</span> Home</h4>
    @if(Session::has('success'))
   <div class="alert alert-success" Notice="alert">{{ Session::get('success') }}</div>
    @endif
  ...
  <div class="card">
    <div class="row">
      ...
      <div class="col-md-6 text-end">
        <a href="{{url('Employee/Notice/home')}}" class="btn btn-warning mt-3 m-3"><i class="fas fa-sync-alt"></i></a>
          <a href="{{url('Employee/Notice/add')}}" class="btn btn-primary mt-3 m-3">Add</a>
      </div>
    </div>
                  ...
                  <td>
                    <div class="btn-group">
                          ...
                          <ul class="dropdown-menu dropdown-menu-end" style="">   
                            <li><a class="dropdown-item" href="{{url('Employee/Notice/edit/'.$user->id)}}">Edit</a></li>
                            <li><button class="dropdown-item delete_debtcase" url="{{url('Employee/Notice/delete/'.$user->id)}}" id="{{$user->id}}">Delete</button></li>
                          </ul>
                      </div>
                  </td>
              </tr>
