...
">        <p class="mb-0 text-lg-right text-md-right f-15 font-weight-bold text-dark-grey d-grid align-items-center text-end" style="padding-right:10px;">
                  ...
                  <div class="row">
                    ...
                    <div class="col-6">
                      ...
                      <ul class="list-unstyled mb-0">
                        ...
                        <li class="d-flex mb-4 align-items-center">
                         @if($TotalAsgProjects && $TotalAsgProjects != 'N/A')
                             <p class="mb-0 fw-medium me-2 website-analytics-text-bg" id="open_task"

                          style="min-width: 72px;">{{$TotalAsgProjects}}</p>
                         
                          <p class="mb-0">Total Assigned Project</p>
                            @endif
                        </li>
               ...
               <div class="row gy-3">
                  ...
                  <div class="col-md-6 col-6">
                     <div class="d-flex align-items-center">
                        ...
                        <div class="card-info">
                           <h5 class="mb-0">{{$CompletedProjects}}</h5>
                  ...
                  <div class="col-md-6 col-6">
                     <div class="d-flex align-items-center">
                        ...
                        <div class="card-info">
                           <h5 class="mb-0">{{$InProgrsProjects}}</h5>
                           <small>In progress Projects</small>
                        </div>
                     </div>
                  </div>
                  <div class="col-md-6 col-6">
 ...
 <div class="col-xl-6 col-md-12 mb-4" style="300px">
    ...
    <div class="col-12 col-xl-8 mb-4" style="300px">
      ...
      <div class="col-xl-4 col-md-6 mb-4"  style="200px">
         <div class="card h-100" style="100%">
               <div class="row" style="height:100%">
                  <!-- Generated Leads -->
                  <div class="col-12 mb-4" style="height:100%">
      ...
      <!--/ Popular Product -->
      <!--upcoming event-->
        <div class="col-xl-4 mb-4 col-md-4 col-6" style="height:497px">
...
<script>
    ...
    // Function to handle the clock action
