            ...
            @foreach($Performance as $user)
                @php
                    ...
                    if ($workingHoursData && $workingHoursData->working_days > 0) {
                        ...
                        // Validate if $averageHoursPerDay and $shiftHours are numeric
                        if (is_numeric($averageHoursPerDay) && is_numeric($shiftHours) && $shiftHours > 0) {
                            ...
                            // Handle the case where $averageHoursPerDay or $shiftHours is not numeric or $shiftHours <= 0
                            // You can set a default rating or handle it based on your application logic
                            $workingHoursRating = 10; // Default rating or any other fallback
                        }
                    } else {
                        // Handle the case where $workingHoursData or $workingHoursData->working_days <= 0
                        // You can set a default rating or handle it based on your application logic
                        $workingHoursRating = 10; // Default rating or any other fallback
                    }
