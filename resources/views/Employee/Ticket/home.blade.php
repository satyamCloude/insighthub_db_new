  ...
  <div class="card">
    ...
    <div class="row">
      ...
      <div class="col-6 text-end">
        ...
        <a href="{{url('Employee/Ticket/home')}}" class="btn btn-primary text-white mt-4 me-4">
        ...
        <a href="{{url('Employee/Ticket/add')}}" class="btn  btn-primary text-white mt-4 me-4"><i class="fa-solid fa-plus">&nbsp;&nbsp;</i>Create Ticket</a>
      ...
      <div id="DataTables_Table_3_wrapper" class="dataTables_wrapper dt-bootstrap5">
        ...
        <table class="dt-responsive table dataTable dtr-column" id="DataTables_Table_3" aria-describedby="DataTables_Table_3_info">
          ...
          <tbody>
            ...
            $client = \App\Models\User::select('first_name','profile_img','email')->where('id',$Tick->ccid)->first();

            $clientUser = \App\Models\User::select('first_name','profile_img','email')->where('id',$Tick->client_id)->first();
              ...
              <td>
                ...
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu">
                    ...
                    <a class="dropdown-item text-dark" href="{{url('Employee/Ticket/view/'.$Tick->client_id.'?ticketId='.$Tick->id)}}"><i class="ti ti-eye me-1"></i> View</a>

                    <a class="dropdown-item text-dark" href="{{url('Employee/Ticket/edit/'.$Tick->id)}}"><i class="ti ti-pencil me-1"></i> Edit</a>

                    <a class="dropdown-item delete_debtcase text-dark" url="{{url('Employee/Ticket/delete/'.$Tick->id)}}"><i class="ti ti-trash me-1"></i> Delete</a>
    ...
    {{ $Ticket->appends(['search' => $searchTerm, 'from' => $fromDate, 'to' => $toDate, 'status' => $status])->links() }}
</div>
