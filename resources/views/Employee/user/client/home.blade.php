    ...
    <div class="row">
      ...
      <div class="card-datatable table-responsive">
        ...
        <tr class="odd">
                  <td>{{ $key+1 }} </td>
                   <td>
                    <a href="{{url('Employee/Client/view/'.$MyClients->id)}}">   
                            
                            <div class="parent d-flex">
                                  <div class="child1"> @if($MyClients->profile_img)
                                 <img 
                                    class="rounded-circle"
                                    style="margin-right: 15px;margin-top: 10px;" 
                                    src="{{$MyClients->profile_img}}"
                                    height="30"
                                    width="30"
                                    alt="User avatar" /> 
                              @else
                              ...
                              @endif   </div>
                          <div class="child2">{{ $MyClients->first_name }}  {{ $MyClients->last_name }}  ({{$MyClients->id}}) <br>{{ $MyClients->company_name }}</div>
                          </div>
        ...
        <tr class="even">
                  <td>{{ $key+1 }} </td>
                   <td>
                    <a href="{{url('Employee/Client/view/'.$user->id)}}">   
                            ...
                            <div class="parent d-flex">
                              ...
                              @endif   </div>
                          <div class="child2">{{ $user->first_name }}  {{ $user->last_name }}  ({{$user->id}}) <br>{{ $user->company_name }}</div>
                          </div>
