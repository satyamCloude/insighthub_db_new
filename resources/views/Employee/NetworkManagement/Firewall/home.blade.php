  ...
  <div class="card">
    <div class="row">
      ...
      <div class="col-md-6 text-end">
        <a href="{{url('Employee/Firewall/home')}}" class="btn btn-warning mt-3 m-3"><i class="fas fa-sync-alt"></i></a>
           @if($RoleAccess[array_search('Firewall', array_column($RoleAccess, 'per_name'))]['add'] == 1)
          <a href="{{url('Employee/Firewall/add')}}" class="btn btn-primary mt-3 m-3">Add</a>
          @endif
      </div>
    </div>
                  ...
                  <td>
                    <div class="btn-group">
                          ...
                          <ul class="dropdown-menu dropdown-menu-end" style="">
                                @if($RoleAccess[array_search('Firewall', array_column($RoleAccess, 'per_name'))]['update'] == 1)
                                    <li><a class="dropdown-item" href="{{url('Employee/Firewall/edit/'.$user->id)}}">Edit</a></li>
                                @endif
                                @if($RoleAccess[array_search('Firewall', array_column($RoleAccess, 'per_name'))]['delete'] == 1)
                                    <li><button class="dropdown-item delete_debtcase" url="{{url('Employee/Firewall/delete/'.$user->id)}}" id="{{$user->id}}">Delete</button></li>
                                @endif
                          </ul>
                      </div>
                  </td>
