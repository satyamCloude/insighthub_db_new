      ...
      <div class="card">
         <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row" style="background:linear-gradient(72.47deg, #7367f0 22.16%, rgba(115, 103, 240, 0.7) 76.47%);">
            ...
            <div class="action-btns">
               <a href="{{url('Employee/Quotes/home')}}" class="btn btn-label-primary me-3" style="background-color:white;">
            ...
            <div class="card-body">
               ...
               <div class="row mb-4">
                  <div class="col-md-6">
                     ...
                     <input type="text" class="form-control" id="first_name" name="first_name" @if($lead) value="{{$lead->first_name}}" @endif placeholder="ABC" required/>
                  </div>
                  <div class="col-md-6">
                     <label for="last_name" class="form-label">Last name <span class="text-danger">*</span></label>
                     <input type="text" class="form-control" id="last_name" name="last_name" @if($lead) value="{{$lead->last_name}}" @endif placeholder="+ABC" required/>
                  </div>
               </div>
               <div class="row mb-4">
                  <div class="col-md-6">
                     <label for="email" class="form-label">Email address <span class="text-danger">*</span></label>
                     <input type="email" class="form-control" id="email" name="email" @if($lead) value="{{$lead->email}}" @endif placeholder="name@example.com" required/>
                  </div>
                  <div class="col-md-6">
...
<script>
  ...
  $('#invoice_number2').keyup(function () {
      ...
      $.ajax({
          type: 'GET',
          url: "{{url('Employee/Invoices/check_invoice_number')}}",
          data: {
