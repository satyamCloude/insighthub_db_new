    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <form action="{{url('Employee/Leave/updateLeave/'.$Leave->id)}}" method="post" enctype="multipart/form-data"> 
            @csrf
            <div class="card-body">
      ...
      @endforeach
                <input type="hidden" name="emp_Id" id="set_emp_id2" value="{{ $Leave->user_id }}">
...
<script>
   $(document).ready(function() {
      ...
      var selectedEmpId = '{{ $Leave->user_id }}';
