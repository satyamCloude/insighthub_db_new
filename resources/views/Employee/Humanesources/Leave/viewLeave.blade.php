    ...
    <div class="alert alert-success" role="alert" id="ResMsg" style="display:none;"></div>
     ...
     <div class="row g-4 mb-4 d-flex">
         <div class="col-sm-2 col-xl-4">
                     ...
                     <div class="card">
                        <div class="card-body">
                           <h4 class=""><span class="text-muted fw-light"> @if($user_details->profile_img)
                            <img 
                            ...
                            />
                            @endif
                        {{ucfirst($user_details->first_name) }} {{ucfirst($user_details->last_name) }}<div style="font-size:12px;margin-left: 46px;margin-top: -11px;">{{$user_details->email}}</div></h4>
                        </div>
                     </div> 
                  </div>
              ...
              <div class="timeline-event">
                ...
                <div class="d-flex justify-content-between flex-wrap mb-2">
                  <div class="d-flex align-items-center" style="user-select:none;pointer-events: none;">
                    ...
                    <span id="mySpan">{{$myleave->leave_type}}</span>
                  </div>
                  <div>
<span class="text-muted">{{ date('d F Y h:i A', strtotime($myleave->created_at)) }}</span>
      ...
      <img 
                    ...
                    <span id="mySpan">@if($myleave && $myleave->reply) {{ $myleave->reply }}@else -- @endif
</span>
...
<input type="hidden" value="{{$id}}" name="emp_id" id="emp_id">
  ...
  function editCategory(element) {
    ...
    $(document).ready(function () {
        ...
        function fetchData() {
            ...
            $.ajax({
                url: "{{ url('Employee/Leave/Show_leaves_yeardata_single') }}",
                method: 'GET',
