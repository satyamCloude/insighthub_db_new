...
<!--<a href="{{url('Employee/Leave/home2')}}"  target="_blank" class="btn btn-label-primary me-3">New Page-->
<!--                            </a>-->
                          </div>
...
<div class="row g-4 mb-4 d-flex" style="justify-content:center;">
    ...
    <div class="col-sm-3 col-xl-3">
        <a href="{{ url('Employee/Leave/home?status=0&months=' . request('months') . '&year=' . request('year') . '&fromDate=' . request('fromDate') . '&toDate=' . request('toDate')) }}">
            <div class="card">
                <div class="card-body">
    ...
    <div class="col-sm-3 col-xl-3">
        <a href="{{ url('Employee/Leave/home?status=1&months=' . request('months') . '&year=' . request('year') . '&fromDate=' . request('fromDate') . '&toDate=' . request('toDate')) }}">
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-start justify-content-between">
                        <div class="content-left">
    ...
    <div class="col-sm-3 col-xl-3">
        <a href="{{ url('Employee/Leave/home?status=2&months=' . request('months') . '&year=' . request('year') . '&fromDate=' . request('fromDate') . '&toDate=' . request('toDate')) }}">
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-start justify-content-between">
                        <div class="content-left">
    ...
    <!-- Pending Leaves Card -->
    <div class="col-sm-3 col-xl-3">
        <a href="{{ url('Employee/Leave/home?status=3&months=' . request('months') . '&year=' . request('year') . '&fromDate=' . request('fromDate') . '&toDate=' . request('toDate')) }}">
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-start justify-content-between">
                        <div class="content-left">
...
<!-- Users List Table -->
                           @if($AuthRole->job_role_id == 2 || $AuthRole->team_lead == 1)
        ...
        <div class="col-sm-12 col-md-8 d-flex justify-content-center justify-content-md-end">
          <div id="DataTables_Table_3_filter" class="dataTables_filter">
                <form method="GET" action="">    
                        ...
                        <label>From: <input type="date" id="fromDate" class="form-control" name="fromDate"></label>
                        <label>To: <input type="date" id="toDate" class="form-control" name="toDate"></label>
                        <input type="submit" value="Search" class="form-control">
                    </form>
          </div>
                                     @if($AuthRole->job_role_id == 2)

                    <a href="{{url('Employee/Leave/addLeave')}}" class="btn btn-primary mt-3 m-3">Add Leave</a>
@endif
        </div>
      </div>
          ...
          @foreach($requestedLeaves as $key=> $user)
           <!-- //employee -->
             ...
             <tr class="odd">
                  ...
                  <td>@if($user && $user->start_date) {{ $user->start_date }} @else {{ $user->start_date }} @endif </td>
                  <td>@if($user && $user->end_date) {{ $user->end_date }} @else {{ $user->end_date }} @endif </td>
                  <td>
                      @if($user->duration == 1)
                          {{ 'Full Day' }}
                 ...
                 <td>
                    <div class="btn-group">
                          ...
                          <ul class="dropdown-menu dropdown-menu-end" style="">
                            <li><a class="dropdown-item" href="{{url('Employee/Leave/editLeave/'.$user->id)}}">Edit</a></li>
                             <li><a class="dropdown-item" href="{{url('Employee/Leave/viewLeave/'.$user->id)}}">View</a></li>
                          </ul>
                      </div>
                  </td>
                </tr>
          ...
          <tr class="odd">
             ...
             <td>
                <img 
                        ...
                        height="30"
                        width="30"
                        alt="User avatar" />{{$user->first_name }} {{$user->last_name }} <br>({{$user->roles}})
                      </td>
              <td>@if($user && $user->date) {{ $user->date }} @else {{ $user->start_date }} @endif </td>
                  <td>@if($user && $user->start_date) {{ $user->start_date }} @else {{ $user->start_date }} @endif </td>
                  <td>@if($user && $user->end_date) {{ $user->end_date }} @else {{ $user->end_date }} @endif </td>
...
@endif
                  ...
                  <div class="col-xl-12 col-12 mb-4 " style="display:none" >
...
">{{$status}}</button>
    ...
    <span id="mySpan">{!! $myleave->description !!}</span>
