  ...
  <div class="card mt-4">
    <div class="row">
      ...
      <div class="col-md-6 text-end">
        <a href="{{url('Employee/Attendence/home')}}" class="btn btn-warning mt-3 m-3"><i class="fas fa-sync-alt"></i></a>
          <a href="{{url('Employee/Attendence/add')}}" class="btn btn-primary mt-3 m-3">Add</a>
      </div>
    </div>
            ...
            <tr>
                ...
                <td>
                    <div class="parent d-flex">
                        ...
                        <div class="child2">
                            <a href="{{ url('Employee/Attendence/View/'.$row->emp_id) }}">
                ...
                <td>
                    {{ isset($row->total_seconds) ? floor($row->total_seconds / 3600) . 'h ' . floor(($row->total_seconds % 3600) / 60) . 'min ' . ($row->total_seconds % 60) . 'sec' : '0h 0min 0sec' }}
                </td>
                <td>
                    {{ isset($row->break_seconds) ? floor($row->break_seconds / 3600) . 'h ' . floor(($row->break_seconds % 3600) / 60) . 'min ' . ($row->break_seconds % 60) . 'sec' : '0h 0min 0sec' }}
                </td>
                <td>
                    {{ isset($totalOvertime) ? $totalOvertime : '0h 0min 0sec' }}
                </td>
                <td>
                    {{ isset($row->total_seconds) ? floor($row->total_seconds / 3600) . 'h ' . floor(($row->total_seconds % 3600) / 60) . 'min ' . ($row->total_seconds % 60) . 'sec' : '0h 0min 0sec' }}
                </td>
                <td><a href="{{ url('Employee/Attendence/View/'.$row->emp_id) }}"><i class="fa fa-eye"></i></a></td>
            </tr>
            @endforeach
        @else
            <tr>
