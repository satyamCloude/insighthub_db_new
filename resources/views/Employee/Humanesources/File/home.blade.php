                        ...
                        <div class="card-body">
                            <div class="d-flex flex-column h-100">
                                <div class="">
                                    ...
                                    <div>
                                        <!--<h6 class="">My Folders</h6>-->
                                        <ul class="list-unstyled categories-list">
                                          
                                                <!--        @if(count($folders))-->
                                                <!--     @foreach($folders as $folder)-->
                                                <!--        <li>-->
                                                <!--            <a href="#" class="text-body d-flex align-items-center open-files" data-id="{{ $folder->id }}">-->
                                                <!--                <i class="mdi mdi-file font-size-20 text-warning me-2"></i>-->
                                                <!--                <span class="me-auto">{{ substr(str_replace('_', ' ', $folder->folder_name), 0, 18) }}</span>-->
                                                <!--            </a>-->
                                                <!--        </li>-->
                                                <!--    @endforeach-->
                                                <!--@else-->
                                                ...
                                                <li>
                                                    <div class="custom-accordion">
                                                        <a class="text-body fw-medium py-1 d-flex align-items-center" data-bs-toggle="collapse" href="#all-folder-collapse" role="button" aria-expanded="true" aria-controls="all-folder-collapse">
                                                            <i class="mdi mdi-folder font-size-20 text-warning me-2"></i>My Folders<i class="mdi mdi-chevron-up accor-down-icon ms-auto"></i>
                                                        </a>
                                                        <div class="collapse show" id="all-folder-collapse">
                                                            <div class="card border-0 shadow-none ps-2 mb-0">
                                                                <ul class="list-unstyled mb-0">
                                                                    ...
                                                                    <li>
                                                                        <a href="#" class="text-body d-flex align-items-center open-files" data-id="{{$folder->id}}">
                                                                            <i class="mdi mdi-file font-size-20 text-warning me-2"></i><span class="me-auto">{{ substr(str_replace('_', ' ', $folder->folder_name), 0, 18) }}</span>
                                                                        </a>
                                                                    </li>
                                                                    @endforeach
                                                                </ul>
                                                ...
                                                <!--    <div class="custom-accordion">-->
                                                <!--        <a class="text-body fw-medium py-1 d-flex align-items-center" data-bs-toggle="collapse" href="#all-folder-collapse" role="button" aria-expanded="true" aria-controls="all-folder-collapse">-->
                                                <!--            <i class="mdi mdi-folder font-size-20 text-warning me-2"></i>Other Folders<i class="mdi mdi-chevron-up accor-down-icon ms-auto"></i>-->
                                                <!--        </a>-->
                                                <!--        <div class="collapse show" id="all-folder-collapse">-->
                                                <!--            <div class="card border-0 shadow-none ps-2 mb-0">-->
                                                <!--                <ul class="list-unstyled mb-0">-->
                                                ...
                                                <!--                    <li>-->
                                                <!--                        <a href="#" class="text-body d-flex align-items-center open-subfolders-files" data-id="{{$folder->id}}">-->
                                                <!--                            <i class="mdi mdi-file font-size-20 text-warning me-2"></i><span class="me-auto">{{ substr(str_replace('_', ' ', $folder->sub_folder_name), 0, 18) }}</span>-->
                                                <!--                        </a>-->
                                                <!--                    </li>-->
                                                <!--                    @endforeach-->
                                                <!--                </ul>-->
                                                ...
                                                <div class="collapse show" id="recent-files-collapse">
                                                    <div class="card border-0 shadow-none ps-2 mb-0">
                                                         <ul class="list-unstyled mb-0">
                                                                    ...
                                                                    <span class="me-auto">{{$recent_file->document_name}}</span></a>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    ...
                                                    <p class="text-muted mb-0">{{count($docFile)}} files</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div> <!--end col-->
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    ...
                                                    <p class="text-muted mb-0">{{count($imgFile)}} images</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div> <!--end col-->
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    ...
                                                    <p class="text-muted mb-0">{{count($videoFile)}} videos</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div> <!--end col-->
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    ...
                                                    <p class="text-muted mb-0">{{count($audioFile)}} files</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div> <!--end col-->
                              <h5 class="font-size-16 me-3 mb-0 mt-4">My Folders</h5>
                                    <div class="row mt-4" id="folders-container">
                                        @if($all_department_folders->isNotEmpty())
                                            @foreach($all_department_folders as $department_folder)
                                                    @php
                                                        ...
                                                        <div class="card ">
                                                            <div class="card-body p-3">
                                                                <div class="dropdown float-end">
                                                                  ...
                                                                  <a class="dropdown-item delete-sub-folder" href="#" data-id="{{ $department_folder->id }}" data-folder_id="{{ $department_folder->folder_id }}" data-name="{{ str_replace('_', ' ', $department_folder->sub_folder_name) }}" >Remove</a>
                             ...
                             <h5 class="font-size-16 me-3 mb-0 mt-4">Shared Folders</h5>
                               ...
                               <div class="row mt-4">
                                    @if(count($shared_folders) > 0)
                                        @foreach($shared_folders as $sharedEmployee)
                                              @php
                                            ...
                                            <div class="col-xl-4 col-sm-6 mt-4">
                                                <div class="card">
                                                    <div class="card-body p-3">
                                                        <div class="open-subfolders-files" data-id="{{$sharedEmployee->id}}">
                                                            <div class="d-flex justify-content-between align-items-center">
                                                                <div>
                                                            ...
                                                            <div class="d-flex mt-3">
                                                                <div class="overflow-hidden me-auto">
                                                                    <h5 class="font-size-15 text-truncate mb-1"><a href="javascript: void(0);" class="text-body">{{ substr(str_replace('_', ' ', $sharedEmployee->sub_folder_name), 0, 22) }}</a></h5>
                                                                    <p class="text-muted text-truncate mb-0">{{$countFile}} Files</p>
                                                                </div>
                                                                 <div class="align-self-end ms-2">
                                                                    <p class="text-muted mb-0 font-size-13"><i class="bx mdi mdi-clock-time-five-outline align-middle me-1"></i> {{ $LstFile ? $LstFile->created_at->diffForHumans() : '--' }}</p>
                                                                 </div>
                                                            </div>
                                                        </div>
                                                    </div>
                        ...
                        <div class="d-flex flex-column h-100">
                            <div class="">
                                <div class="text-center">
                                    ...
                                    <p class="text-muted">@if($formattedSize){{$formattedSize}} @else 0KB @endif used</p>
                                </div>
                           ...
                           <div class="mt-4">
    <div class="mt-4">
        @foreach (['Images', 'Videos', 'Audios', 'Documents'] as $type)
            <div class="pb-2 mb-2">
                <a href="javascript:void(0);" class="text-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="overflow-hidden me-auto">
                            <h5 class="font-size-13 text-truncate mb-1">{{ $type }}</h5>
                            <p class="font-size-13 text-muted text-truncate mb-0">
                                @if ($type == 'Images')
                                    {{ count($imgFile) }} Files
                                @elseif ($type == 'Videos')
                                    {{ count($videoFile) }} Files
                                @elseif ($type == 'Audios')
                                    {{ count($audioFile) }} Files
                                @elseif ($type == 'Documents')
                                    {{ count($docFile) }} Files
                                @endif
                            </p>
...
<div class="modal fade" id="add-folder" tabindex="-1" aria-labelledby="paymentModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered ">
        <div class="modal-content ">
            <form action="{{url('Employee/FileManagement/e-store-folder')}}" method="POST">
                @csrf
...
<div class="modal fade" id="edit-folder" tabindex="-1" aria-labelledby="paymentModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form action="{{ url('Employee/FileManagement/e-update-folder') }}" method="POST">
                @csrf
                <div class="modal-header">
                    <h4>Edit Folder</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                ...
                <hr>
                     <div class="modal-body">
                    <label>Folder</label>
                    <select class="form-control" name="subfolder_id">
                        <option value="">Select Folder</option>
                        @foreach($folders as $folder1)
                            <option value="{{ $folder1->id }}">{{ $folder1->folder_name }}</option>
                        @endforeach
                    </select>
                </div>
...
<div class="modal fade" id="share-folder" tabindex="-1" aria-labelledby="paymentModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form action="{{ url('Employee/FileManagement/share-folder') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-header">
                    <h4>Share Folder</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                ...
                <div class="modal-body">
                    <label>Employee</label>
                        <select class="form-control emp_id select2" name="share_employee_id[]" multiple required>
                        @foreach($employees as $emp)
                        <option value="{{$emp->id}}" data-img-src="{{ $emp->profile_img }}">{{$emp->first_name}} {{$emp->last_name}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="modal-footer">
...
<div class="modal fade" id="add-sub-folder" tabindex="-1" aria-labelledby="paymentModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form action="{{ url('Employee/FileManagement/e-store-sub-folder') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <label>Folder</label>
                    <select class="form-control" name="folder_id" required id="file_folder_id">
                        <option value="">Select Folder</option>
                        @foreach($folders as $folder1)
                            <option value="{{ $folder1->id }}">{{ substr(str_replace('_', ' ', $folder1->folder_name), 0, 18) }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="modal-body">
                ...
                <div class="modal-body">
                    ...
                    <select class="form-control" name="sub_folder_id" id="sub_folder_id">
...
<div class="modal fade" id="add-file" tabindex="-1" aria-labelledby="paymentModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form action="{{ url('Employee/FileManagement/e-store-file') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-header">
                    <h4>Create File</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                ...
                <div class="modal-body">
                    ...
                    <select class="form-control" name="folder_id" required id="file_folder_id">
                        ...
                        @foreach($folders as $folder2)
                            <option value="{{ $folder2->id }}">{{ substr(str_replace('_', ' ', $folder2->folder_name), 0, 20) }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <select class="form-control" name="sub_folder_id" id="sub_folder_id">
                        <option value="">Select Sub Folder</option>
                        @foreach($sub_folders as $folders)
                            <option value="{{ $folders->id }}">{{ substr(str_replace('_', ' ', $folders->sub_folder_name), 0, 20) }}</option>
                        @endforeach
                    </select>
                </div>
...
$(document).ready(function() {
    ...
    // Function to handle folder selection change for file creation
    $('#file_folder_id').on('change', function() {
        var folderId = $(this).val();
        var subFolderSelect = $('#sub_folder_id');

        subFolderSelect.empty().append('<option value="">Select Sub Folder</option>');

        if (folderId) {
            $.ajax({
                url: `{{ url('Employee/FileManagement/get-subfolders') }}/${folderId}`,
                type: 'GET',
    ...
    $(document).on('click', '.edit-folder', function(e) {
        ...
        var folderName = $(this).data('name').replace(/_/g, ' ');
        $('#folder_id_edit').val(folderId);
        $('#folder_name_edit').val(folderName);
    });

    // Function to handle click on share folder links
    ...
    // Function to handle click on share sub-folder links
    $(document).on('click', '.share-sub-folders', function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                employeeSelect.select2({
                    dropdownParent: $('#share-sub-folder')
                });
            },
            error: function(xhr) {
                console.error('An error occurred:', xhr.responseText);
    ...
    // Additional functions for file and folder management
    ...
    $(document).on('click', '.delete-folder', function(e) {
        e.preventDefault();
        var folderId = $(this).data('id');
        var url = '/Employee/FileManagement/e-delete-folder/' + folderId;
    ...
    $(document).on('click', '.open-files', function(e) {
        e.preventDefault();
        var folderId = $(this).data('id');
        var url = '/Employee/FileManagement/e-view-folder-files/' + folderId;
    ...
    $(document).on('click', '.open-all-files', function(e) {
        e.preventDefault();
        var url = '/Employee/FileManagement/e-view-all-files';
