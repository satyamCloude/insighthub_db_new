...
@section('title', 'MicrosoftOffice365')
@section('content')
<!-- Content -->
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-3 mb-4"><span class="text-muted fw-light">MicrosoftOffice365 /</span> Add</h4>
                <div class="col-12 mb-4">
                  <div id="wizard-validation" class="bs-stepper mt-2">
                    ...
                    <div class="bs-stepper-content">
                      <form id="wizard-validation-form" method="post" action="{{url('Employee/MicrosoftOffice365/store')}}" enctype="multipart/form-data">
                        @csrf
                        <!-- Account Details -->
