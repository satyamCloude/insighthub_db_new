                ...
                <div class="col-12 mb-4"1>
                  <div id="wizard-validation" class="bs-stepper mt-2">
                    ...
                    <div class="bs-stepper-content">
                      <form id="wizard-validation-form" method="post" action="{{url('Employee/TsPlus/store')}}" enctype="multipart/form-data">
                        @csrf
                        <!-- Account Details -->
                        ...
                        <div id="social-links-validation" class="content">
                          <div class="content-header mb-3">
                            ...
                            <small>Enter Your Computer Details.</small>
                          </div>
                          <div class="row g-3">
                            <div class="col-sm-6">
                              <label class="form-label" for="computer_id">Computer ID</label>
                                <input type="text" class="form-control" name="computer_id" required>
                            </div>
                            <div class="col-12 d-flex justify-content-between">
                              <button  type="button" class="btn btn-label-secondary btn-prev">
                                <i class="ti ti-arrow-left me-sm-1 me-0"></i>
                        ...
                        <div id="license-links-validation" class="content">
                          ...
                          <div class="row g-3">
                             ...
                             <div class="col-sm-6">
                              ...
                              <input type="text"name="no_of_license" class="form-control"/>
                            </div>
                            <div class="col-12 d-flex justify-content-between">
                              <button type="button" class="btn btn-label-secondary btn-prev">
                                <i class="ti ti-arrow-left me-sm-1 me-0"></i>
