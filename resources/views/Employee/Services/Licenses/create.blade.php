                ...
                <div class="col-12 mb-4"1>
                  <div id="wizard-validation" class="bs-stepper mt-2">
                    ...
                    <div class="bs-stepper-content">
                      <form id="wizard-validation-form" method="post" action="{{url('Employee/Licenses/store')}}" enctype="multipart/form-data">
                        @csrf
                        <!-- Account Details -->
                            ...
                            <div class="col-sm-6">
                             ...
                             <div class="col-sm-12">
                              ...
                              <div class="editor-container">
                                    ...
                                    <input type="hidden" name="Licenses_note" class="hidden-field">
                                </div>
                            </div>
