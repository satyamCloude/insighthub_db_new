...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-3 mb-4"><span class="text-muted fw-light">CloudHosting /</span> Add</h4>
                <div class="col-12 mb-4">
                  <div id="wizard-validation" class="bs-stepper mt-2">
                    ...
                    <div class="bs-stepper-content">
                      <form id="wizard-validation-form" method="post" action="{{url('Employee/CloudHosting/store')}}" enctype="multipart/form-data">
                        @csrf
                        <!-- Account Details -->
                          ...
                          <div class="col-sm-6">
                            ...
                            <div class="col-sm-6">
                              ...
                              <select class="form-control" name="firewall_id">
                                    ...
                                    <option value="{{$Firewall->id}}">{{$Firewall->firewall_serial_no}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-sm-6">
                              <label class="form-label" for="dc_login_url">Login URL</label>
                              <input type="text"name="dc_login_url" class="form-control"/>
                            </div>
                            <div class="col-sm-6">
                              <label class="form-label" for="dc_username">User Name</label>
                              <input type="text"name="dc_username" class="form-control"/>
                            </div>
                            <div class="col-sm-6">
                            ...
                            <div class="col-sm-12">
                              ...
                              <div class="editor-container">
                                    ...
                                    <input type="hidden" name="cloudHosting_notes" class="hidden-field">
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="personal-info-validation" class="content">
                          ...
                          <div class="row g-3">
                            ...
                            <div class="col-sm-12">
                              ...
                              <div class="editor-container">
                                    <div class="full-editor geteditor"></div>
                                    <input type="hidden" name="login_notes" class="hidden-field">
                                </div>
                            </div>
