                ...
                <div class="col-12 mb-4"1>
                  <div id="wizard-validation" class="bs-stepper mt-2">
                    ...
                    <div class="bs-stepper-content">
                      <form id="wizard-validation-form" method="post" action="<?php echo e(url('admin/CompanyLogin/update/'.$CompanyLogin->id)); ?>" enctype="multipart/form-data">  
                        <?php echo csrf_field(); ?>
                        <!-- Account Details -->
                          ...
                          <div class="row g-3">
                            <div class="col-sm-6">
                              <label class="form-label" for="company_name">Company Name <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" name="company_name" <?php if($CompanyLogin && $CompanyLogin->company_name): ?> value="<?php echo e($CompanyLogin->company_name); ?>" <?php endif; ?>>
                            </div>
                            <div class="col-sm-6">
                              <label class="form-label" for="portal_login_url">Portal login URL <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" name="portal_login_url" <?php if($CompanyLogin && $CompanyLogin->portal_login_url): ?> value="<?php echo e($CompanyLogin->portal_login_url); ?>" <?php endif; ?>>
                            </div>
                            <div class="col-sm-6">
                              <label class="form-label" for="username">User Name <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" name="username" <?php if($CompanyLogin && $CompanyLogin->username): ?> value="<?php echo e($CompanyLogin->username); ?>" <?php endif; ?>>
                            </div>
                            <div class="col-sm-6">
                              <label class="form-label" for="password">Password <span class="text-danger">*</span></label>
                                <input type="password" class="form-control" name="password" <?php if($CompanyLogin && $CompanyLogin->password2): ?> value="<?php echo e($CompanyLogin->password2); ?>" <?php endif; ?>>
                            </div>                           
                        ...
                        <div id="personal-info-validation" class="content">
                          ...
                          <div class="row g-3">
                            <div class="col-sm-6">
                              ...
                              <input type="text"name="authorised_person_name" <?php if($CompanyLogin && $CompanyLogin->authorised_person_name): ?> value="<?php echo e($CompanyLogin->authorised_person_name); ?>" <?php endif; ?>  class="form-control"/>
                            </div>
                            <div class="col-sm-6">
                              <label class="form-label" for="contact_no">Contact No.</label>
                              <input type="number"name="contact_no" <?php if($CompanyLogin && $CompanyLogin->contact_no): ?> value="<?php echo e($CompanyLogin->contact_no); ?>" <?php endif; ?>  class="form-control"/>
                            </div>
                            <div class="col-sm-6">
                              <label class="form-label" for="email_address">Email Address</label>
                              <input type="email"name="email_address"  <?php if($CompanyLogin && $CompanyLogin->email_address): ?> value="<?php echo e($CompanyLogin->email_address); ?>" <?php endif; ?> class="form-control"/>
                            </div>
                            <div class="col-12 d-flex justify-content-between">
                          ...
                          <div class="row g-3">
                            <div class="col-sm-12">
                              ...
                              <div class="editor-container">
                                <div class="full-editor geteditor"><?php if($CompanyLogin && $CompanyLogin->aditional_informaiton): ?> <?php echo $CompanyLogin->aditional_informaiton; ?> <?php endif; ?></div>
                                <input type="hidden" name="aditional_informaiton" <?php if($CompanyLogin && $CompanyLogin->aditional_informaiton): ?> value="<?php echo e($CompanyLogin->aditional_informaiton); ?>" <?php endif; ?> class="hidden-field">
                              </div>
                            </div>
                            <div class="col-12 d-flex justify-content-between">
                              <button  type="button" class="btn btn-label-secondary btn-prev">
                        ...
                        <div id="license-links-validation" class="content">
                          ...
                          <div class="row g-3">
                              ...
                              <select class="form-control" name="status">
                                    ...
                                    <option <?php if($CompanyLogin && $CompanyLogin->status ==$Status->id): ?> selected <?php endif; ?> value="<?php echo e($Status->id); ?>"><?php echo e($Status->status); ?></option>
                          ...
                          <div class="row g-3">
                            <div class="col-md-12">
                              ...
                              <select class="form-control" name="employee_id">
                                    ...
                                    <option <?php if($CompanyLogin && $CompanyLogin->employee_id ==$Employee->id): ?> selected <?php endif; ?> value="<?php echo e($Employee->id); ?>"><?php echo e($Employee->first_name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                              </select>
                            </div>
                            <div class="col-12 d-flex justify-content-between">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/insighthub/public_html/resources/views/admin/CompanyLogin/edit.blade.php ENDPATH**/ ?>