		...
		<!-- User Sidebar -->
			...
			<!-- User Card -->
					...
					<div class="user-avatar-section">
						<div class="d-flex align-items-center flex-column">
							<img class="img-fluid rounded mb-3 pt-1 mt-4"
								<?php if($user && $user->profile_img): ?> src="<?php echo e($user->profile_img); ?>" <?php else: ?> src="<?php echo e(url('public/images/profile_bZh2.jpg')); ?>" <?php endif; ?>
					...
					<div class="info-container">
						<ul class="list-unstyled">
							<li class="mb-2">
								...
								<span>	<?php if($user && $user->first_name): ?>  <?php echo e($user->first_name); ?> <?php endif; ?></span>
							</li>
							<li class="mb-2 pt-1">
								<span class="fw-medium me-1">Email:</span>
								<span><?php if($user && $user->email): ?>  <?php echo e($user->email); ?> <?php endif; ?></span>
							</li>
							<li class="mb-2 pt-1">
								...
								<?php if($user &&  $user->status == 0): ?>
				                  ...
				                  <?php elseif($user &&  $user->status == 4): ?>
				                  <span class="badge bg-label-danger">Incomplete</span>
				                  <?php elseif($user &&  $user->status == 5): ?>
							...
							<li class="mb-2 pt-1">
								...
								<span>	<?php if($user && $user->phone_number): ?>  <?php echo e($user->phone_number); ?> <?php endif; ?></span>
							</li>
							<li class="mb-2 pt-1">
								<span class="fw-medium me-1">GSTIN:</span>
								<span><?php if($ClientDetail && $ClientDetail->gstin): ?><?php echo e($ClientDetail->gstin); ?><?php endif; ?></span>
							</li>
							<li class="mb-2 pt-1">
								<span class="fw-medium me-1">HSN/SAC:</span>
								<span><?php if($ClientDetail && $ClientDetail->hsn_sac): ?><?php echo e($ClientDetail->hsn_sac); ?><?php endif; ?></span>
							</li>
							<li class="mb-2 pt-1">
								<span class="fw-medium me-1">TDS:</span>
								<span><?php if($ClientDetail && $ClientDetail->tds): ?><?php echo e($ClientDetail->tds); ?><?php endif; ?></span>
							</li>
							<li class="mb-2 pt-1">
								<span class="fw-medium me-1">Country:</span>
								<span><?php if($Country && $Country->name): ?><?php echo e($Country->name); ?><?php endif; ?></span>
							</li>
							<li class="mb-2 pt-1">
								<span class="fw-medium me-1">State:</span>
								<span><?php if($State && $State->name): ?><?php echo e($State->name); ?><?php endif; ?></span>
							</li>
							<li class="mb-2 pt-1">
								<span class="fw-medium me-1">City:</span>
								<span><?php if($City && $City->name): ?><?php echo e($City->name); ?><?php endif; ?></span>
							</li>
							<li class="mb-2 pt-1">
								<span class="fw-medium me-1">Pincode:</span>
								<span><?php if($ClientDetail && $ClientDetail->pincode): ?><?php echo e($ClientDetail->pincode); ?><?php endif; ?></span>
							</li>
							<li class="mb-2 pt-1">
								<span class="fw-medium me-1">Address 1:</span>
								<span><?php if($ClientDetail && $ClientDetail->address_1): ?><?php echo e($ClientDetail->address_1); ?><?php endif; ?></span>
							</li>
							<li class="mb-2 pt-1">
								<span class="fw-medium me-1">Address 2:</span>
								<span><?php if($ClientDetail && $ClientDetail->address_2): ?><?php echo e($user->status); ?><?php endif; ?></span>
							</li>
							<li class="mb-2 pt-1">
								<span class="fw-medium me-1">Verified Document:</span>
								<span><a class="card-link" target="_blank"
									href="<?php if($ClientDetail && $ClientDetail->doc_verify): ?><?php echo e($ClientDetail->doc_verify); ?><?php endif; ?>">Download</a></span>
								</li>
							</ul>
						
							<div class="d-flex justify-content-center">
								<a href="<?php echo e(url('admin/Client/edit/'.$id)); ?>"
    			...
    			<div class=" card col-md-12 mt-4 p-3">
	                ...
	                <p>Name : <?php if($accountManager): ?><?php echo e($accountManager->first_name); ?> <?php echo e($accountManager->last_name); ?><?php endif; ?></p>
	                <p>Contant No. : <?php if($accountManager): ?><?php echo e($accountManager->phone_number); ?><?php endif; ?></p>
	                <p>Role : <?php if($accountRole): ?> <?php echo e($accountRole); ?><?php endif; ?></p>
			...
			<div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
											...
											<div class="d-block text-capitalize">
												...
												<div class="d-flex">
													<p class="mb-0 f-15 font-weight-bold text-blue text-primary d-grid">
														<span id=""><?php echo e($TotalProject); ?></span>
													</p>
												</div>
											</div>
									...
									<div class="col-xl-8 col-lg-6 col-md-6 ">
										<div class="bg-white p-20 rounded b-shadow-4 d-flex justify-content-between align-items-center">
											<div class="d-block text-capitalize">
												...
												<div class="d-flex">
													<p class="mb-0 f-15 font-weight-bold text-blue text-primary d-grid">
														<span id=""><?php if($ClientDetail && $ClientDetail->over_due_invoice): ?><?php echo e($ClientDetail->over_due_invoice); ?> <?php else: ?> 0 <?php endif; ?></span>
													</p>
												</div>
											</div>
										</div>
                ...
                <div class="row mt-4">
                    ...
                    <script>
                        ...
                        var paidInvoicesCount = <?php echo e($paidInvoicesCount); ?>;
                        var unpaidInvoicesCount = <?php echo e($unpaidInvoicesCount); ?>;
                        // Projects Chart
					...
					<!--		<div class="card-body">-->
				 <!--               <form class="formChangePassword2" id="formChangePassword2" method="POST" action="<?php echo e(url('admin/Client/changePassword/'.$id)); ?>">-->
     <!--                               <?php echo csrf_field(); ?>-->
								...
								<table class="table border-top">
									...
									<tbody>
        						        <?php $__currentLoopData = $teamMembers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $team): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        							        <tr >
        							            <td class="text-truncate"><?php echo e($team->id); ?></td>
												<td class="text-truncate"><?php echo e($team->first_name); ?> <?php echo e($team->last_name); ?></td>
												<td class="text-truncate"><?php echo e($team->phone); ?></td>
												<td class="text-truncate"><?php echo e($team->email); ?></td>
												<td class="text-truncate"><?php echo e($team->address_1); ?></td>
												<td class="text-truncate ">
												    <a href="javascript:void(0)" data-id="<?php echo e($team->id); ?>" id="editTeam"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
												    <a href="javascript:void(0)" class="delete_debtcase" url="<?php echo e(url('admin/Client/deleteTeam/'.$team->id)); ?>" ><i class="fa fa-trash"></i></a>
												</td>
											</tr>
        							    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
							        </tbody>
						...
						<div class="card-body">
						    <table class="dt-responsive table dataTable dtr-column" id="DataTables_Table_3" aria-describedby="DataTables_Table_3_info">
                                ...
                                <?php if(count($invoices) > 0): ?>
                                    <?php $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $Inventor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="odd">
                                        <td><?php if($Inventor && $Inventor->created_at): ?> <?php echo e(date('Y-m-d',strtotime($Inventor->created_at))); ?> <?php endif; ?></td>
                                        <td>
                                           Online
                                        </td>
                                        <td>Invoice Payment <?php if($Inventor && $Inventor->invoice_number2): ?> 
                                                (#<?php echo e($Inventor->invoice_number2); ?>)
                                                <?php endif; ?>
                                            <br>
                                            Trans.Id <?php echo e(isset($Inventor) ? $Inventor->razorpay_payment_id : ''); ?>

                                            </td>
                                        <td><?php echo e($Inventor->prefix); ?> <?php echo e(number_format(floatVal($Inventor->final_total_amt ?? 0),2)); ?></td>
                                        <td><?php echo e($Inventor->prefix); ?> 0:00/- </td>
                                        <td><?php echo e($Inventor->prefix); ?> 0:00/- </td>
                                    </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php else: ?>
			...
			<div class="row">
				<div class="col-xl-12 col-lg-12 col-md-12 order-1 order-md-0">
					<div class="card mb-4">
						<div class="card-header d-flex justify-content-between">
						    <h5>Recent Quotes</h5>
						    <a href="<?php echo e(url('admin/Quotes/add')); ?>" class="btn btn-primary">Create Quote</a>
						</div>
							...
							<div class="table-responsive">
								<table class="table border-top">
									...
									<tbody>
										...
										<?php $__currentLoopData = $quotes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<tr class="odd">
											<td class="text-truncate"><?php echo e($key+1); ?> </td>
											<!-- Issue here: Use $user instead of $quotes -->
											<td class="text-truncate"><?php if($user && $user->subject): ?> <?php echo e($user->subject); ?> <?php endif; ?></td>
											<td class="text-truncate"><?php if($user && $user->first_name): ?> <?php echo e($user->first_name); ?> <?php endif; ?></td>
											<td class="text-truncate">
											...
											<td class="text-truncate"><?php if($user && $user->total): ?> <?php echo e($user->total); ?> <?php endif; ?></td>
											<td class="text-truncate"><?php if($user && $user->valid_until): ?> <?php echo e($user->valid_until); ?> <?php endif; ?></td>
											<td class="text-truncate"><?php if($user && $user->updated_at): ?> <?php echo e($user->updated_at->format('Y-m-d')); ?> <?php endif; ?></td>                  
							...
							<div class="table-responsive">
								<table class="table border-top">
									...
									<tbody>
										...
										<?php $client =  \App\Models\User::select('first_name','profile_img','email')->where('id',$Tick->ccid)->first() ?>
										<?php $Department =  \App\Models\Department::where('id',$Tick->department_id)->first() ?>
										<tr>
											<td class="text-truncate"><?php echo e($key+1); ?></td>
											<td class="text-truncate"><?php if($Department && $Department->name): ?><?php echo e($Department->name); ?> <?php else: ?> <?php echo $Tick->department_id; ?> <?php endif; ?></td>
											<td class="text-truncate"><?php echo e($Tick->subject); ?></td>
											<td class="text-truncate">
					...
					<div class="card mb-4">
					    <div class="card-header d-flex justify-content-between">
					        ...
					        <h6>
					            ...
					            Paid : <?php echo e($currency->prefix); ?> <?php echo e(number_format($amounts->total_paid,2)); ?>, 
					            </span>&nbsp;&nbsp;
					            <span class="text-danger">
					            Unpaid : <?php echo e($currency->prefix); ?> <?php echo e(number_format($amounts->total_unpaid,2)); ?>, 
					            </span>&nbsp;&nbsp;
					            <span class="text-warning">
					            Due : <?php echo e($currency->prefix); ?> <?php echo e(number_format($amounts->total_due,2)); ?>

					            </span>
					       </h6>
						    <a class="btn btn-primary" href="<?php echo e(url('admin/Invoices/add')); ?>" class="card-header">Create Invoice</a>
					    </div>
						<div class="card-body">
								...
								<table class="table border-top">
									...
									<tbody>
										<?php if(count($Invoice) > 0): ?>
                                            ...
                                            <tr class="odd">
                                                <td>
                                                    <?php if($Inventor->profile_img): ?>
                                                        <img class="rounded-circle" style="margin-right: 15px;margin-top: 10px;" src="<?php echo e($Inventor->profile_img); ?>" height="30" width="30" alt="User avatar" />
                                                    <?php else: ?>
                                                ...
                                                <td>
                                                    <a href="<?php echo e(url('admin/Invoices/view/'.$Inventor->id)); ?>">
                                                        <?php if($Inventor && $Inventor->invoice_number2): ?> 
                                                            <?php echo e($Inventor->invoice_number2); ?> 
                                                        <?php endif; ?>
                                                    </a>
                                                </td>
                                                <td>
                                                    <?php if($Inventor && $Inventor->issue_date): ?> 
                                                        <?php echo e($Inventor->issue_date); ?> 
                                                    <?php endif; ?>
                                                </td>
                                                <td>
                                                    <?php if($Inventor && $Inventor->due_date): ?> 
                                                        <?php echo e($Inventor->due_date); ?> 
                                                    <?php endif; ?>
                                                </td>
                                                <td>
                                                    <?php
                                                    ...
                                                    ?>
                                                    <?php if($Inventor && $Inventor->is_payment_recieved == 1): ?>
                                                        <?php echo e(isset($Inventor) ? $Inventor->prefix . number_format($final_amt, 2) : ''); ?>
                                                ...
                                                <td>
                                                    ...
                                                    ?>
                                                    <?php if($Inventor && $Inventor->is_payment_recieved == 0): ?>
                                                        <?php echo e(isset($Inventor) ? $Inventor->prefix . number_format($final_amt, 2) : ''); ?>
                                                ...
                                                <td>
                                                    <?php if($Inventor && ($Inventor->is_payment_recieved == 1 || $Inventor->is_payment_recieved == 2)): ?>
                                                        <span class="btn btn-success btn-sm">Paid</span>
                                                    <?php elseif($Inventor && $Inventor->paid_amount > 0 && $Inventor->paid_amount != $Inventor->final_total_amt): ?>
						...
						<div class="card mb-4 mt-4">
							...
							<div class="card-body">
								<table class="dt-route-vehicles table dataTable no-footer dtr-column" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info" style="width: 1214px;">
                                    ...
                                    <tbody>
                                        <?php if($product_data): ?>
                                            <?php $__currentLoopData = $product_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($service): ?>
                                                    <?php
                                                    ...
                                                    <tr>
                                                        <td></td>
                                                        <td><?php echo e($service->product_name); ?></td>
                                                        <td><?php echo e($Invoice->final_total_amt); ?></td>
                                                        <td><?php echo e($service->next_due_date); ?></td>
                                                        <td><span class="badge rounded <?php echo e($class); ?>"><?php echo e($status); ?></span></td>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="progress w-100" style="height: 8px;">
                                                                    <div class="progress-bar" role="progressbar" style="width: <?php echo e($totalDays); ?>%;" aria-valuenow="<?php echo e($totalDays); ?>" aria-valuemin="0" aria-valuemax="100"></div>
                                                                </div>
                                                                <div class="text-body ms-3"><?php echo e($totalDays); ?></div>
                                                            </div>
                                                        </td>
										...
										<tbody>
											<tr>
												<td class="text-truncate">
													...
													<span class="fw-medium"><?php if($LastloginLogActivity): ?> <?php echo e($LastloginLogActivity->browser); ?> <?php endif; ?></span>
												</td>																    
												<td class="text-truncate"><?php if($LastloginLogActivity): ?> <?php echo e($LastloginLogActivity->ip); ?> <?php endif; ?></td>
												<td class="text-truncate"><?php if($LastloginLogActivity): ?> <?php echo e($LastloginLogActivity->created_at->format('d, F Y H:i')); ?> <?php endif; ?></td>
											</tr>
				...
				<div class="col-xl-12 col-lg-12 col-md-12 order-1 order-md-0">
					<div class="card mb-4">
						<div class="card-header d-flex justify-content-between">
						    ...
						    <h5>Balance : <span class="text-success"><?php echo e($currency->prefix); ?> <?php echo e(number_format($credits->sum('amount'), 2)); ?></span></h5>
								...
								<table class="table border-top">
									...
									<tbody>
										...
										<tr>
											...
											<td class="text-truncate"><?php echo e($credit->id); ?></td>																    
											<td class="text-truncate <?php if($credit->amount > 0): ?> text-success <?php else: ?> text-danger <?php endif; ?>" ><?php echo e(number_format($credit->amount,2)); ?></td>
											<td class="text-truncate"><?php echo e($credit->created_at->format('Y-m-d H:i:s')); ?></td>
										</tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									</tbody>
								</table>
			...
			<div class="row">
				<div class="col-xl-6 col-lg-6 col-md-6 1 ">
					<div class="card mb-4">
						...
						<div class="card-body">
							    <h6><?php if($user && $user->google2fa_enabled): ?><?php echo e($user->google2fa_enabled ? $user->first_name.' has enabled' : $user->first_name.' has not enabled'); ?> <?php endif; ?> two-factor authentication.</h6>
                               ...
                               <?php if($user && $user->google2fa_enabled): ?>
                                    <a href="<?php echo e(url('admin/Client/2fa/disable?id='.$user->id)); ?>" >
                                        <button class="btn btn-danger">Disable</button>
                                    </a>
                                    <?php else: ?>
                                     <a href="<?php echo e(url('admin/Client/2fa/enable?id='.$user->id)); ?>" >
...
<div class="modal fade" id="add-member" tabindex="-1" aria-labelledby="paymentModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content ">
            <form action="<?php echo e(url('admin/Client/storeTeam')); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="modal-body" id="editForm">
                    <div class="row">
                        <div class="col-6">
                            ...
                            <input type="hidden" name="team_id" value="<?php echo e($id); ?>" class="form-control" required />
                        </div>
                        <div class="col-6">
...
<div class="modal fade" id="add-credits" tabindex="-1" aria-labelledby="paymentModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content ">
            <form action="<?php echo e(url('admin/Client/Credits/store')); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="modal-header">
                ...
                <div class="modal-body" id="editForm">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <input type="hidden" name="client_id" value="<?php echo e($id); ?>" class="form-control" />
                        </div>
                    </div>
                </div>
                <div class="modal-footer mt-4">
...
<div class="modal fade" id="edit-member" tabindex="-1" aria-labelledby="paymentModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content ">
            <form action="<?php echo e(url('admin/Client/updateTeam')); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="modal-header">
...
<script>
    ...
    $('#editTeam').click(function(){
        ...
        $.ajax({
            url: "<?php echo e(url('admin/Client/editTeam')); ?>/"+id,
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/insighthub/public_html/resources/views/admin/user/client/view.blade.php ENDPATH**/ ?>