      ...
      <div class="card-datatable table-responsive">
        <div id="DataTables_Table_3_wrapper" class="dataTables_wrapper dt-bootstrap5">
          ...
          <table class="dt-responsive table dataTable dtr-column" id="DataTables_Table_3" aria-describedby="DataTables_Table_3_info">
           ...
           <tbody id="result">
    <?php if(count($OS) > 0): ?>
        <?php $__currentLoopData = $OS; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $Cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr class="bg-secondary5">
                <td><?php echo e($key+1); ?></td>
                <td><?php if($Cat && $Cat->category_name): ?> <?php echo e($Cat->category_name); ?> <?php else: ?> N/A <?php endif; ?></td>
                <td><?php if($Cat && $Cat->os_name): ?> <?php echo e($Cat->os_name); ?> <?php else: ?> N/A <?php endif; ?></td>
                    <td><img src="<?php if($Cat && $Cat->image): ?> <?php echo e($Cat->image); ?> <?php endif; ?>" height="38"></td>
                <td>
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" style="">
                            ...
                            <li><button class="dropdown-item delete_debtcase1" data-url="<?php echo e(url('admin/os_category/delete/'.$Cat->id)); ?>" id="<?php echo e($Cat->id); ?>">Delete</button></li>
                        </ul>
                    </div>
                </td>
            </tr>
...
<div class="modal fade" id="backDropModal" data-bs-backdrop="static" tabindex="-1" style="display: none;" aria-modal="true" role="dialog">
    <div class="modal-dialog">
      <form class="modal-content" action="<?php echo e(url('admin/os_category/store')); ?>" method="post">
        <?php echo csrf_field(); ?>
          ...
          <div class="row g-2">
            <div class="col mb-3">
              ...
              <select id="category_id" class="form-control" name="os_id" required>
                  ...
                  <?php $__currentLoopData = $OperatingSystem; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Categorys): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <option value="<?php echo e($Categorys->id); ?>"><?php echo e($Categorys->ostype); ?></option>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
            </div>
          </div>
          ...
          <div class="row g-2">
            <div class="col mb-3">
              ...
              <select id="currency_id" class="form-control" name="currency_id" required>
                  ...
                  <?php $__currentLoopData = $Currency; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Categorys): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
function editCategory(element) {
    ...
    $.ajax({
        url: "<?php echo e(url('admin/os_category/edits')); ?>/"+cate_id,
        method: 'GET',
        data: { id: cate_id },
...
</script><?php /**PATH /home/insighthub/public_html/resources/views/admin/settings/Product/operatingsystem.blade.php ENDPATH**/ ?>