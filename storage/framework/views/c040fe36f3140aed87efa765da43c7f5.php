<?php $AppSetting =  \App\Models\AppSetting::select('CompanyLogo','welcometextClient','CompanyBannerClient')->where('id','1')->first() ?>
<!DOCTYPE html>
    ...
    $(document).ready(function(){
        ...
        $('#welcometext').on('selectstart', function(e) {
            e.preventDefault();
              ...
              <?php endif; ?>
              <form id="formAuthentication" class="mb-3 my-3" action="<?php echo e(url('user-forgot-password-mail-send')); ?>" method="POST">
              <?php echo csrf_field(); ?>
              <div class="mb-3">
...
<?php /**PATH /home/insighthub/public_html/resources/views/auth/userforgot.blade.php ENDPATH**/ ?>