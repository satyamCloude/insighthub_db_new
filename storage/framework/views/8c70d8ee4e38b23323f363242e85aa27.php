  ...
  <div class="card">
    <div class="row">
      ...
      <div class="col-md-6 text-end">
         <a href="<?php echo e(url('Employee/TimeSheet/home')); ?>" class="btn btn-warning mt-3 m-3"><i class="fas fa-sync-alt"></i></a>
           <?php if($RoleAccess[array_search('TimeSheet', array_column($RoleAccess, 'per_name'))]['add'] == 1): ?>
          <a href="<?php echo e(url('Employee/TimeSheet/add')); ?>" class="btn btn-primary mt-3 m-3">Add</a>
          <?php endif; ?>
      </div>
    </div>
                     ...
                     <?php if(in_array('TimeSheet', array_column($RoleAccess, 'per_name'))): ?>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" style="">
                                ...
                                <?php if($RoleAccess[array_search('TimeSheet', array_column($RoleAccess, 'per_name'))]['update'] == 1): ?>
                                    <li><a class="dropdown-item" href="<?php echo e(url('Employee/TimeSheet/edit/'.$user->id)); ?>">Edit</a></li>
                                <?php endif; ?>
                                <?php if($RoleAccess[array_search('TimeSheet', array_column($RoleAccess, 'per_name'))]['delete'] == 1): ?>
                                    <li><button class="dropdown-item delete_debtcase" url="<?php echo e(url('Employee/TimeSheet/delete/'.$user->id)); ?>" id="<?php echo e($user->id); ?>">Delete</button></li>
                                <?php endif; ?>
                            </ul>
                        </div>
                    <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/insighthub/public_html/resources/views/Employee/Humanesources/TimeSheet/home.blade.php ENDPATH**/ ?>