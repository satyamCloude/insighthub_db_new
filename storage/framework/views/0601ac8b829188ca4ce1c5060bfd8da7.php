  ...
  <div class="row">
      ...
      <div class="card">
        <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row">
          ...
          <div class="action-btns">
            <a href="<?php echo e(url('admin/Invoices/home')); ?>" class="btn btn-label-primary me-3">
              <span class="align-middle"> Back</span>
            </a>
          </div>
        </div>
          <form action="<?php echo e(url('admin/Invoices/update/'.$id)); ?>" method="post" enctype="multipart/form-data"> 
          <?php echo csrf_field(); ?>
           <?php echo csrf_field(); ?>
          <div class="card-body">
            ...
            <div class="row mb-4">
              <div class="col-md-3">
                ...
                <div class="input-group">
                  <div class="input-group-prepend">
                    ...
                    <input type="hidden" name="selectedOrderID" id="selectedOrderID" value="<?php if($selected_order_id): ?> <?php echo e($selected_order_id); ?> <?php else: ?> 0 <?php endif; ?>" class="form-control height-35 f-15" readonly>
                  </div>
                  <input type="number" name="invoice_number2" id="invoice_number2" class="form-control height-35 f-15" required autocomplete="off" value="<?php echo e($Inventory->invoice_number2); ?>" readonly>
                </div>
              ...
              <div class="col-md-2">
                ...
                <input type="date" class="form-control startDate height-35 f-15" name="issue_date"  value="<?php echo e($Inventory->issue_date); ?>"  required />
              </div>

              <div class="col-md-2">
                <label for="product_code" class="form-label">Due Date<span class="text-danger">*</span></label>
                <input type="date" class="form-control endDate height-35 f-15" name="due_date"  value="<?php echo e($Inventory->due_date); ?>" required />
              </div>
              <div class="col-md-4" style="margin-top: 9px; width: 432.014px;">
                  ...
                  <select class="form-control select2 height-35 f-15" name="currency" id="currencies">
                      ...
                      <option value="<?php echo e($currency->id); ?>" <?php if($Inventory->currency == $currency->id): ?> selected <?php endif; ?>>
                          <?php echo e($currency->code); ?> (<?php echo e($currency->prefix); ?>)
                      </option>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </select>
              </div>
            ...
            <div class="row mb-4">
                       ...
                       <div class="col-md-4 customer_name">
                        ...
                        <div class="dropdown">
                            ...
                            <button class="dropbtn" style="justify-content:space-between;margin-right:3%" type="button">
                                <div>
                                    <img src="<?php echo e($profile_img ? $profile_img : url('/') . '/public/images/profile_Ri1o.jpeg'); ?>" alt="" id="selected_client_img" class="rounded-circle avatar-xs" style="display:<?php echo e($profile_img ? 'inline' : 'none'); ?>;">
                                    <span id="selected_client_btn"><?php echo e($first_name); ?> <?php echo e($last_name); ?> (<?php echo e($id); ?>)</span>
                                </div>
                                <div>
                            ...
                            <div class="dropdown-content" style="max-height: 45vh; overflow: auto;">
                                ...
                                <div class="outer" id="client_<?php echo e($client->id); ?>" style="display:flex;margin:6px;padding:4px;color:black;" onclick="selectClient('<?php echo e($client->id); ?>', '<?php echo e($client->profile_img); ?>', '<?php echo e($client->first_name); ?> <?php echo e($client->last_name); ?> (#<?php echo e($client->id); ?>)')">
                                    <div style="border-radius:50%;">
                                        <?php if($client->profile_img): ?>
                                        <img src="<?php echo e($client->profile_img); ?>" style="width:45px; border-radius:50%; height:auto;">
                                        <?php else: ?>
                                        <img src="<?php echo e(url('/')); ?>/public/images/profile_Ri1o.jpeg" style="width:45px; border-radius:50%; height:auto;">
                                        <?php endif; ?>
                                    </div>
                        ...
                        <input type="hidden" name="client_id" id="set_client_id" value="<?php echo e($id); ?>">
                    </div>
                ...
                <select class="form-control select2" name="project_id" onchange="getProjectDetails(this.value)" required>
                    ...
                    <?php $__currentLoopData = $Project; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($project->id); ?>"  <?php if($Inventory->project_id == $project->id): ?> selected <?php endif; ?>>
            ...
            <select class="form-control select2" name="calc_tax" id="when_calc_tax" required onchange="CalculateTax()">
                <option value="0" <?php if($Inventory->calc_tax == 0): ?> selected <?php endif; ?>>Before Discount</option>
                <option value="1"<?php if($Inventory->calc_tax == 1): ?> selected <?php endif; ?>>After Discount</option>
            </select>
        </div>
    ...
    <div class="col-md-3">
        ...
        <select class="form-control select2" name="bank_account" required>
            <option value="1"  <?php if($Inventory->bank_account == 1): ?> selected <?php endif; ?>>Paypal Basics</option>
            <option value="2"  <?php if($Inventory->bank_account == 2): ?> selected <?php endif; ?>>Bank Transfer</option>
            <option value="3"  <?php if($Inventory->bank_account == 3): ?> selected <?php endif; ?>>Debit/Credit Card</option>
        </select>
    </div>
</div>
        ...
        <div class="row mb-4">
            <div class="col-md-4">
                ...
                <textarea class="form-control m-0" name="billing_address" readonly style="resize:none"><?php echo e($billing_address->address_1); ?></textarea>
            </div>
              ...
              <div class="col-md-4">
                ...
                <textarea class="form-control m-0" name="generated_by" id="generated_by" value="1"  style="resize:none" readonly><?php echo e($billing_address->company_name); ?></textarea>
              ...
              <div class="col-md-4">
                ...
                <div class="dropdown">
                  ...
                  <div class="dropdown-content">
                    ...
                    <div class="outer" id="service_<?php echo e($category->id); ?>" style="display:flex;margin:6px;padding:4px;color:black;" 
                    onclick="getProduct1('<?php echo e($category->id); ?>','<?php echo e($category->faIcon); ?>')">
                         <span class="mt-2" ><?php echo $category->faIcon; ?></span>
                      <div class="sie_cont" style="display:flex;flex-direction:column;margin:5px;">
            ...
            <div class="content-wrapper">
              <div class="c-inv-desc-table item-row mt-4 w-100 d-lg-flex d-md-flex d-block">
                  <table width="100%">
                    <tbody>
                      ...
                      <tr>
                        <td class="border-bottom-0 btrr-mbl btlr">
                          <input type="text" class="form-control f-14 border-0 w-100 item_name" id="item_name" name="item_name[]" placeholder="Item Name" autocomplete="off" value="<?php echo e(isset($productDetails) ? $productDetails->product_name : ''); ?>">
                
                          <input type="hidden" name="product_id[]" value="<?php echo e($productDetails->proId); ?>" autocomplete="off">
                        </td>
                        <td class="border-bottom-0 d-block d-lg-none d-md-none">
                          <textarea class="form-control f-14 border-0 w-100 mobile-description form-control item_summary" id="item_summary" name="item_summary" placeholder="Enter Description (optional)"><?php echo e(isset($productDetails) ? $productDetails->description : ''); ?></textarea>
                        </td>
                       <td class="border-bottom-0">
                        <input type="number" min="1" class="form-control f-14 border-0 w-100 text-right qty quantity mt-3" value="<?php if($Inventory && $Inventory->quantity): ?><?php echo e($Inventory->quantity); ?><?php else: ?> 1 <?php endif; ?>" name="quantity[]" autocomplete="off" id="qty<?php echo e($numberCount); ?>" sectionCount="<?php echo e($numberCount); ?>">
                    ...
                    <td class="border-bottom-0">
                        <input type="number" min="1" class="f-14 border-0 w-100 text-right cost_per_item form-control" value="<?php echo e($productDetails ? $productDetails->price : '0.00'); ?>" name="cost_per_items[]" autocomplete="off" id="cost_per_item<?php echo e($numberCount); ?>" sectionCount="<?php echo e($numberCount); ?>" readonly required>
                    </td>
                    
                    <td class="border-bottom-0">
                        <div class="select-others height-35 rounded border-0">
                            <div class="dropdown bootstrap-select show-tick select-picker type customSequence border-0">
                                <select id="multiselect1" name="taxes<?php echo e($numberCount); ?>[]" multiple="multiple" onchange="CalculateTax()" class="select-picker type customSequence border-0 multiselect" data-size="3">
                                    <?php $__currentLoopData = $Tax; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Taxs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option data-rate="<?php echo e($Taxs->tax_name); ?>" data-product-id<?php echo e($numberCount); ?>="<?php echo e($numberCount); ?>" data-tax-value="<?php echo e($Taxs->rate); ?>" data-tax<?php echo e($numberCount); ?>="<?php echo e($Taxs->tax_name . ':' . $Taxs->rate); ?>" value="<?php echo e($Taxs->id); ?>" <?php if($Taxs->id == $productDetails->taxId): ?> selected <?php endif; ?>><?php echo e($Taxs->tax_name . ':' . $Taxs->rate); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                                <input type="hidden" name="applied_tax[]" id="applied_tax<?php echo e($numberCount); ?>">
                      ...
                      <td rowspan="2" align="right" valign="top" class="bg-amt-grey btrr-bbrr">
                            ...
                            ?>
                            <span class="amount-html" id="total-amt<?php echo e($numberCount); ?>"><?php echo e(str_replace(',','',number_format($totalPrice, 2))); ?></span>
                            <input type="hidden" id="total_tax<?php echo e($numberCount); ?>">
                        </td>
                        
                      </tr>
                      <tr class="d-none d-md-table-row d-lg-table-row">
                        <td colspan="3" class="dash-border-top bblr border-right-0">
                          <textarea class="f-14 border p-3 px-1 rounded w-100 desktop-description form-control item_summary" id="item_summary" name="item_summary" placeholder="Enter Description (optional)" style="margin:unset; border: unset!important;box-shadow: unset !important;height: 120px;"><?php echo e(isset($productDetails) ? strip_tags($productDetails->description) : ''); ?></textarea>
                        </td>
                        <td class="border-left-0">
                          <div class="dropify-wrapper" style="height: 81.6px;" id="show_img1">
                            <div class="dropify-message"><span class=""><img id="show_imgs1" src="<?php echo e(url('public/images/cloud.png')); ?>" style="width: 54px;
                              margin-top: 25px;
                              "></span>
                              <p>Choose a file</p>
              ...
              <?php if($addonOrders): ?>
                <?php $__currentLoopData = $addonOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $addons): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="c-inv-desc-table item-row mt-4 w-100 d-lg-flex d-md-flex d-block">
                              <table width="100%">
                                <tbody>
                                  <tr class="text-dark-grey font-weight-bold f-14">
                                  ...
                                  <tr>
                                    <td class="border-bottom-0 btrr-mbl btlr">
                                      <input type="text" class="form-control f-14 border-0 w-100 item_name" id="item_name" name="item_name[]" placeholder="Item Name" autocomplete="off" value="<?php echo e(isset($addons) ? $addons->product_name : ''); ?>">
                            
                                      <input type="hidden" name="product_id[]" value="<?php echo e($addons->product_id); ?>" autocomplete="off">
                                    </td>
                                    <td class="border-bottom-0 d-block d-lg-none d-md-none">
                                      <textarea class="form-control f-14 border-0 w-100 mobile-description form-control item_summary" id="item_summary" name="item_summary" placeholder="Enter Description (optional)"><?php echo e(isset($addons) ? $addons->description : ''); ?></textarea>
                                    </td>
                                    <td class="border-bottom-0">
                                      <input type="number" min="1" class="form-control f-14 border-0 w-100 text-right qty quantity mt-3" value="<?php if($addons && $addons->quantity): ?><?php echo e($addons->quantity); ?><?php else: ?> 1 <?php endif; ?>" name="quantity[]" autocomplete="off" id="qty<?php echo e($numberCount); ?>" sectionCount="<?php echo e($numberCount); ?>">
                                      <select class="text-dark-grey float-right border-0 f-12" name="unit_id">
                                        <option selected="" value="1">Pcs</option>
                                      </select>
                                    ...
                                    <td class="border-bottom-0">
                                      <input type="number" min="1" class="f-14 border-0 w-100 text-right cost_per_item form-control" value="<?php echo e($addons ? $addons->price : '0.00'); ?>" name="cost_per_items[]" autocomplete="off" id="cost_per_item<?php echo e($numberCount); ?>" sectionCount="<?php echo e($numberCount); ?>" readonly required>
                                    </td>
                                    <script>
                                      $(document).ready(function() {
                                   
                                    $("#multiselect<?php echo e($key+2); ?>").selectpicker();
                                      });
                                    </script>
                                    ...
                                    <div class="select-others height-35 rounded border-0">
                                        <div class="dropdown bootstrap-select show-tick select-picker type customSequence border-0">
                                            <select id="multiselect<?php echo e($key+2); ?>" name="taxes<?php echo e($numberCount); ?>[]" multiple="multiple" onchange="CalculateTax()" class="select-picker type customSequence border-0 multiselect" data-size="3">
                                                <?php $__currentLoopData = $Tax; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Taxs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option data-rate="<?php echo e($Taxs->tax_name); ?>" data-product-id<?php echo e($numberCount); ?>="<?php echo e($numberCount); ?>" data-tax-value="<?php echo e($Taxs->rate); ?>" data-tax<?php echo e($numberCount); ?>="<?php echo e($Taxs->tax_name . ':' . $Taxs->rate); ?>" value="<?php echo e($Taxs->id); ?>" 
                                                  <?php if($addons->tax == $Taxs->id): ?> selected <?php endif; ?>><?php echo e($Taxs->tax_name . ':' . $Taxs->rate); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                            <input type="hidden" name="applied_tax[]" id="applied_tax<?php echo e($numberCount); ?>">
                                            <div class="dropdown-menu">
                                  ...
                                  <tr class="d-none d-md-table-row d-lg-table-row">
                                    <td colspan="3" class="dash-border-top bblr border-right-0">
                                      <textarea class="f-14 border p-3 px-1 rounded w-100 desktop-description form-control item_summary" id="item_summary" name="item_summary" placeholder="Enter Description (optional)" style="margin:unset; border: unset!important;box-shadow: unset !important;height: 120px;"><?php echo e(isset($addons) ? strip_tags($addons->description) : ''); ?></textarea>
                                    </td>
                                    <td class="border-left-0">
                                      <div class="dropify-wrapper" style="height: 81.6px;" id="show_img1">
                                        <div class="dropify-message"><span class=""><img id="show_imgs1" src="<?php echo e(url('public/images/cloud.png')); ?>" style="width: 54px;
                        ...
                        <table width="100%">
                          <tbody>
                            ...
                            <tr>
                                  ...
                                  <tbody>
                                    <tr>
                                      <td width="70%" class="c-inv-sub-padding">
                                        <input type="number" min="0" name="discount_value" class="form-control f-14 border-0 w-100 text-right discount_value" placeholder="0" autocomplete="off" <?php if($Inventory && $Inventory->discount_value): ?> value="<?php echo e($Inventory->discount_value); ?>" <?php else: ?> value="0" <?php endif; ?>>
                                      </td>
                                      <td width="30%" align="left" class="c-inv-sub-padding">
                                        <select class="form-control" id="discount_type" name="discount_type">
                                          <option  <?php if($Inventory && $Inventory->discount_value == 'percent'): ?> selected <?php endif; ?> value="percent">%
                                          </option>
                                          <option <?php if($Inventory && $Inventory->discount_value == 'fixed'): ?> selected <?php endif; ?> value="fixed">
                                            Amount</option>
                                        </select>
                                      </td>
                                    </tr>
                              ...
                              <td><span class="discount_amount">  <?php if($Inventory && $Inventory->discount_amount): ?> <?php echo e(str_replace(',','',number_format($Inventory->discount_amount, 2))); ?>  <?php else: ?> 0.00 <?php endif; ?></span>
                                  <input type="hidden" name="discount_amount" class="discount_amount1"  <?php if($Inventory && $Inventory->discount_amount): ?> value="<?php echo e($Inventory->discount_amount); ?>" <?php endif; ?>>
                              </td>
                            </tr>
                            <tr>
                              <td>Tax</td>
          ...
          <div class="card-footer">
            <div class="row mb-4">
              <div class="col-md-6 text-end">
                <a href="<?php echo e(url('admin/Invoices/home')); ?>" type="button" class="btn btn-outline-danger">Discard</a>
              </div>
              <div class="col-md-6">
...
<script>
 ...
 $("#multiselect1").selectpicker();
    ...
    $('#services').change(function() {
      ...
      if (selectedServiceId && selectedClientId) {
        ...
        $.ajax({
          type: 'GET',
          url: "<?php echo e(url('admin/Invoices/get_selected_product_plan')); ?>",
          data: {
    ...
    $('#currencies').change(function() {
      ...
      $.ajax({
        type: 'POST',
        url: "<?php echo e(url('admin/Invoices/selectedCurrencyData')); ?>",
        data: {
    ...
    $('#invoice_number2').keyup(function() {
      ...
      $.ajax({
        type: 'GET',
        url: "<?php echo e(url('admin/Invoices/check_invoice_number')); ?>",
        data: {
    ...
    $(document).on('change', 'input[name^="invoice_item_image["]', function() {
      ...
      if (file) {
        ...
        $('#show_img' + sectionCount + ' span img').attr('src', "<?php echo e(url('public/images/cloud.png')); ?>");
 ...
 function calcDiscount() {
  ...
  function getProductDetailWithFullData(product_id) {
    ...
    $.ajax({
      type: 'POST',
      url: "<?php echo e(url('admin/Invoices/get_product_price')); ?>",
      data: {
  ...
  function getProjectDetails(project_id) {
    ...
    $.ajax({
      type: 'POST',
      url: "<?php echo e(url('admin/Invoices/get_project_details')); ?>",
      data: {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/insighthub/public_html/resources/views/admin/Invoices/edit.blade.php ENDPATH**/ ?>