  ...
  $.ajax({
    ...
    success: function(response) {
      if (response.status == 400) {
        ...
        var url = "<?php echo e(url('/google/resend_varification_email/')); ?>/" + email + "/" + id;
...
</html><?php /**PATH /home/insighthub/public_html/resources/views/auth/user_register.blade.php ENDPATH**/ ?>