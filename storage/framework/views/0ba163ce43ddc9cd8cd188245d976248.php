...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="row mt-4 m-4">
        ...
        <div class="col-md-8 text-end ">
           ...
           <a href="<?php echo e(url('admin/LogActivity/ticket')); ?>"class="btn btn-primary">Ticket</a>
        ...
        <div id="DataTables_Table_3_wrapper" class="dataTables_wrapper dt-bootstrap5">
          <div class="row bg-label-dark text-dark">
            <div class="col-sm-12 col-md-6 d-flex justify-content-center justify-content-md-start">
              <h5 class="card-header">Ticket Mail Log</h5>
            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/insighthub/public_html/resources/views/admin/settings/LogActivity/ticket.blade.php ENDPATH**/ ?>