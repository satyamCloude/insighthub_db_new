      ...
      <div class="card">
         <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row" style="background:linear-gradient(72.47deg, #7367f0 22.16%, rgba(115, 103, 240, 0.7) 76.47%);">
            ...
            <div class="action-btns">
               <a href="<?php echo e(url('admin/Quotes/home')); ?>" class="btn btn-label-primary me-3" style="background-color:white;">
               <span class="align-middle"> Back</span>
               </a>
            </div>
         </div>
         <form action="<?php echo e(url('admin/Quotes/store')); ?>" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="card-body">
               <div class="row mb-4">
                  <div class="col-md-2">
               ...
               <div class="row mb-4">
                  ...
                  <div class="col-md-6 customer_name">
                     ...
                     <input type="hidden" name="customer_name" id="customer_name" class="form-control">
                  </div>
               </div>
               <?php endif; ?>
               <div class="row mb-4">
            ...
            <div class="row mb-4">
               ...
               <div class="col mb-3">
                  ...
                  <select  name="taxes[]" id="mod_tax" multiple class="form-control select2">
                     ...
                     <option value="">Select Taxs</option>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/insighthub/public_html/resources/views/admin/sales/Quotes/create.blade.php ENDPATH**/ ?>