<div class="card-header sticky-element bg-label-secondary mb-4 p-2">
    <div class="row">
        <div class="col-md-12 d-flex justify-content-center align-self-baseline">
            <!-- <input type="radio" name="leadsetting" id="radio1" checked value="category">&nbsp;&nbsp; -->
            <label for="radio1"><h4>Service Automation</h4></label>
        </div>
...
</script><?php /**PATH /home/insighthub/public_html/resources/views/admin/settings/Product/home.blade.php ENDPATH**/ ?>