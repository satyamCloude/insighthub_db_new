            ...
            <tbody id="result">
              ...
              <?php if(count($PayRoll) > 0): ?>
                ...
                <tr class="odd">
                    ...
                    <td><?php if($user && $user->tds): ?> <?php echo e($user->tds); ?> <?php endif; ?></td>
                </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              <!-- <tr style="background: aliceblue;">
                  <td></td>
                  <td><strong>Total</strong></td>
                  <td><strong><?php echo e($totaltds); ?></strong></td>
              </tr> -->
              <?php else: ?>
              <tr>
...
<script>
    $(document).ready(function () {
        ...
        function fetchData() {
            ...
            $.ajax({
                url: "<?php echo e(url('admin/PayRoll/get_TdsData')); ?>",
                method: 'GET',
...
</script><?php /**PATH /home/insighthub/public_html/resources/views/admin/Humanesources/PayRoll/TDS.blade.php ENDPATH**/ ?>