  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row">
            ...
            <div class="action-btns">
              <a href="<?php echo e(url('admin/Employee/home')); ?>" class="btn btn-label-primary me-3">
        ...
        <form action="<?php echo e(url('admin/Employee/update/'.$Employee->id)); ?>" method="post" enctype="multipart/form-data"> 
    <?php echo csrf_field(); ?>
    <div class="card-body">
        ...
        <div class="row mb-4"> 
            <div class="col-md-4">
                ...
                <select name="gender" class="form-control select2" required>
                    <option <?php if($Employee && $Employee->gender == '1'): ?> selected <?php endif; ?> value="1">Male</option>
                    <option <?php if($Employee && $Employee->gender == '2'): ?> selected <?php endif; ?> value="2">Female</option>
                </select>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control" name="first_name" placeholder="Enter First Name" value="<?php echo e(old('first_name', $Employee->first_name ?? '')); ?>" required />
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control" name="last_name" placeholder="Enter Last Name" value="<?php echo e(old('last_name', $Employee->last_name ?? '')); ?>" required />
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="row mb-4"> 
            <div class="col-md-6">
                ...
                <input type="email" class="form-control" name="email" placeholder="abc@gmail.com" id="personal_email" value="<?php echo e(old('email', $Employee->email ?? '')); ?>" required />
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-6">
                ...
                <input type="number" class="form-control" name="phone_number" placeholder="+1234156789" maxlength="12" value="<?php echo e(old('phone_number', $Employee->phone_number ?? '')); ?>" required oninput="if(this.value.length > 12) this.value = this.value.slice(0, 12);" />
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="row mb-4"> 
            <div class="col-md-6">
                ...
                <input type="date" class="form-control" name="dob" value="<?php echo e(old('dob', $EmployeeDetail->dob ?? '')); ?>" required />
                <?php $__errorArgs = ['dob'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-6">
                ...
                <input type="date" class="form-control" name="marriage_anniversary" value="<?php echo e(old('marriage_anniversary', $EmployeeDetail->marriage_anniversary ?? '')); ?>" />
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="row mb-4"> 
            <div class="col-md-6">
                ...
                <input type="date" class="form-control" name="date_of_joining" value="<?php echo e(old('date_of_joining', $EmployeeDetail->date_of_joining ?? '')); ?>" required />
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-6">
                ...
                <input type="number" class="form-control" name="net_salary" placeholder="00000" value="<?php echo e(old('net_salary', $EmployeeDetail->net_salary ?? '')); ?>" required min="1000" />
        ...
        <div class="row mb-4"> 
                  <div class="col-md-6">
                        <div class="avatar-preview">
                           <img id="uploadedProfile" width="100" height="100"   <?php if($Employee && $Employee->profile_img): ?> src="<?php echo e($Employee->profile_img); ?>" <?php else: ?> src="<?php echo e(url('public/images/21104.png')); ?>"  <?php endif; ?> alt="Preview" />
                        </div>
                  </div>
                  <div class="col-md-6">
        ...
        <hr>
              ...
              <div class="row mb-4"> 
                <div class="col-md-6">
                  <label for="company_id" class="form-label">Company Name <span class="text-danger">*</span></label>
                   ...
                   <input type="hidden" class="company_id" value="<?php echo e($Company->id); ?>" placeholder="Company Name" disabled>
                </div>
                <div class="col-md-6 ">
                  <label for="department_id" class="form-label">Department <span class="text-danger">*</span></label>
                    <select name="department_id" class="form-control select2" required>
                            ...
                            <option <?php if($EmployeeDetail && $EmployeeDetail->department_id == $Depart->id): ?> selected <?php endif; ?> value="<?php echo e($Depart->id); ?>"><?php echo e($Depart->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
              </div>
                  ...
                  <label for="job_role_id" class="form-label">Permision Role <span class="text-danger">*</span></label>
                    <select name="job_role_id" class="form-control select2" required>
                         <option value="0">Select</option>
                            ...
                            <option <?php if($EmployeeDetail && $EmployeeDetail->job_role_id == $Rol->id): ?> selected <?php endif; ?> value="<?php echo e($Rol->id); ?>"><?php echo e($Rol->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div class="col-md-6 select2-primary">
                  <label for="permission_role_id" class="form-label">Job Role <span class="text-danger">*</span></label>
                    <select name="jobrole_id" class="form-control select2" required>
                         <option value="0">Select</option>
                             <?php $__currentLoopData = $Jobrole; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Pers): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option <?php if($EmployeeDetail && $EmployeeDetail->jobrole_id == $Pers->id): ?> selected <?php endif; ?> value="<?php echo e($Pers->id); ?>"><?php echo e($Pers->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div> 
              ...
              <div class="row mb-4"> 
                ...
                <div class="col-md-6 ">
                  ...
                  <br>
                      <input type="checkbox" class="form-check-input input-filter" <?php if($EmployeeDetail && $EmployeeDetail->team_lead == '1'): ?> checked <?php endif; ?>  id="team_lead" name="team_lead" />
                </div>
              </div>
              <hr>
               ...
               <div class="row mb-4"> 
                ...
                <div class="col-md-6 ">
                  ...
                  <select name="additional_week_off_first" class="form-control select2">
                            <option value="0">Select day</option>
                            <?php $__currentLoopData = $Weekly; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Week): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option <?php if($EmployeeDetail && $EmployeeDetail->additional_week_off_first == $Week->id): ?> selected <?php endif; ?> value="<?php echo e($Week->id); ?>"><?php echo e($Week->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
              </div>
                ...
                <div class="col-md-6">
                  <label for="additional_week_off_second" class="form-label">Additional Week Off Second <span class="text-danger">*</span></label>
                    <select name="additional_week_off_second" class="form-control select2">
                            <option value="0">Select day</option>
                            <?php $__currentLoopData = $Weekly; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Week): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option <?php if($EmployeeDetail && $EmployeeDetail->additional_week_off_second == $Week->id): ?> selected <?php endif; ?> value="<?php echo e($Week->id); ?>"><?php echo e($Week->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div class="col-md-6 ">
                  ...
                  <select name="additional_week_off_third" class="form-control select2">
                            <option value="0">Select day</option>
                            <?php $__currentLoopData = $Weekly; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Week): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option <?php if($EmployeeDetail && $EmployeeDetail->additional_week_off_third == $Week->id): ?> selected <?php endif; ?> value="<?php echo e($Week->id); ?>"><?php echo e($Week->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
              </div>
                ...
                <div class="col-md-6">
                  <label for="additional_week_off_fourth" class="form-label">Additional Week Off Fourth <span class="text-danger">*</span></label>
                    <select name="additional_week_off_fourth" class="form-control select2">
                            <option value="0">Select day</option>
                            <?php $__currentLoopData = $Weekly; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Week): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option <?php if($EmployeeDetail && $EmployeeDetail->additional_week_off_fourth == $Week->id): ?> selected <?php endif; ?> value="<?php echo e($Week->id); ?>"><?php echo e($Week->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div class="col-md-6 ">
                    ...
                    <select name="status" class="form-control select2" required>
                      <option value="1" <?php if($EmployeeDetail && $EmployeeDetail->status == 1): ?> selected <?php endif; ?>>Active</option>  
                      <option value="2" <?php if($EmployeeDetail && $EmployeeDetail->status == 2): ?> selected <?php endif; ?>>Resigned</option>  
                      <option value="3" <?php if($EmployeeDetail && $EmployeeDetail->status == 3): ?> selected <?php endif; ?>>Terminated</option>  
                    </select>
                </div>
              </div>
              <div class="row mb-4"> 
                <div class="col-md-4" id="team_lead_section"  <?php if($EmployeeDetail && $EmployeeDetail->team_lead == '1'): ?> style="display:none" <?php endif; ?>>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-6 ">
                  ...
                  <input type="date" class="form-control"  <?php if($EmployeeDetail && $EmployeeDetail->date_of_relieving): ?> value="<?php echo e($EmployeeDetail->date_of_relieving); ?>" <?php endif; ?>  name="date_of_relieving"/>
                </div>
              </div>
              <div class="row mb-4"> 
                <div class="col-md-12">
                  ...
                  <div class="editor-container">
                          <div class="full-editor geteditor"><?php if($EmployeeDetail && $EmployeeDetail->signature): ?> <?php echo $EmployeeDetail->signature; ?> <?php endif; ?></div>
                          <input type="hidden" name="signature"<?php if($EmployeeDetail && $EmployeeDetail->signature): ?> value="<?php echo e($EmployeeDetail->signature); ?>" <?php endif; ?> class="hidden-field">
                      </div>
                </div>
                <div class="col-md-6">
                  <label for="working_type_id" class="form-label">Working Type <span class="text-danger">*</span></label>
                    <select name="working_type_id" class="form-control select2">
                            ...
                            <option <?php if($EmployeeDetail && $EmployeeDetail->working_type_id == '1'): ?> selected <?php endif; ?> value="1">Work From Office</option>
                            <option <?php if($EmployeeDetail && $EmployeeDetail->working_type_id == '2'): ?> selected <?php endif; ?> value="2">Work From Home</option>
                    </select>
                </div>
              </div>
              <hr>
               ...
               <div class="row mb-4"> 
                <div class="col-md-12">
                      ...
                      <select name="shift_id" class="form-control select2" required>
                            ...
                            <option <?php if($EmployeeDetail && $EmployeeDetail->shift_id == $Time->id): ?> selected <?php endif; ?> value="<?php echo e($Time->id); ?>"><?php echo e($Time->shift_name); ?> <b>-</b> <?php echo e(\Carbon\Carbon::parse($Time->StartTime)->format('H:i')); ?> <b>To</b> <?php echo e(\Carbon\Carbon::parse($Time->EndTime)->format('H:i')); ?> </option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              ...
              <div class="row mb-4"> 
                <div class="col-md-12">
                      ...
                      <div class="editor-container">
                          <div class="full-editor geteditor"><?php if($EmployeeDetail && $EmployeeDetail->kra): ?> <?php echo $EmployeeDetail->kra; ?> <?php endif; ?></div>
                          <input type="hidden" name="kra"<?php if($EmployeeDetail && $EmployeeDetail->kra): ?> value="<?php echo e($EmployeeDetail->kra); ?>" <?php endif; ?> class="hidden-field">
                      </div>
                </div>
              </div>     
              <hr>
              ...
              <div class="row mb-4"> 
                <div class="col-md-6">
                  <label for="login_email" class="form-label">Login Email<span class="text-danger">*</span></label>
                    <input type="email"  <?php if($Employee && $Employee->login_email): ?> value="<?php echo e($Employee->login_email); ?>" <?php endif; ?> class="form-control" name="login_email" id="login_email" required />
                </div>
                <div class="col-md-6">
                  <label for="password" class="form-label">Password <span class="text-danger">*</span></label>
                    <div class="d-flex">
                      <input type="password" class="form-control" name="password" <?php if($Employee && $Employee->login_password): ?> value="<?php echo e($Employee->login_password); ?>" <?php endif; ?> required/>
            ...
            <div class="card-footer">
              <div class="row mb-4"> 
                <div class="col-md-6 text-end" >
                  <a href="<?php echo e(url('admin/Employee/home')); ?>" type="button" class="btn btn-outline-danger">Discard</a>
                </div>
                <div class="col-md-6">
...
$(window).on('load', function() {
    ...
    var selectedEmpId = '<?php echo e($EmployeeDetail->team_lead_id); ?>';
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/insighthub_db/resources/views/admin/Humanesources/Employee/edit.blade.php ENDPATH**/ ?>