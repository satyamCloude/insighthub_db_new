        ...
        <div class="card">
          <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row">
            ...
            <div class="action-btns">
              <a href="<?php echo e(url('admin/Rack/home')); ?>" class="btn btn-label-primary me-3">
          ...
          <?php endif; ?>
          <form action="<?php echo e(url('admin/Rack/store')); ?>" method="post" enctype="multipart/form-data"> 
            <?php echo csrf_field(); ?>
            <div class="card-body">
              ...
              <div class="row mb-4"> 
                  <div class="col-md-6">
                    ...
                    <div class="outer" id="clients_<?php echo e($clients->id); ?>" style="display:flex;margin:6px;padding:4px;color:black;" onclick="selectClient2(<?php echo e($clients->id); ?>)">
                      <?php if($clients->profile_img): ?><img src="<?php echo e($clients->profile_img); ?>" style="width:45px;border-radius:50%;height:45px;">
                      <?php else: ?>
                    ...
                    <span><?php echo e($clients->first_name); ?> <?php echo e($clients->last_name); ?> | <?php echo e($clients->id); ?> <br> <?php echo e($clients->company_name); ?></span>
                  ...
                  <div class="col-md-6">
                      ...
                      <select class="form-control" name="vendor_id" required>                      
                          <?php $__currentLoopData = $Vendor; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Vend): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <option value="<?php echo e($Vend->id); ?>"><?php echo e($Vend->first_name); ?></option>   
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>   
                      </select>
                  </div>
              </div>
            ...
            <div class="card-footer">
              <div class="row mb-4"> 
                <div class="col-md-6 text-end" >
                  <a href="<?php echo e(url('admin/Rack/home')); ?>" type="button" class="btn btn-outline-danger">Discard</a>
                </div>
                <div class="col-md-6">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/insighthub/public_html/resources/views/admin/NetworkManagement/Rack/create.blade.php ENDPATH**/ ?>