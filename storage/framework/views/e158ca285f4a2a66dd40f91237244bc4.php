        ...
        <div class="card">
          <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row">
            ...
            <div class="action-btns">
              <a href="<?php echo e(url('admin/Project/home')); ?>" class="btn btn-label-primary me-3">
                <span class="align-middle"> Back</span>
              </a>
            </div>
          </div>
         <form action="<?php echo e(url('admin/Project/store')); ?>" method="post" enctype="multipart/form-data">
             <?php echo csrf_field(); ?>
            <div class="card-body">
              ...
              <div class="row mb-4"> 
                <div class="col-md-4">
                     ...
                     <select class="form-control select-picker" name="category_id" id="project_category_id" data-live-search="true">
                          <option value="">--</option>
                      <?php $__currentLoopData = $ProjectCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lst): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($lst->id); ?>"><?php echo e($lst->category_name); ?></option>
                ...
                <div class="col-md-4">
                      ...
                      <div class="input-group">
                                      <select class="form-control select-picker" name="department_id" id="employee_department" data-live-search="true">
                                          <option value="">--</option>
                                           <?php $__currentLoopData = $Department; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lst): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($lst->id); ?>"><?php echo e($lst->name); ?></option>
                ...
                <div class="col-md-4">
                     ...
                     <div class="input-group">
                        <select class="form-control select-picker" name="client_id" id="project_client_id" data-live-search="true">
                            <option value="">--</option>
                             <?php $__currentLoopData = $Client; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lst): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <option value="<?php echo e($lst->id); ?>"><?php echo e($lst->first_name); ?></option>
                               <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/insighthub/public_html/resources/views/admin/Project/create.blade.php ENDPATH**/ ?>