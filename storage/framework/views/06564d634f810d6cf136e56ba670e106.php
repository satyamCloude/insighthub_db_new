         ...
         <div class="col-12">
            <div class="card mb-4">
               <div class="user-profile-header-banner">
                  <img height="248" <?php if($user->banner): ?> src="<?php echo e($user->banner); ?>" <?php else: ?> src="https://demos.pixinvent.com/vuexy-html-admin-template/assets/img/pages/profile-banner.png" <?php endif; ?> alt="Banner image" class="rounded-top" style="    width: 100%;" />
               </div>
      ...
      <div class="row">
                     ...
                     <ul class="list-unstyled mb-4 mt-3">
                        <li class="d-flex align-items-center mb-3">
                           <i class="ti ti-user text-heading"></i
                              ><span class="fw-medium mx-2 text-heading">Full Name:</span> <span><?php echo e($user->first_name); ?></span>
                        </li>
                        <li class="d-flex align-items-center mb-3">
         ...
         <div class="col-12 mt-4">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form class="formChangePassword2" id="formChangePassword2" method="POST" action="<?php echo e(url('admin/changePasswords/' . Auth::user()->id)); ?>">
                        <?php echo csrf_field(); ?>
...
<script>
   $(document).ready(function() {
   	$('.edit-profile').click(function() {
           ...
           $.ajax({
               url: "<?php echo e(url('admin/ProfileSettings/home')); ?>", // Controller routes
               type: 'GET',
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/insighthub/public_html/resources/views/admin/MyProfile/index.blade.php ENDPATH**/ ?>