...
<script type="text/javascript">
  ...
  function Tab(value, id, Activeid) {
    ...
    $.ajax({
        url: "<?php echo e(url('Employee/Employee/TabView')); ?>",
        method: 'GET',
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/insighthub/public_html/resources/views/Employee/Humanesources/Employee/view.blade.php ENDPATH**/ ?>