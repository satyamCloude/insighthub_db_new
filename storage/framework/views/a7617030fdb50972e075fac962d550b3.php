 ...
 <div class="shadow-none border-0">
      ...
      <div class="email-list pt-0">
        <ul class="list-unstyled m-0">
          <?php if(count($DraftMails) > 0): ?>
           <?php $__currentLoopData = $DraftMails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $Send): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
             ...
             <div class="d-flex align-items-center">
               ...
               <div class="email-list-item-meta ms-auto d-flex align-items-center">
                 ...
                 <ul class="list-inline email-list-item-actions text-nowrap">
                   <li class="list-inline-item email-edit" onclick="edit(<?php echo e($Send->id); ?>)"><i class="fa-regular fa-pen-to-square"></i></li>
                   <li class="list-inline-item email-delete" onclick="Delete(<?php echo e($Send->id); ?>)"><i class="ti ti-trash ti-sm"></i></li>
                   <li class="list-inline-item" onclick="SendM(<?php echo e($Send->id); ?>)"><i class="ti ti-send ti-sm"></i></li>
                 </ul>
               </div>
             </div>
           </li>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/insighthub_db/resources/views/admin/sales/MassMail/DraftMails.blade.php ENDPATH**/ ?>