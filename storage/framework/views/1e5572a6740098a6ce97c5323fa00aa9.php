                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <div class="inner_cont">
                            <span style="color: #5d596c;font-weight: 500;font-size: 22px;margin-bottom: 9px;"><?php echo e($currency->name); ?></span>
                            <ul style="padding-left: 1px;list-style: none;margin-top:7px;">
                                <li style="margin-right:26px;color:#1cab5b">Paid &nbsp; <?php echo e($currency->prefix); ?><?php echo e(number_format($result[$currency->code]->total_paid, 2)); ?> <?php echo e($currency->code); ?></li>
                                <li style="margin-right:26px;color:#ea5455;">Unpaid &nbsp; <?php echo e($currency->prefix); ?><?php echo e(number_format($result[$currency->code]->total_unpaid, 2)); ?> <?php echo e($currency->code); ?></li>
                                <li style="margin-right:26px;color:#dc7a1b;">Overdue &nbsp; <?php echo e($currency->prefix); ?><?php echo e(number_format($result[$currency->code]->total_due, 2)); ?> <?php echo e($currency->code); ?></li>
                            </ul>
                        </div>
                    </div>
                ...
                <form>
                    <div class="row mb-4"> 
                        <div class="col-md-3">
                            ...
                            <input type="date" name="fDate" class="form-control" value="<?php echo e($fDate); ?>">
                        </div>
                        <div class="col-md-3">
                            <label for="client_id" class="form-label">To Date<span class="text-danger">*</span></label>
                            <input type="date" name="tDate" class="form-control"  value="<?php echo e($tDate); ?>">
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="text" name="invoiceId" class="form-control" value="<?php echo e($invoiceId); ?>">
                        </div>
                        <div class="col-md-2">
                            <label for="warranty_expiry" class="form-label">Status<span class="text-danger">*</span></label>
                            <select name="status" class="form-control select2">
                                <option value="">Select Status</option>
                                <option value="1" <?php echo e($status == 1 ? 'selected':''); ?>>Paid</option>
                                <option value="2" <?php echo e($status == 0 ? 'selected':''); ?>>UnPaid</option>
                            </select>
                        </div>
                        <div class="col-md-2">
                            <br>
                ...
                <table id="invoiceListTable" class="invoice-list-table table border-top">
                            ...
                            <?php $__currentLoopData = $Invoice; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $Inventor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="odd">
                                    <td style="padding-left:6px;padding-right:0px;">
                                        <input type="checkbox" name="ids[]" class="selectId" value="<?php echo e($Inventor->id); ?>">&nbsp;&nbsp;<?php echo e($key + 1); ?>
                                    ...
                                    <td>
                                        <div class="parent d-flex">
                                            ...
                                            <div class="child2">
                                                  <?php echo e($Inventor->first_name); ?> <?php echo e($Inventor->last_name); ?> | (#<?php echo e($Inventor->users_id); ?>) <br> <span style="color:#6e6c76;font-size:85%"><?php echo e($Inventor->comp_name); ?></span>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td><?php if($Inventor && $Inventor->issue_date): ?> <?php echo e($Inventor->issue_date); ?> <?php endif; ?></td>
                                    <td><?php if($Inventor && $Inventor->due_date): ?> <?php echo e($Inventor->due_date); ?> <?php endif; ?></td>
                                        <td>
                                        <?php
                                    ...
                                    <td>
                                        ...
                                        ?>
                                        <?php echo e(isset($Inventor) ? $Inventor->prefix . number_format($final_amt1, 2) : ''); ?>
                                      ...
                                      <td>
                    <?php if($Inventor && floatval($Inventor->final_total_amt) == floatval($Inventor->paid_amount)): ?>
                        <span class="btn btn-success btn-sm">Paid</span>
                    <?php elseif($Inventor && $Inventor->paid_amount > 0 && floatval($Inventor->final_total_amt) != floatval($Inventor->paid_amount)): ?>
                    ...
                    <?php endif; ?>
                                    ...
                                    <td>
                                        ...
                                        ?>
                                             <?php if($Inventor && floatval($Inventor->final_total_amt) == floatval($Inventor->paid_amount)): ?>
                                                    <button class="dropdown-item btn-next auto_pay" data-id="<?php echo e($Inventor->id); ?>"  data-clientid="<?php echo e($Inventor->client_id); ?>" data-amount="<?php echo e($final_amt1); ?>">Pay</button>
                                            <?php elseif($Inventor && $Inventor->paid_amount > 0 && floatval($Inventor->final_total_amt) != floatval($Inventor->paid_amount)): ?>
                                                     <button class="dropdown-item btn-next auto_pay" data-id="<?php echo e($Inventor->id); ?>"  data-clientid="<?php echo e($Inventor->client_id); ?>" data-amount="<?php echo e($final_amt1); ?>">Pay</button>
                                                <?php endif; ?>
                                                    <li><a class="dropdown-item" href="<?php echo e(url('admin/Invoices/edit/'.$Inventor->id)); ?>">Edit</a></li>
                                                <li><button class="dropdown-item delete_debtcase" url="<?php echo e(url('admin/Invoices/delete/'.$Inventor->id)); ?>">Delete</button></li>
                                            </ul>
                                        </div>
                                    </td>
                                </tr>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3 form-check">
                    ...
                    <?php echo e($default_currency->prefix); ?> <span id="creditBalance" >0.00</span>
                ...
                <div class="mb-3" id="paymentAmountContainer" >
                    ...
                    <label for="paymentAmount" class="form-label">Payment Amount : <?php echo e($default_currency->prefix); ?> <span id="totalAmount">0.00</span></label>
...
<script>
    ...
    $('.auto_pay').click(function() {
        ...
        $.ajax({
            url: "<?php echo e(url('admin/Client/getCredit')); ?>/"+clientid, // Controller route
            type: 'GET',
    ...
    document.querySelectorAll('.rzp-payment-btn').forEach(button => {
        ...
        button.addEventListener('click', function() {
            ...
            var options = {
                ...
                "currency": "<?php echo e($default_currency->code); ?>",

                "name": "Tech CRM",

                "image": "<?php echo e(url('/')); ?>/public/logo/company.png",

                "handler": function(response) {

                    window.location.href = "<?php echo e(url('admin/Invoices/paymentStatusUpdate')); ?>?orderId=" + invoiceId + "&payment_id=" + response.razorpay_payment_id;
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/insighthub/public_html/resources/views/admin/Invoices/home.blade.php ENDPATH**/ ?>