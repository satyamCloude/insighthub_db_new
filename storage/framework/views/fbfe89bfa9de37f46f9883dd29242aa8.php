...
<div class="row">
   <div class="col-12">
      ...
      <?php endif; ?>
      <div class="card">
         <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row" style="background:linear-gradient(72.47deg, #7367f0 22.16%, rgba(115, 103, 240, 0.7) 76.47%);">
            <h5 class="card-title mb-sm-0 me-2" style="color:white;font-size:19px;">Add Detail's</h5>
            <div class="action-btns">
               <a href="<?php echo e(url('Employee/Quotes/home')); ?>" class="btn btn-label-primary me-3" style="background-color:white;">
               <span class="align-middle"> Back</span>
               </a>
            </div>
         </div>
         <form action="<?php echo e(url('Employee/Quotes/store')); ?>" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="card-body">
               <div class="row mb-4">
                  <div class="col-md-2">
                  ...
                  <?php if($_REQUEST && $_REQUEST['id']): ?>
                  <input type="hidden" class="form-control" id="leads_id" name="leads_id" value="<?php echo e($_REQUEST['id']); ?>" />
                  <?php else: ?>
               ...
               <div class="row mb-4">
                  <div class="col-md-6">
                     ...
                     <input type="text" class="form-control" id="first_name" name="first_name" <?php if($lead): ?> value="<?php echo e($lead->first_name); ?>" <?php endif; ?> placeholder="ABC" required/>
                  </div>
                  <div class="col-md-6">
                     <label for="last_name" class="form-label">Last name <span class="text-danger">*</span></label>
                     <input type="text" class="form-control" id="last_name" name="last_name" <?php if($lead): ?> value="<?php echo e($lead->last_name); ?>" <?php endif; ?> placeholder="+ABC" required/>
                  </div>
               </div>
               <div class="row mb-4">
                  <div class="col-md-6">
                     <label for="email" class="form-label">Email address <span class="text-danger">*</span></label>
                     <input type="email" class="form-control" id="email" name="email" <?php if($lead): ?> value="<?php echo e($lead->email); ?>" <?php endif; ?> placeholder="name@example.com" required/>
                  </div>
                  <div class="col-md-6">
               ...
               <div class="row mb-4">
                  <div class="col-md-6">
                     ...
                     <input type="text" class="form-control" id="company_id" name="company_id" <?php if($id != ''): ?> value="<?php echo e($lead->company_name); ?>" <?php endif; ?> placeholder="company name" required/>
                  </div>
               </div>
               <hr>
               ...
               <div class="row mb-4 mt-4 mb-3">
                  <div class="col-md-6">
                     ...
                     <input type="date" class="form-control" name="date_created" placeholder="Demo" required value="<?php echo date('Y-m-d'); ?>"/>
                  </div>
                  ...
                  <div class="row newa1 mb-4">
                    <div class="col-md-3">
                        ...
                        <textarea class="form-control" id="description" name="description[]" placeholder="...."  rows="1" required></textarea>
                     </div>
                     <div class="col-md-2">
                     ...
                     <input type="hidden" id="Products_id1" name="Products_id[]">
                     <input type="hidden" id="BillingCycle1" name="BillingCycle[]">
                     <input type="hidden" id="Caltax" name="Caltax[]">
                     <div class="col-md-2">
                        <label for="unit_price" class="form-label">Unit Price <span class="text-danger">*</span></label>
                        <input type="number"  class="form-control unit_price" id="unit_price" name="unit_price[]"  placeholder="01" required/>
                     </div>
                     <div class="col-md-2">
                     ...
                     <div class="col-md-1">
                        ...
                        <input type="number" class="form-control taxs" name="tax_rate[]" id="unit_tax" placeholder="0"  required/>
                        <input type="hidden" id="unit_tax_id" class="form-control tax" name="tax[]" >
                     </div>
                     <div class="col-md-2">
         ...
         <div class="modal-body">
            ...
            <div class="row md-4 addones" style="display:none">
               <div class="col mb-3">
                  ...
                  <select name="Products_id[]" class="form-control select2 addones " id="addones" onchange="get_addon_price(this.value)"  required>
...
<script>
  ...
  $(document).ready(function() {
     $('#country').on('change', function() {
       ...
       $.ajax({
          url: "<?php echo e(url('Employee/Client/getstateData')); ?>", // Replace with your actual route name
          method: 'post',
  ...
  function addNewRow(mod_price_unit, mod_description, productservices, mod_billing_cycle, mod_tax, modTaxrate) {
      var newRow = '<div class="row newa' + (modalCounter++) + ' mb-4">' +
          ...
          '<div class="col-md-2">' +
          '<label for="total" class="form-label">Total <span class="text-danger">*</span></label>' +
          '<input type="number" class="form-control total" name="total[]" placeholder="01" step="0.01" required/>' +
          '</div>' +
          '<div class="col-md-1">' +
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/insighthub/public_html/resources/views/Employee/sales/Quotes/create.blade.php ENDPATH**/ ?>