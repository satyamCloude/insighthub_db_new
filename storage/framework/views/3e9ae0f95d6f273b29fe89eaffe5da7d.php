      ...
      <div class="card-datatable table-responsive">
        <div id="DataTables_Table_3_wrapper" class="dataTables_wrapper dt-bootstrap5">
          ...
          <table class="dt-responsive table dataTable dtr-column" id="DataTables_Table_3" aria-describedby="DataTables_Table_3_info">
            ...
            <tbody>
              <?php if(count($LeadSource) > 0): ?>
              <?php $__currentLoopData = $LeadSource; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $Inventor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr class="odd">
                  <td><?php echo e($key+1); ?> </td>
                  <td><?php if($Inventor && $Inventor->name): ?> <?php echo e($Inventor->name); ?> <?php endif; ?></td>
                  <td>
                    <div class="btn-group">
                          ...
                          <ul class="dropdown-menu dropdown-menu-end" style="">
                            <li><a class="dropdown-item" href="#" id="<?php echo e($Inventor->id); ?>" onclick="editCategory(this)">Edit</a></li>
                             <?php if($Inventor->id > 7): ?>
                            <li><button class="dropdown-item delete_debtcase" url="<?php echo e(url('admin/LeadSettings/LeadSource/delete/'.$Inventor->id)); ?>" id="<?php echo e($Inventor->id); ?>">Delete</button></li>
                            <?php endif; ?>
                          </ul>
                      </div>
                  </td>
...
<div class="modal fade" id="myModal" data-bs-backdrop="static" tabindex="-1" style="display: none;" aria-modal="true" role="dialog">
    <div class="modal-dialog">
      <form class="modal-content" action="<?php echo e(url('admin/LeadSettings/LeadSource/store')); ?>" method="post">
        <?php echo csrf_field(); ?>
...
<div class="modal fade" id="showedit" data-bs-backdrop="statics" tabindex="-1" aria-modal="true" role="dialog">
    ...
    <div class="modal-dialog">
      <form class="modal-content" action="<?php echo e(url('admin/LeadSettings/LeadSource/update')); ?>" method="post">
        <?php echo csrf_field(); ?>
        <div class="modal-header">
...
<script>
   function TVINETab(value) {
    $.ajax({
        url: "<?php echo e(url('admin/LeadSettings/VINETab')); ?>",
        method: 'GET',
        data: { type: value },
  ...
  function editCategory(element) {
    ...
    $.ajax({
        url: "<?php echo e(url('admin/LeadSettings/LeadSource/edit/')); ?>",
        method: 'GET',
        data: { id: cate_id },
...
</script><?php /**PATH /home/insighthub/public_html/resources/views/admin/settings/LeadSettings/home.blade.php ENDPATH**/ ?>