...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <div class="row">
    <div class="col-12">
      ...
      <?php endif; ?>
        <form action="<?php echo e(url('admin/Client/store')); ?>" method="post" enctype="multipart/form-data"> 
          <?php echo csrf_field(); ?>
          <div class="card-body">
            <div class="input-group mt-5 mb-3">
              ...
              <!--</select>-->
              <input type="text" name="first_name" value="<?php echo e(old('first_name')); ?>" placeholder="First name" class="form-control" required />
              <input type="text" name="last_name" value="<?php echo e(old('last_name')); ?>" placeholder="Last name" class="form-control" required/>
            </div>
            <div class="row mb-4"> 
                <div class="col-md-6">
    ...
    <input type="tel" name="phone_number" id="phone_number" value="<?php echo e(old('phone_number')); ?>" class="inpt form-control" required placeholder="+1234567890" pattern="[0-9+]{1,10}" maxlength="10" oninput="this.value = this.value.replace(/[^0-9+]/g, '').slice(0, 10);">
</div>
            </div>
            <div class="row mb-4"> 
              <div class="col-md-6">
                <label for="exampleForm1" class="form-label">Email address</label>
                <input type="email" class="form-control"  value="<?php echo e(old('email')); ?>" name="email" id="exampleFormCont1" placeholder="name@example.com" required/>
              </div>
              <div class="col-md-6">
                <div class="form-password-toggle">
                  <label class="form-label" for="basic-default-password32">Password</label>
                  <div class="input-group input-group-merge">
                    <input type="password" class="form-control"  value="<?php echo e(old('password')); ?>" name="password" id="basic-default-password32" placeholder="············" aria-describedby="basic-default-password" required>
            ...
            <div class="row mb-4"> 
              <div class="col-md-6">
                ...
                <input type="text" class="form-control" value="<?php echo e(old('address_1')); ?>"  name="address_1" id="exampleFo7rmControlInput1" placeholder="Address 1" required/>
              </div>
              <div class="col-md-6">
                <label for="exampleFormControl8Input1" class="form-label">Address 2</label>
                <input type="text" class="form-control"  value="<?php echo e(old('address_2')); ?>"  name="address_2" id="exampleFormControlIn9put1" placeholder="Address 2" required/>
              </div>
            </div>
            <div class="row mb-4"> 
              <div class="col-md-3">
              ...
              <div class="col-md-3">
                ...
                <input type="number" class="form-control" value="<?php echo e(old('pincode')); ?>" name="pincode" id="exampleFormjControlInput1" placeholder="Pincode" required />
              </div>
            </div>
            <div class="row mb-4"> 
              <div class="col-md-3">
                <label for="exampleFormControlIpnput1" class="form-label">GSTIN</label>
                <input type="text" class="form-control" value="<?php echo e(old('gstin')); ?>" name="gstin" id="gstNumber" maxlength="15" placeholder="GSTIN" required/>
              ...
              <div class="col-md-3">
                ...
                <input type="text" class="form-control" name="hsn_sac" value="<?php echo e(old('hsn_sac')); ?>" id="exampleFormConqtrolInput1" placeholder="HSN/SAC" required/>
              </div>
              <div class="col-md-3">
                <label for="exampleFormrControlInput1" class="form-label">TDS</label>
                <input type="number" class="form-control" name="tds" value="<?php echo e(old('tds')); ?>" id="exasmpleFormControlInput1" maxlength="10" placeholder="TDS" required/>
              </div>
              <div class="col-md-3">
            ...
            <div class="row mb-4"> 
              <div class="col-md-3">
                ...
                <select class="form-control select2" name="currency" required>
                  <?php $__currentLoopData = $Currency; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Currencies): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <option value="<?php echo e($Currencies->id); ?>"><?php echo e($Currencies->prefix); ?> <?php echo e($Currencies->code); ?></option>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>  
                </select>
              </div>
              <!--<div class="col-md-3 ">-->
                  ...
                  <div class="dropdown-content">
                    ...
                    <div class="outer" id="client_<?php echo e($client->id); ?>" style="display:flex;margin:6px;padding:4px;color:black;" onclick="selectClient(<?php echo e($client->id); ?>)">
                      ...
                      <div class="sie_cont" style="display:flex;flex-direction:column;margin:5px;">
                        <span><?php echo e($client->first_name); ?> <?php echo e($client->last_name); ?> (#<?php echo e($client->id); ?>) <br/><?php echo e($client->jobrole); ?></span>
 ...
 <div class="col-md-6">
  ...
  <div class="avatar-upload">
    ...
    <div class="avatar-preview">
      ...
      <img id="imagePreview" width="100%" name="profile_img" src="<?php echo e(url('/')); ?>/public/images/default_profile.jpg" alt="Preview" />
    </div>
  </div>
</div>
<div class="col-md-6">
...
<script>
  ...
  $(document).ready(function() {
    ...
    $('#gstNumber').keyup(function() {
      ...
      $.ajax({
                    url: "<?php echo e(url('admin/Client/check-gst-number')); ?>", // The URL of the server-side script
                    type: 'POST',
                    headers: {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/insighthub/public_html/resources/views/admin/user/client/create.blade.php ENDPATH**/ ?>