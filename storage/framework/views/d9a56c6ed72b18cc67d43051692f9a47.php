    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <form action="<?php echo e(url('admin/TaxSettings/store')); ?>" method="post" enctype="multipart/form-data"> 
            <?php echo csrf_field(); ?>
            <div class="card-body">
              <div class="row mb-4"> 
                <div class="col-md-6">
  ...
  <?php /**PATH /home/insighthub/public_html/resources/views/admin/settings/TaxSettings/create.blade.php ENDPATH**/ ?>