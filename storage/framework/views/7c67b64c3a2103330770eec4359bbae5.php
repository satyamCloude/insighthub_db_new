  ...
  <div class="card">
    <div class="row">
      ...
      <div class="col-md-6 text-end">
         <a href="<?php echo e(url('admin/TaskCategory/EXPORTCSV')); ?>" class="btn btn-info mt-3 m-3"><i class="fa-solid fa-file-csv"></i></a>
      ...
      <div class="card-datatable table-responsive">
        <div id="DataTables_Table_3_wrapper" class="dataTables_wrapper dt-bootstrap5">
          ...
          <table class="dt-responsive table dataTable dtr-column" id="DataTables_Table_3" aria-describedby="DataTables_Table_3_info">
            ...
            <tbody>
              <?php if(count($TaskCategory) > 0): ?>
              <?php $__currentLoopData = $TaskCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $Inventor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr class="odd">
                  ...
                  <td><?php if($Inventor && $Inventor->category_name): ?> <?php echo e($Inventor->category_name); ?> <?php endif; ?></td>
                    ...
                    <div class="btn-group">
                          ...
                          <ul class="dropdown-menu dropdown-menu-end" style="">
                            <li><a class="dropdown-item" onclick="EditTaskCategory(<?php echo e($Inventor->id); ?>)">Edit</a></li>
                            <li><button class="dropdown-item delete_debtcase" url="<?php echo e(url('admin/TaskCategory/delete/'.$Inventor->id)); ?>" id="<?php echo e($Inventor->id); ?>">Delete</button></li>
                          </ul>
                      </div>
                  </td>
              </tr>
...
<script>
 ...
 function EditTaskCategory(id) {
    $.ajax({
        url: `<?php echo e(url('admin/TaskCategory/edit/')); ?>/${id}`,
        method: 'GET',
        data: { id: id },
...
function updatepro(status,value,id){
  $.ajax({
        url: "<?php echo e(url('admin/TaskCategory/UpdateStatus')); ?>",
        method: 'GET',
        data: { id: id,
                status_pro: value, 
                status : status
...
</script><?php /**PATH /home/insighthub/public_html/resources/views/admin/TaskCategory/home.blade.php ENDPATH**/ ?>