  ...
  <div class="card">
      ...
      <div class="card-datatable table-responsive">
         ...
         <div class="alert alert-success" role="alert"><?php echo e(Session::get('success')); ?></div>
          ...
          <form action="<?php echo e(url('admin/InvoiceModule/store/'.$id)); ?>" method="post" enctype="multipart/form-data"> 
           <?php echo csrf_field(); ?>
            <div class="card-body">
              <div class="row mb-4"> 
                ...
                <div class="col-md-12 ">
                      ...
                      <input type="text" class="form-control" value="<?php if($template_data && $template_data->subject): ?>  <?php echo e($template_data->subject); ?> <?php endif; ?>" name="subject" />
                </div>
            ...
            <div class="row mb-4"> 
                <div class="col-md-12">
                      <label for="header" class="form-label"><h5>Header<span class="text-danger">*</span></h5></label>
                       <textarea type="text" name="header" id="header" class="form-control"><?php if($template_data && $template_data->header): ?>  <?php echo e($template_data->header); ?> <?php endif; ?></textarea>                     
                </div>
            </div>
             <div class="row mb-4"> 
                <div class="col-md-12">
                      <label for="discription" class="form-label"><h5>Template<span class="text-danger">*</span></h5></label>
                       <textarea type="text" name="template" id="template" class="form-control"><?php if($template_data && $template_data->template): ?>  <?php echo e($template_data->template); ?> <?php endif; ?></textarea>                     
                </div>
            </div>
             ...
             <div class="row mb-4"> 
                <div class="col-md-12">
                      <label for="footer" class="form-label"><h5>Footer<span class="text-danger">*</span></h5></label>
                       <textarea type="text" name="footer"  id="footer" class="form-control"><?php if($template_data && $template_data->footer): ?>  <?php echo e($template_data->footer); ?> <?php endif; ?></textarea>                     
                </div>
            </div>
            </div>
             <div class="col-md-12">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/insighthub/public_html/resources/views/admin/ETemplatesettings/InvoiceModule/home.blade.php ENDPATH**/ ?>