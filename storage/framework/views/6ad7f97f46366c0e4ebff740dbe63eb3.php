...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="row mt-4 m-4">
        ...
        <div class="col-md-8 text-end ">
           ...
           <a href="<?php echo e(url('admin/LogActivity/lead')); ?>"class="btn btn-primary">Lead</a>
        </div>
    </div>
    <div class="card  m-4">
              ...
              <?php if(count($LogActivity) > 0): ?>
                 <?php $__currentLoopData = $LogActivity; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr class="odd">
                      ...
                      <td> <?php echo e($user->user_id == 1 ? 'Admin ID' : 'Employee ID'); ?> <?php echo e($user->user_id); ?><br><small style="color:#b5b2b2;"><?php echo e($user->email); ?></small></td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/insighthub/public_html/resources/views/admin/settings/LogActivity/lead.blade.php ENDPATH**/ ?>