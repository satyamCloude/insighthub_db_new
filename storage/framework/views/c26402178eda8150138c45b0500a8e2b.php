      ...
      <div class="card">
         <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row">
            ...
            <div class="action-btns">
               <a href="<?php echo e(url('Employee/Quotes/home')); ?>" class="btn btn-label-primary me-3">
               <span class="align-middle"> Back</span>
               </a>
            </div>
         </div>
         <form action="<?php echo e(url('Employee/Quotes/update/'.$Quotes->id)); ?>" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="card-body">
               <div class="row mb-4">
                  <div class="col-md-2">
               ...
               <div class="card-footer">
                  <div class="row mb-4">
                     <div class="col-md-6 text-end" >
                        <a href="<?php echo e(url('Employee/Quotes/home')); ?>" type="button" class="btn btn-outline-danger">Discard</a>
                     </div>
                     <div class="col-md-6">
   ...
   <div class="modal-dialog modal-xl">
      <form class="modal-content">
         ...
         <div class="modal-body">
            ...
            <div class="row md-4 addones" style="display:none">
               <div class="col mb-3">
...
<script>
   ...
   $.ajax({
        url: "<?php echo e(url('Employee/Quotes/get_categoryProduct')); ?>",
        method: 'GET',
   ...
   function mod_billing_cycles(value) {
      ...
      // alert(cycleid);
      $.ajax({
         url: "<?php echo e(url('Employee/Quotes/get_productdata')); ?>",
         method: 'GET',
   ...
   function get_product_addon(value) {
      var productid = $('#productservices').val(); // Get the selected product ID
      $.ajax({
         url: "<?php echo e(url('Employee/Quotes/get_product_addon')); ?>",
         method: 'GET',
   ...
   function getUserDetails(id) {
    $.ajax({
        type: 'GET',
        url: "<?php echo e(url('Employee/getUserDetails')); ?>",
        data: {
            id: id,
        },
   ...
   $.ajax({
      type: 'GET',
      url: "<?php echo e(url('Employee/Invoices/check_invoice_number')); ?>",
      data: {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/insighthub/public_html/resources/views/Employee/sales/Quotes/edit.blade.php ENDPATH**/ ?>