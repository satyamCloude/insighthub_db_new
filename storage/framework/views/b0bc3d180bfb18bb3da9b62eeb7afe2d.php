          ...
          <tr class="even">
            ...
            <td>
              <div class="d-flex justify-content-start align-items-center user-name">
                <div class="avatar-wrapper">
                  <div class="avatar me-2">
                   <img src="<?php echo e(url('/')); ?>/public/images/caution.png">
                  </div>
                </div>
                <div class="d-flex flex-column">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/insighthub/public_html/resources/views/admin/MonitoringService/ServerMonitoring/index.blade.php ENDPATH**/ ?>