...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <!-- <a href="<?php echo e(url('Employee/PayRoll/home2')); ?>" class="btn btn-label-primary me-3">
    ...
    <div class="row mt-4 mb-4">
        ...
        <div class="col-md-8" style="text-align: end;">
            <div class="btn-group justify-content-center" >
                ...
                <!--<a href="<?php echo e(url('Employee/PayRoll/EXPORTCSV')); ?>" class="btn btn-secondary buttons-collection btn-label-primary waves-effect waves-light" tabindex="0" aria-controls="DataTables_Table_0" type="button" aria-haspopup="dialog" aria-expanded="false">-->
                <!--    <span>-->
                        <!-- <i class="ti ti-file-export me-sm-1"></i> -->
                <!--        <span class="d-none d-sm-inline-block">Export</span>-->
                <!--    </span>-->
                <!--</a>-->
                <a href="<?php echo e(url('Employee/PayRoll/GenerateSellary')); ?>" class="btn btn-info">
                	<span>
                        <!-- <i class="fas fa-sync-alt"></i> -->
                        <span class="d-none d-sm-inline-block">Generate</span>
                    </span></a>
                <!-- <a href="<?php echo e(url('Employee/PayRoll/home')); ?>" class="btn btn-secondary"><i class="fas fa-sync-alt"></i></a> -->
            </div>
        </div>
	</div>
	<div class="row">
                                ...
                                <tbody id="result">
                                    ...
                                    <tr class="odd">
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo e(url('Employee/PayRoll/view/'.$user->user_id)); ?>" class="text-info" ><i class="fas fa-eye pointer-cursor"></i></a>&nbsp;&nbsp;
                                            <a class="btn-link" href="<?php echo e(url('Employee/PayRoll/SallarySlip/'.$user->id)); ?>"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></a>
                                        </td>
                                    </tr>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" action="<?php echo e(url('Employee/PayRoll/Rules/update/'.$Rules->id)); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="row">
...
function fetchData() {
    ...
    $.ajax({
        url: "<?php echo e(url('Employee/PayRoll/get_SallaryData')); ?>",
        method: 'GET',
        data: {
            year: selectedYear,
            month: selectedMonth
        ...
        success: function(data) {
            ...
            console.log(data);
            if (data && data.data && data.html.length > 0) {
    ...
    return value.toFixed(2) + '%';
        ...
        function Salary() {
            $.ajax({
                url: "<?php echo e(url('Employee/PayRoll/Salary')); ?>",
                method: 'GET',
                success: function(data) {
                    // Handle the successful response
        ...
        function Deduction() {
            $.ajax({
                url: "<?php echo e(url('Employee/PayRoll/Deduction')); ?>",
                method: 'GET',
                success: function(data) {
                    // Handle the successful response
                    $('#newpayroll').empty(); // Clear previous content
        ...
        function TDS() {
            $.ajax({
                url: "<?php echo e(url('Employee/PayRoll/TDS')); ?>",
                method: 'GET',
                success: function(data) {
                    // Handle the successful response
                    $('#newpayroll').empty(); // Clear previous content
        ...
        function editrol(element) {
            ...
            $.ajax({
                url: "<?php echo e(url('Employee/PayRoll/edit')); ?>",
                method: 'GET',
                data: {
                    id: id
                },
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/insighthub/public_html/resources/views/Employee/Humanesources/PayRoll/home.blade.php ENDPATH**/ ?>