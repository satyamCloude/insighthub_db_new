...
<head>
   ...
   <link rel="stylesheet" href="<?php echo e(url('public/assets/vendor/css/pages/app-invoice.css')); ?>" />
   <style>
    .card-body {
        flex: 1 1 auto;
        min-height: 1px;
            ...
            <div class="invoice-table-wrapper">
                <table width="100%">
                    <tbody><tr class="inv-logo-heading">
                        <td class="tthead"><img src="<?php if($Quotes && $Quotes->companylogo): ?> <?php echo e($Quotes->companylogo); ?> <?php endif; ?>" alt="Worksuite" id="logo"></td>
                    ...
                    <tr class="inv-num">
                        <td width="61%" class="f-14 text-dark">
                            <p class="mt-3 mb-0"><br>
                             <?php if($Quotes && $InvoiceSettings->show_client_company_name ==1): ?>
                             <?php echo e($Quotes->company_name); ?>

                             <?php endif; ?><br> 
                             <?php if($Quotes): ?>

                             <?php echo e($Quotes->contact_no); ?> <br>
                             <?php echo e($Quotes->billing_address); ?>                             <?php endif; ?>
                             </p> 
                        </td>
                        <td align="right">
                            <table class="inv-num-date text-dark f-13 mt-3 marg" width="100%">
                                <tbody>
                                    <tr>
                                        <td class="bg-light-grey border-right-0 f-w-500">
                                        Invoice Number</td>
                                        <td class="border-left-0"> <?php if($Quotes): ?><?php echo e($Quotes->invoice_number1); ?> <?php echo e($Quotes->invoice_number2); ?>  <?php endif; ?></td>
                                    </tr>
                                <tr>
                                    <td class="bg-light-grey border-right-0 f-w-500">Invoice Date</td>
                                    <td class="border-left-0"><?php if($Quotes): ?><?php echo e($Quotes->date_created); ?><?php endif; ?></td>
                                </tr>
                                <tr>
                                    <td class="bg-light-grey border-right-0 f-w-500">Due Date</td>
                                    <td class="border-left-0"><?php if($Quotes): ?><?php echo e($Quotes->valid_until); ?><?php endif; ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </td>
                ...
                <tbody><tr class="inv-unpaid">
                    <td class="f-14 text-dark">
                         <p class="mb-0 text-left">
                          ...
                          <?php if($Quotes && $InvoiceSettings->show_client_name ==1): ?>
                          <?php echo e($Quotes->first_name); ?> <?php echo e($Quotes->last_name); ?>

                          <?php endif; ?><br>

                          <?php if($Quotes && $InvoiceSettings->show_client_email ==1): ?>
                          <?php echo e($Quotes->email); ?>

                          <?php endif; ?><br>

                          <?php if($Quotes && $InvoiceSettings->show_client_phone ==1): ?>
                          <?php echo e($Quotes->phone_number); ?>

                          <?php endif; ?><br>

                          <?php if($Quotes && $InvoiceSettings->show_client_company_address ==1): ?>
                          <?php echo e($Quotes->address_1); ?><br>
                          <?php echo e($Quotes->address_2); ?><br>
                          <?php endif; ?>
                          <?php if($Quotes): ?>

                          <?php echo e($Quotes->pincode); ?>                          <?php endif; ?>
<br>

                        </p>
                    </td>
                        <td align="right" class="mt-2 mt-lg-0 mt-md-0">
                            <?php if($Quotes && $Quotes->is_payment_received == 0): ?>
                            <span class="unpaid rounded f-15">Unpaid</span>
                            <?php elseif($Quotes && $Quotes->is_payment_received == 1): ?>
                        ...
                        <td colspan="2">
                            <table class="inv-detail f-14 table-responsive-sm" width="100%">
                                <tbody>
                                    ...
                                    <?php $Tax =  \App\Models\TaxSetting::whereIn('id', explode(',',$Quote->Caltax))->get() ?>
                                    <tr class="text-dark font-weight-semibold f-13">
                                      ...
                                      <td align="right"><?php $__currentLoopData = $Tax; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tax): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php echo e($tax->tax_name); ?> <?php echo e($tax->rate); ?>% <?php if(!$loop->last): ?> , <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></td>
                                    ...
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        ...
                                                        <td colspan="5" class="border-bottom-0">
                                                            rty
                                                                                            ...
                                                                                            <table class="inv-note" width="100%">
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td width="100%"></td>
                                                                                                    <td><img src="<?php if($Quotes): ?><?php echo e($Quotes->signature); ?> <?php endif; ?>"  class="mt-2 mb-2" height="70" width="15%"></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td>Note</td>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td style="vertical-align: text-top">
                                                                                                        <p class="text-dark-grey"><?php if($Quotes): ?><?php echo e($Quotes->subject); ?> <?php endif; ?> </p>
                                                                                                    </td>
                                                ...
                                                <!-- Page JS -->
                                                <script src="<?php echo e(url('public/assets/js/offcanvas-add-payment.js')); ?>"></script>
                                                <script src="<?php echo e(url('public/assets/js/offcanvas-send-invoice.js')); ?>"></script>
                                            </body>
                                            </html>



<?php /**PATH /home/insighthub/public_html/resources/views/Employee/sales/Quotes/downloadView.blade.php ENDPATH**/ ?>