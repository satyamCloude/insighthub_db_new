...
">        <p class="mb-0 text-lg-right text-md-right f-15 font-weight-bold text-dark-grey d-grid align-items-center text-end" style="padding-right:10px;">
        ...
        <!--<button type="button" class="btn-danger rounded f-15 ml-4" id="clockout" value="clockout" onclick="clock(<?php echo e(auth()->id()); ?>,value)"-->
        ...
        <!--  <i class="fa-solid fa-right-to-bracket p-1"></i><span style="font-size: 17px;">Clock Out</span>-->
        <!--</button>-->
        <!--<button type="button" class="btn-primary rounded f-15 ml-4" id="clockin" value="clockin" onclick="clock(<?php echo e(auth()->id()); ?>,value)" -->
        <!--  style="background-color: #7f7c8b;border: 0;color: #fff;padding: 9px 11px 20px;position: relative;text-transform: capitalize;display: flex;padding-top:20px;display: none;">-->
        <!--  <i class="fa-solid fa-right-to-bracket p-1"></i><span style="font-size: 17px;">Clock In</span>-->
        <!--</button>-->
      </div>
      ...
      <div class="col-xl-8 mb-4 col-lg-6 col-12">
         ...
         <!--            <h5 class="card-title mb-0">Welcome <?php echo e(Auth::user()->first_name); ?> -->
         <!--               ! 🎉</h5>-->
         <!--            <?php if($previousYearBestSellerEmployee &&  $previousYearBestSellerEmployee->id == Auth::user()->id): ?> <p class="mb-2">Congratulations, You are the Best seller of the month</p><?php endif; ?>-->
         <!--            <h4 class="text-primary mb-1"><?php echo e($currentMonthEmpPrice); ?></h4>-->
                  ...
                  <div class="row">
                    ...
                    <div class="col-6">
                      ...
                      <ul class="list-unstyled mb-0">
                        ...
                        <li class="d-flex mb-4 align-items-center">
   <?php if($averageResponseTime && $averageResponseTime != 'N/A'): ?>
                             <p class="mb-0 fw-medium me-2 website-analytics-text-bg" id="open_task"
               ...
               <div class="row gy-3">
                  <div class="col-md-6 col-6 mb-4">
                     <div class="d-flex align-items-center">
                        ...
                        <div class="card-info">
                           <h5 class="mb-0"><?php echo e($totalTicket); ?></h5>
                  ...
                  <div class="col-md-6 col-6">
                     <div class="d-flex align-items-center">
                        ...
                        <div class="card-info">
                           <h5 class="mb-0"><?php echo e($pendingTicket); ?></h5>
                  ...
                  <div class="col-md-6 col-6">
                     <div class="d-flex align-items-center">
                        ...
                        <div class="card-info">
                           <h5 class="mb-0"><?php echo e($todayTicket); ?></h5>
                           <small>Sales</small>
                        </div>
                     </div>
                  </div>
...
<h5 class="mb-0"><?php echo e($default_currency->prefix); ?> <?php echo e($formattedStaRevenue); ?></h5>
<small>Revenue</small>
                        </div>
                     </div>
                  </div>
...
<div class="col-md-6 col-xl-4 mb-4" style="height: 400px;">
    <div class="card" style="height: 100%;">
                  ...
                  <div class="card-body">
                     <div class="table-responsive text-nowrap">
                        <table class="table table-sm">
                           ...
                           <tbody class="table-border-bottom-0">
                              <?php $__currentLoopData = $project; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                
                              <tr class="odd">
                                 <td><?php echo e($user->project_name); ?></td>
                                 <td><?php echo e($user->start_date); ?></td>
                                 <td><?php echo e($user->deadline); ?></td>
                                 <td><?php switch($user->status_id):
                                    case ('1'): ?>
     ...
     <!--/ Popular Product -->
      ...
      <!--/ Sales by Countries tabs -->
      <!-- Transactions -->
       <div class="col-xl-8 col-md-6 mb-4"  style="height:500px">
...
function updateClockButtons(clockStatus) {
 ...
 // Get and format working hours
    ...
    $('#ShiftHours').text(formatTotalTime(WorkingHoursInSeconds) || '00:00');
        ...
        const joinedEmployees = <?php echo json_encode($joinedEmployees, 15, 512) ?>;
        const resignedEmployees = <?php echo json_encode($resignedEmployees, 15, 512) ?>;
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/insighthub_db/resources/views/Employee/dashDepartmentType/Support.blade.php ENDPATH**/ ?>