   ...
   <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
      ...
      <div class="nav-item dropdown-style-switcher dropdown me-2 me-xl-0 relative text-indigo-600 transition duration-300 group-hover:text-white ease">
         ...
         <ul class="dropdown-menu dropdown-menu-end dropdown-styles" style="overflow:auto;height:88vh;">
            ...
            <li>
               <a class="dropdown-item product-link" href="<?php echo e(url('user/get-related-data/'.$product->id)); ?>" data-product-id="<?php echo e($product->id); ?>">
               <span class="align-middle"> <?php echo $product->faIcon; ?> <?php echo e($product->category_name); ?></span>
               </a>
            </li>
      ...
      <ul class="navbar-nav flex-row align-items-center ms-auto" style="display:flex;">
         ...
         <li class="nav-item me-2 me-xl-0 ">
            <a class="nav-link  right2" href="<?php echo e(url('user/order/cart')); ?>" >
            ...
            <div class="dropdown-menu dropdown-menu-end py-0 right2">
               ...
               <div class="dropdown-menu-header border-bottom">
                  <div class="dropdown-header d-flex align-items-center py-3">
                     <a href="<?php echo e(url('user/ticket/create')); ?>"
               ...
               <div class="dropdown-shortcuts-list scrollable-container">
                  <div class="row row-bordered overflow-visible g-0">
                     <?php if(auth()->check() && auth()->user()->type == '4' && $employeeDetails->department_id == 5): ?>
                     <div class="dropdown-shortcuts-item col">
                        <span class="dropdown-shortcuts-icon rounded-circle mb-2">
                        <i class="ti ti-users fs-4"></i>
                        </span>
                        <a href="<?php echo e(url('Employee/Leads/home')); ?>" class="stretched-link">Leads</a>
                     </div>
                     <?php else: ?>
                     <div class="dropdown-shortcuts-item col">
                        <span class="dropdown-shortcuts-icon rounded-circle mb-2">
                        ...
                        <a href="<?php echo e(url('admin/Calendar/home')); ?>" class="stretched-link">Calendar</a>
                        <?php elseif(auth::user()->type == '2'): ?>
                        <a href="<?php echo e(url('user/Calendar/home')); ?>" class="stretched-link">Calendar</a>
                        <?php elseif(auth::user()->type == '4'): ?>
                        <a href="<?php echo e(url('Employee/Calendar/home')); ?>" class="stretched-link">Calendar</a>
                        <?php endif; ?>
                        <!-- <small class="text-muted mb-0">Appointments</small> -->
                     </div>
                     <?php endif; ?>
                     <?php if(auth()->check() && auth()->user()->type == '4' && $employeeDetails->department_id == 4): ?>
                     <div class="dropdown-shortcuts-item col">
                        <span class="dropdown-shortcuts-icon rounded-circle mb-2">
                        <i class="ti ti-users fs-4"></i>
                        </span>
                        <a href="<?php echo e(url('Employee/Employee/home')); ?>" class="stretched-link">Employee</a>
                     </div>
                     <?php elseif(auth()->check() && auth()->user()->type == '4' && ($employeeDetails->department_id == 2 || $employeeDetails->department_id == 1)): ?>
                     <div class="dropdown-shortcuts-item col">
                        <span class="dropdown-shortcuts-icon rounded-circle mb-2">
                        <i class="ti ti-clock fs-4"></i>
                        </span>
                        <a href="<?php echo e(url('Employee/TimeSheet/home')); ?>" class="stretched-link">TimeSheet</a>
                        <!-- <small class="text-muted mb-0">Management</small> -->
                     </div>
                     <?php elseif(auth()->check() && auth()->user()->type == '4' && $employeeDetails->department_id == 3): ?>
                     <div class="dropdown-shortcuts-item col">
                        <span class="dropdown-shortcuts-icon rounded-circle mb-2">
                        <i class="ti ti-file-invoice fs-4"></i>
                        </span>
                        <a href="<?php echo e(url('Employee/Invoices/home')); ?>" class="stretched-link">Invoices</a>
                     </div>
                     <?php elseif(auth()->check() && auth()->user()->type == '4' && $employeeDetails->department_id == 5): ?>
                     <div class="dropdown-shortcuts-item col">
                        <span class="dropdown-shortcuts-icon rounded-circle mb-2">
                        <i class="ti ti-file-invoice fs-4"></i>
                        </span>
                        <a href="<?php echo e(url('Employee/Project/home')); ?>" class="stretched-link">Project</a>
                     </div>
                     <?php else: ?>
                     <div class="dropdown-shortcuts-item col">
                        <span class="dropdown-shortcuts-icon rounded-circle mb-2">
                        ...
                        <?php if(auth()->check()): ?>
                        <?php if(auth()->user()->type == '1'): ?>
                        <a href="<?php echo e(url('admin/Invoices/home')); ?>" class="stretched-link">Invoices</a>
                        <?php elseif(auth()->user()->type == '2'): ?>
                        <a href="<?php echo e(url('user/Invoices/home')); ?>" class="stretched-link">Invoices</a>
                        <?php elseif(auth()->user()->type == '4'): ?>
                        <a href="<?php echo e(url('Employee/Invoices/home')); ?>" class="stretched-link">Invoice</a>
                        <?php endif; ?>
                        <?php endif; ?>
                     </div>
                     <?php endif; ?>
                  ...
                  <div class="row row-bordered overflow-visible g-0">
                     <?php if(auth()->check() && auth()->user()->type == '4' && ($employeeDetails->department_id == 4 || $employeeDetails->department_id == 3)): ?>
                     <div class="dropdown-shortcuts-item col">
                        <span class="dropdown-shortcuts-icon rounded-circle mb-2">
                        <i class="ti ti-users fs-4"></i>
                        </span>
                        <a href="<?php echo e(url('Employee/PayRoll/home')); ?>" class="stretched-link">Payroll</a>
                        <!-- <small class="text-muted mb-0">Management</small> -->
                     </div>
                     <?php elseif(auth()->check() && auth()->user()->type == '4' && ($employeeDetails->department_id == 2 || $employeeDetails->department_id == 1)): ?>
                     <div class="dropdown-shortcuts-item col">
                        ...
                        <a href="<?php echo e(url('Employee/Performance/home')); ?>" class="stretched-link">Performance </a>
                     </div>
                     <?php elseif(auth()->check() && auth()->user()->type == '4' && $employeeDetails->department_id == 5): ?>
                     <div class="dropdown-shortcuts-item col">
                        <span class="dropdown-shortcuts-icon rounded-circle mb-2">
                        ...
                        <a href="<?php echo e(url('Employee/Task/home')); ?>" class="stretched-link">Task </a>
                     </div>
                     <?php else: ?>
                     <div class="dropdown-shortcuts-item col">
                        <span class="dropdown-shortcuts-icon rounded-circle mb-2">
                        ...
                        <?php if(auth::user()->type == '1'): ?>
                        <a href="<?php echo e(url('admin/Client/home')); ?>" class="stretched-link">Time Tracker</a>
                        <?php elseif(auth::user()->type == '2'): ?>
                        <a href="javascript:void(0);" class="stretched-link">Time Tracker</a>
                        <?php elseif(auth::user()->type == '4'): ?>
                        <a href="<?php echo e(url('Employee/Client/home')); ?>" class="stretched-link">Time Tracker</a>
                        <?php endif; ?>
                     </div>
                     <?php endif; ?>
                     <?php if(auth()->check() && auth()->user()->type == '4' && $employeeDetails->department_id == 4): ?>
                     <div class="dropdown-shortcuts-item col">
                        ...
                        <a href="<?php echo e(url('Employee/Attendence/home')); ?>" class="stretched-link">Attendance</a>
                     </div>
                     <?php elseif(auth()->check() && auth()->user()->type == '4' && ($employeeDetails->department_id == 2 || $employeeDetails->department_id == 1)): ?>
                     <div class="dropdown-shortcuts-item col">
                        <span class="dropdown-shortcuts-icon rounded-circle mb-2">
                        ...
                        <a href="<?php echo e(url('Employee/Attendence/home')); ?>" class="stretched-link">KRA</a>
                     </div>
                     <?php elseif(auth()->check() && auth()->user()->type == '4' && ($employeeDetails->department_id == 3 || $employeeDetails->department_id == 5)): ?>
                     <div class="dropdown-shortcuts-item col">
                        <span class="dropdown-shortcuts-icon rounded-circle mb-2">
                        <i class="ti ti-lock fs-4"></i>
                        </span>
                        <a href="<?php echo e(url('Employee/Ticket/home')); ?>" class="stretched-link">Ticket</a>
                     </div>
                     <?php else: ?>
                     <div class="dropdown-shortcuts-item col">
                        <span class="dropdown-shortcuts-icon rounded-circle mb-2">
                        ...
                        <?php if(auth::user()->type == '1'): ?>
                        <a href="<?php echo e(url('admin/Settings/home?type=Role')); ?>" class="stretched-link">Role Management</a>
                        <?php elseif(auth::user()->type == '2'): ?>
                        <a href="javascript:void(0);" class="stretched-link">Role Management</a>
                        <?php elseif(auth::user()->type == '4'): ?>
                        <a href="<?php echo e(url('Employee/Role/home')); ?>" class="stretched-link">Role Management</a>
                        <?php endif; ?>
                  ...
                  <div class="row row-bordered overflow-visible g-0">
                     <?php if(auth()->check() && auth()->user()->type == '4' && ($employeeDetails->department_id == 4 || $employeeDetails->department_id == 2 || $employeeDetails->department_id == 1 || $employeeDetails->department_id == 3)): ?>
                     <div class="dropdown-shortcuts-item col">
                        <span class="dropdown-shortcuts-icon rounded-circle mb-2">
                        <i class="ti ti-lock fs-4"></i>
                        </span>
                        <a href="<?php echo e(url('Employee/Leave/home')); ?>" class="stretched-link">Leaves</a>
                        <!-- <small class="text-muted mb-0">Management</small> -->
                     </div>
                     <?php elseif(auth()->check() && auth()->user()->type == '4' && $employeeDetails->department_id == 5): ?>
                     <div class="dropdown-shortcuts-item col">
                        ...
                        <a href="<?php echo e(url('Employee/Inventory/home')); ?>" class="stretched-link">Inventory</a>
                     </div>
                     <?php else: ?>
                     <div class="dropdown-shortcuts-item col">
                        <span class="dropdown-shortcuts-icon rounded-circle mb-2">
                        ...
                        <?php if(auth::user()->type == '1'): ?>
                        <a href="<?php echo e(url('admin/dashboard')); ?>" class="stretched-link">Dashboard</a>
                        <?php elseif(auth::user()->type == '2'): ?>
                        <a href="<?php echo e(url('user/dashboard')); ?>" class="stretched-link">Dashboard</a>
                        <?php elseif(auth::user()->type == '4'): ?>
                        <a href="<?php echo e(url('Employee/dashboard')); ?>" class="stretched-link">Dashboard</a>
                        <?php endif; ?>
                        <small class="text-muted mb-0">User Profile</small>
                     </div>
                     <?php endif; ?>
                     <?php if(auth()->check() && auth()->user()->type == '4' && ($employeeDetails->department_id != 4 && $employeeDetails->department_id != 2  && $employeeDetails->department_id != 1 && $employeeDetails->department_id != 3 && $employeeDetails->department_id != 5)): ?>
                     <div class="dropdown-shortcuts-item col">
                        <span class="dropdown-shortcuts-icon rounded-circle mb-2">
                        <i class="ti ti-settings fs-4"></i>
                        </span>
                        <?php if(auth::user()->type == '1'): ?>
                        <a href="<?php echo e(url('admin/MyProfile')); ?>" class="stretched-link">Setting</a>
                        <?php elseif(auth::user()->type == '2'): ?>
                        <a href="<?php echo e(url('user/MyProfile')); ?>" class="stretched-link">Setting</a>
                        <?php elseif(auth::user()->type == '4'): ?>
                        <a href="<?php echo e(url('Employee/MyProfile')); ?>" class="stretched-link">Setting</a>
                        <?php endif; ?>
                        <small class="text-muted mb-0">Account Settings</small>
                     </div>
                     <?php elseif(auth()->check() && auth()->user()->type != '4'): ?>
                     <div class="dropdown-shortcuts-item col">
                        <span class="dropdown-shortcuts-icon rounded-circle mb-2">
                        <i class="ti ti-settings fs-4"></i>
                        </span>
         ...
         <li class="nav-item dropdown-notifications navbar-dropdown dropdown me-3 me-xl-1 right1">
            ...
            <span class="badge bg-danger rounded-pill badge-notifications"><?php echo e($countNoti); ?></span>
            </a>
            <?php endif; ?>
            <ul class="dropdown-menu dropdown-menu-end py-0 right2" style="width: 100%;">
               ...
               ?>
               <li class="dropdown-notifications-list scrollable-container" onClick="updateStatus(<?php echo e($noti->id); ?>)">
                     ...
                     <li class="list-group-item list-group-item-action dropdown-notifications-item">
                        <div class="d-flex">
                           <div class="flex-shrink-0 me-3">
                              <div class="avatar">
                                 <?php if(Auth::user()->type == 4): ?>
                                 <img src="<?php echo e(isset($userPhoto) ? $userPhoto->profile_img : url('public/images/21104.png')); ?>" alt class="h-auto rounded-circle" />
                                 <?php else: ?>
                                 <img src="<?php echo e(url('public/logo/company.png')); ?>" alt class="h-auto rounded-circle" />
                                 <?php endif; ?>
                              </div>
                           </div>
                           <div class="flex-grow-1">
                              <h6 class="mb-1"><?php echo e($noti->subject); ?></h6>
                              <p class="mb-0"><?php echo $noti->message; ?></p>
                              <small class="text-muted"><?php echo e($days); ?> ago</small>
                           </div>
               ...
               <li class="dropdown-menu-footer border-top">
                  <?php if(auth::user()->type == '1'): ?>
                  <a href="<?php echo e(url('admin/notification/home')); ?>"
                  ...
                  <?php elseif(auth::user()->type == '2'): ?>
                  <a href="<?php echo e(url('user/notification/home')); ?>"   class="dropdown-item d-flex justify-content-center text-primary p-2 h-px-40 mb-1 align-items-center"> View all notifications
                  </a>
                  <?php elseif(auth::user()->type == '4'): ?>
                  <a href="<?php echo e(url('Employee/notification/home')); ?>"   class="dropdown-item d-flex justify-content-center text-primary p-2 h-px-40 mb-1 align-items-center"> View all notifications
                  </a>
                  <?php endif; ?>
               </li>
            </ul>
         ...
         <li class="nav-item navbar-dropdown dropdown-user dropdown">
            <a class="nav-link dropdown-toggle hide-arrow right2" href="javascript:void(0);" data-bs-toggle="dropdown">
               <div class="avatar avatar-online">
                  <img src="<?php echo e(Auth::user()->profile_img); ?>" alt class="rounded-circle" />
               </div>
            </a>
            <ul class="dropdown-menu dropdown-menu-end right2">
               <li>
                  ...
                  <div class="dropdown-item">
                     <div class="d-flex">
                        ...
                        <div class="flex-grow-1">
                           ...
                           <small class="text-muted"><?php if(Auth::user()->type == 1): ?> Admin <?php elseif(Auth::user()->type == 2): ?> Client <?php elseif(Auth::user()->type == 4): ?>  Employee <?php endif; ?></small>
                        </div>
                     </div>
                  </div>
                  <!-- </a> -->
               ...
               <li>
                  <?php if(Auth::user()->type == 1): ?>
                  <a class="dropdown-item" href="<?php echo e(url('admin/MyProfile')); ?>">
                  <i class="ti ti-user-check me-2 ti-sm"></i>
                  <span class="align-middle">My Profile</span>
                  </a>
                  <?php elseif(Auth::user()->type == 2): ?> 
                  <a class="dropdown-item" href="<?php echo e(url('user/MyProfile')); ?>">
                  <i class="ti ti-user-check me-2 ti-sm"></i>
                  <span class="align-middle">My Profile</span>
                  </a>
                  <?php elseif(Auth::user()->type == 4): ?>  
                  <a class="dropdown-item" href="<?php echo e(url('Employee/MyProfile')); ?>">
                  <i class="ti ti-user-check me-2 ti-sm"></i>
                  <span class="align-middle">My Profile</span>
                  </a>
                  <?php endif; ?>
               ...
               <li>
                  <a class="dropdown-item" href="<?php echo e(url('admin/Settings/home')); ?>">
               ...
               <li>
                  ...
                  <?php elseif(auth::user()->type == '4'): ?>
                  <a class="dropdown-item" href="<?php echo e(url('Employee/logout')); ?>">
                  <i class="ti ti-logout me-2 ti-sm"></i>
                  <span class="align-middle">Log Out</span>
                  </a>
                  <?php else: ?>
...
<form id="timerForm">
   ...
   <input type="hidden" id="urls" value="<?php echo e(Auth::user()->type); ?>">
</form>
...
<script>
   function strtTimer() {
    ...
    var stopTimerUrl = type == 1 ? "<?php echo e(url('admin/Task/StartTimer')); ?>" : "<?php echo e(url('Employee/Task/StartTimer')); ?>";
   ...
   $('.stptimerbtn').click(function() {
       ...
       var type = $('#urls').val();
       var stopTimerUrl = type == 1 ? "<?php echo e(url('admin/Task/StopTimer')); ?>" : "<?php echo e(url('Employee/Task/StopTimer')); ?>";
...
<script>
   ...
   //   $.ajax({
   //     url: "<?php echo e(url('admin/Task/checkStartTimer')); ?>",
   //     method: 'GET',
   //     success: function(resp) {
   ...
   //       if (selectedProject) {
   //         $.ajax({
   //           url: "<?php echo e(url('admin/Task/GetTask')); ?>",
   //           method: 'GET',
   //           data: {
   //             project_id: selectedProject,
   //           },
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/insighthub_db/resources/views/includes/navbar.blade.php ENDPATH**/ ?>