          ...
          <table class="dt-responsive table dataTable dtr-column" id="DataTables_Table_3" aria-describedby="DataTables_Table_3_info">
            ...
            <tbody id="result">
              ...
              <?php if(count($PayRoll) > 0): ?>
                <?php $__currentLoopData = $PayRoll; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                 <?php 
                ...
                <tr class="odd">
                    ...
                    <td><?php if($user && $user->deduction): ?> <?php echo e($user->deduction); ?> <?php endif; ?></td>
                </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              <!-- <tr style="background: aliceblue;">
                  <td></td>
                  <td><strong>Total</strong></td>
                  <td><strong><?php echo e($totaldeduction); ?></strong></td>
              </tr> -->
              <?php else: ?>
              <tr>
...
<script>
    $(document).ready(function () {
        ...
        function fetchData() {
            ...
            $.ajax({
                url: "<?php echo e(url('admin/PayRoll/get_deductionData')); ?>",
                method: 'GET',
...
</script><?php /**PATH /home/insighthub/public_html/resources/views/admin/Humanesources/PayRoll/Deduction.blade.php ENDPATH**/ ?>