<?php $AppSetting =  \App\Models\AppSetting::select('CompanyLogo','welcometextEmployee','CompanyBannerEmployee')->where('id','1')->first() ?>
<!DOCTYPE html>
...
<html
  ...
  <head>
    ...
    <style>
      .auth-cover-bg{
        background-image: url('<?php echo e($AppSetting->CompanyBannerEmployee); ?>');
          ...
          <div class="w-px-400 mx-auto">
            ...
            <!-- Logo -->
              <div class="app-brand justify-content-center mb-4 mt-2">
                <a href="<?php echo e(url('/Employee')); ?>" class="app-brand-link">
                  <img width="100%" src="<?php echo e($AppSetting->CompanyLogo); ?>">
                </a>
              </div>
              <!-- /Logo -->
              <span class="mb-4" id="welcometext"><?php echo $AppSetting->welcometextEmployee; ?></span>
    ...
    $(document).ready(function(){
        ...
        $('#welcometext').on('selectstart', function(e) {
            e.preventDefault();
              ...
              <?php endif; ?>
               <form id="formAuthentication" class="mb-3" action="<?php echo e(url('employee_Login')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="mb-3">
...
</html><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/insighthub_db/resources/views/auth/employee_login.blade.php ENDPATH**/ ?>