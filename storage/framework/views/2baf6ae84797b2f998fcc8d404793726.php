...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="bs-stepper vertical mt-2 linear">
      <div class="bs-stepper-header">
        <div class="step <?php if(Session::get('TabViews')== 'App'): ?> active <?php endif; ?>">
        ...
        <div class="line"></div>
        <div class="step <?php if(Session::get('TabViews')== 'Currency'): ?> active <?php endif; ?>">
        ...
        <div class="line"></div>
        <div class="step <?php if(Session::get('TabViews')== 'Company'): ?> active <?php endif; ?>">
        ...
        <!-- <div class="line"></div> -->
       <!--  <div class="step <?php if(Session::get('TabViews')== 'CustomLink'): ?> active <?php endif; ?>">
      ...
      <!--   <div class="line"></div>
        ...
        <!-- <div class="line"></div>
        <div class="step">
          <button type="button" class="step-trigger" onclick="Tab(value)" value="Hosting-Panel">
            <span class="bs-stepper-circle"><i class="fas fa-user-tag"></i></span>
            <span class="bs-stepper-label">
              <span class="bs-stepper-title">Hosting Panel</span>
              <span class="bs-stepper-subtitle">Settings</span>
            </span>
          </button>
        </div>  -->
        <div class="line"></div>
        <div class="step">
          <button type="button" class="step-trigger" onclick="Tab(value)" value="operatingsystem">
        ...
        <div class="line"></div> 
         <div class="step">
          <button type="button" class="step-trigger" onclick="Tab(value)" value="Template">
            <span class="bs-stepper-circle"><i class="fas fa-ticket-alt"></i></span>
            <span class="bs-stepper-label">
...
<script type="text/javascript">
  function Tab(value) {
    ...
    $.ajax({
        url: "<?php echo e(url('admin/Settings/TabView')); ?>",
        method: 'GET',
        data: { type: value },
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/insighthub/public_html/resources/views/admin/settings/index.blade.php ENDPATH**/ ?>