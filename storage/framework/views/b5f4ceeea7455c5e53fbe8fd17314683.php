<div class="row g-4 mb-4">
    ...
    <a class="text-dark" href="#">
      <div class="card">
        <div class="card-body">
          <div class="row">
          <div class="col-sm-3">
               <img class="img-fluid" src="<?php echo e($Profile->profile_img); ?>" width="115" alt="Avatar" style="height:154px; width: 136px;">
          </div>
          <div class="col-sm-9" style="margin-top: 13px;">
                <h3 style="color: #000; font-size: 18px; line-height: 7px"><?php echo e($Profile->first_name); ?></h3>
                <p style=" margin-top: 0px; line-height: 7px"><?php echo e($Profile->name); ?></p>
                <p style="font-size: 11px; margin-top: 0px; line-height: 7px">Last login at -- <?php echo e($Profile->updated_at); ?></p>
                <p style="font-size: 11px; margin-top: 0px; line-height: 7px">Team Lead : <?php if($Profile->team_lead == 1): ?> Yes <?php else: ?> No <?php endif; ?></p>
                <hr>
                <div class="d-flex flex-wrap justify-content-between">
                    <span>
                      <label>Open Tasks</label>
                      <p style="color: #000;"><?php echo e($OpenTask); ?></p>
                    </span>
                    <span>
                      <label>Projects</label>
                      <p style="color: #000;"><?php echo e($Projects); ?></p>
                    </span>
                    <span>
                    ...
                    <span>
                      <label>Tickets</label>
                      <p style="color: #000;"><?php echo e($Tickets); ?></p>
                    </span>
                </div>
          </div>
        </div>
       ...
       <div class="card-body ">
          <div class="d-flex justify-content-between">
             <div class="col-6">
               ...
               <?php if($ReportingTo && $ReportingTo->first_name): ?>  <?php echo e($ReportingTo->first_name); ?> <?php else: ?> -- <?php endif; ?>
             </div>
             <div class="col-6">
                <p class="f-14 text-dark-grey" style="color:#000">Reporting Team</p>
                 <?php echo e($ReportingTeam->name); ?>
  ...
  <div class="col-md-3">
    ...
    <div class="card bg-white border-0 b-shadow-4">
       ...
       <div class="row">
        ...
        <div class="col-sm-8">
          <h6 class="ms-"><?php echo e($Profile->marriage_anniversary); ?></h6>
        </div>
        <div class="col-sm-4">
          <h5 class="text-dark small">Date of Birth</h5>
        </div>
        <div class="col-sm-8">
          <h6 class="ms-"><?php echo e($Profile->dob); ?></h6>
        </div>
        <div class="col-sm-4">
        ...
        <div class="col-sm-8">
          <h6 class="ms-"><?php echo e($Profile->uaddrss); ?></h6>
        </div>
       </div>
  ...
  <?php /**PATH /home/insighthub/public_html/resources/views/Employee/MyProfile/Profile.blade.php ENDPATH**/ ?>