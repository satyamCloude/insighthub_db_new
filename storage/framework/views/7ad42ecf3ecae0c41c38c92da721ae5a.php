      ...
      <div class="card">
         <div class="card-header sticky-element bg-label-secondary d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row">
            ...
            <div class="action-btns">
               <a href="<?php echo e(url('admin/Quotes/home')); ?>" class="btn btn-label-primary me-3">
               <span class="align-middle"> Back</span>
               </a>
            </div>
         </div>
         <form action="<?php echo e(url('admin/Quotes/update/'.$Quotes->id)); ?>" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="card-body">
               <div class="row mb-4">
                  <div class="col-md-2">
               ...
               <div class="row mb-4">
                  <div class="col-md-6">
                     ...
                     <input type="text" class="form-control" id="first_name" <?php if($Quotes && $Quotes->first_name): ?> value="<?php echo e($Quotes->first_name); ?>" <?php endif; ?> name="first_name" placeholder="ABC"/>
                  </div>
                  <div class="col-md-6">
                     <label for="last_name" class="form-label">Last name <span class="text-danger">*</span></label>
                     <input type="text" class="form-control" id="last_name" <?php if($Quotes && $Quotes->last_name): ?> value="<?php echo e($Quotes->last_name); ?>" <?php endif; ?> name="last_name" placeholder="+ABC"/>
                  </div>
               </div>
               <div class="row mb-4">
                  <div class="col-md-6">
                     <label for="email" class="form-label">Email address <span class="text-danger">*</span></label>
                     <input type="email" class="form-control"  id="email"  <?php if($Quotes && $Quotes->email): ?> value="<?php echo e($Quotes->email); ?>" <?php endif; ?> name="email" placeholder="name@example.com"/>
                  </div>
                  <div class="col-md-6">
                     <label for="phone_number" class="form-label">Contact No <span class="text-danger">*</span></label>
                     <input type="number" class="form-control"  id="phone_number" <?php if($Quotes && $Quotes->phone_number): ?> value="<?php echo e($Quotes->phone_number); ?>" <?php endif; ?> name="phone_number" placeholder="+1234156789"/>
                  </div>
               </div>
               <div class="row mb-4">
                  <div class="col-md-6">
                     <label for="company_id" class="form-label">Company Name <span class="text-danger">*</span></label>
                     <input type="text" class="form-control"  id="company_id" name="company_id" <?php if($Quotes && $Quotes->company_id): ?> value="<?php echo e($Quotes->company_id); ?>" <?php endif; ?> placeholder="company name" required/>
                  </div>
                  <div class="col-md-6 customer_name">
                     <label for="customer_name" class="form-label">Customer Name <span class="text-danger">*</span></label> <br>
                     <div class="dropdown">
                        <?php
                        ...
                        $id = $client->id ?? '';
                        ?>
                        <button  type="button" class="dropbtn" id="selected_customer_btn"><?php echo e($first_name); ?> <?php echo e($last_name); ?>(<?php echo e($id); ?>)<i class="fa fa-angle-down" style="font-size:24px"></i></button>
                        <div class="dropdown-content" style="max-height: 40vh;overflow: auto;z-index: 10;">
                     ...
                     <input type="hidden" name="customer_name" id="customer_name" value="<?php echo e($id); ?>">
                     <!--  <div class="col-md-6">
                        <label for="customer_name" class="form-label">Customer Name <span class="text-danger">*</span></label>
                        <select name="customer_name" class="form-control select2">
                              <option value="">Select Customer</option>
                              <?php $__currentLoopData = $vendor; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vendors): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <option <?php if($Quotes && $Quotes->customer_name == $vendors->id): ?> selected <?php endif; ?> value="<?php echo e($vendors->id); ?>"><?php echo e($vendors->first_name); ?></option>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                        </div> -->
                  </div>
               ...
               <div class="row mb-4">
                  <div class="col-md-12">
                     ...
                     <input type="text" class="form-control" <?php if($Quotes && $Quotes->subject): ?> value="<?php echo e($Quotes->subject); ?>" <?php endif; ?> name="subject" placeholder="Demo "/>
                  </div>
                  <!--  <div class="col-md-6">
               ...
               <div class="row mb-4 mt-4 mb-3">
                  <div class="col-md-6">
                     ...
                     <input type="date" class="form-control" <?php if($Quotes && $Quotes->date_created): ?> value="<?php echo e($Quotes->date_created); ?>" <?php endif; ?> name="date_created" placeholder="Demo "/>
                  </div>
                  <div class="col-md-6 mb-3">
                     <label for="date_created" class="form-label">Valid Until <span class="text-danger">*</span></label>
                     <input type="date" class="form-control" <?php if($Quotes && $Quotes->valid_until): ?> value="<?php echo e($Quotes->valid_until); ?>" <?php endif; ?> name="valid_until" placeholder="Demo "/>
                  </div>
                  <!--  <div class="col-md-6 mt-4">
                     ...
                     <div class="input-group">
                       ...
                       <input type="text" name="invoice_number1" id="invoice_number1" value="INV#" class="form-control height-35 f-15" >
                       </div>
                  ...
                  <div class="row d-flex justify-content-between">
                     ...
                     <div class="col-md-2">
                        ...
                        <span class="align-middle">Existing Product</span>
                        </button>
                     </div>
                  </div>

                  <?php $__currentLoopData = $QuotesCal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $Quot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <div class="row newa<?php echo e($key+1); ?> mb-4">
                     <div class="col-md-3">
                        <label for="description" class="form-label">Description <span class="text-danger">*</span></label>
                        <textarea class="form-control" id="description" name="description[]" placeholder="...."  rows="1"><?php if($Quot && $Quot->description): ?> <?php echo e($Quot->description); ?> <?php endif; ?> </textarea>
                     </div>
                     <div class="col-md-2">
                        <label for="qty" class="form-label">Qty <span class="text-danger">*</span></label>
                        <input type="number" class="form-control qty" <?php if($Quot && $Quot->qty): ?> value="<?php echo e($Quot->qty); ?>" <?php endif; ?> name="qty[]" placeholder="01"/>
                     </div>
                     <div class="col-md-2">
                        <label for="unit_price" class="form-label">Unit Price <span class="text-danger">*</span></label>
                        <input type="number"  class="form-control unit_price" <?php if($Quot && $Quot->unit_price): ?> value="<?php echo e($Quot->unit_price); ?>" <?php endif; ?> id="unit_price" name="unit_price[]"  placeholder="01"/>
                     </div>
                     <div class="col-md-2">
                        <label for="discount" class="form-label">Discount% <span class="text-danger">*</span></label>
                        <input type="number"  class="form-control discount" <?php if($Quot && $Quot->discount): ?> value="<?php echo e($Quot->discount); ?>" <?php endif; ?> name="discount[]" placeholder="01"/>
                     </div>
                     <div class="col-md-1">
                        <label for="total" class="form-label">Tax% <span class="text-danger">*</span></label>
                        <input type="number" class="form-control taxs" name="tax_rate[]"  <?php if($Quot && $Quot->tax_rate): ?> value="<?php echo e($Quot->tax_rate); ?>" <?php endif; ?>  id="unit_tax" placeholder="0"  required/>
                        <input type="hidden" name="tax[]" id="unit_tax_id"  <?php if($Quot && $Quot->tax): ?> value="<?php echo e($Quot->tax); ?>" <?php endif; ?>  class="form-control tax"  >
                     </div>
                     <div class="col-md-2">
                        <label for="total" class="form-label">Total <span class="text-danger">*</span></label>
                        <input type="number"  class="form-control total" <?php if($Quot && $Quot->total): ?> value="<?php echo e($Quot->total); ?>" <?php endif; ?>  name="total[]" placeholder="01" step="0.01"/>
                     </div>
                     <input type="hidden" id="Products_id1" <?php if($Quot && $Quot->Products_id): ?> value="<?php echo e($Quot->Products_id); ?>" <?php endif; ?> name="Products_id[]">
                     <input type="hidden" id="BillingCycle1" <?php if($Quot && $Quot->BillingCycle): ?> value="<?php echo e($Quot->BillingCycle); ?>" <?php endif; ?> name="BillingCycle[]">
                     <input type="hidden" id="Caltax" <?php if($Quot && $Quot->BillingCycle): ?> value="<?php echo e($Quot->Caltax); ?>" <?php endif; ?> name="Caltax[]">
               ...
               <div class="card-footer">
                  <div class="row mb-4">
                     <div class="col-md-6 text-end" >
                        <a href="<?php echo e(url('admin/Quotes/home')); ?>" type="button" class="btn btn-outline-danger">Discard</a>
                     </div>
                     <div class="col-md-6">
   ...
   <div class="modal-dialog modal-xl">
      <form class="modal-content">
         ...
         <div class="modal-body">
            <div class="row mb-4">
               <div class="col mb-3">
                  ...
                  <select name="category_id" class="form-control select2" id="category_id" required>
                     ...
                     <?php $__currentLoopData = $Category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Prod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                     <option value="<?php echo e($Prod->id); ?>" data-name="<?php echo e($Prod->product_name); ?>"><?php echo e($Prod->product_name); ?></option>
                     <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </select>
               </div>
               <div class="col mb-3">
            ...
            <div class="row mb-4 addones" style="display:none">
               <div class="col mb-3">
            ...
            <div class="row mb-4">
               <div class="col mb-3">
                  ...
                  <input type="number" id="mod_price_unit" class="form-control mod_price_unit" name="mod_price_unit"  placeholder="Price Unit">
               </div>
               <div class="col mb-3">
                  ...
                  <select  name="taxes[]" id="mod_tax" multiple class="form-control select2">
                     ...
                     <option data-rate="<?php echo e($Taxs->rate); ?>" data-tax-text="<?php echo e($Taxs->tax_name . ':' . $Taxs->rate); ?>" value="<?php echo e($Taxs->id); ?>"><?php echo e($Taxs->tax_name . ':' . $Taxs->rate); ?></option>
                     <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </select>
               </div>
            </div>
...
<script>
  $(document).ready(function() {
    $('.select2').select2();
      $("#category_id").on("change", function(event) {
        ...
        $.ajax({
              url: "<?php echo e(url('admin/Quotes/get_categoryProduct')); ?>",
              method: 'GET',
  ...
  function mod_billing_cycles(value) {
      ...
      // alert(cycleid);
      $.ajax({
         url: "<?php echo e(url('admin/Quotes/get_productdata')); ?>",
         method: 'GET',
   ...
   function get_product_addon(value) {
      var productid = $('#productservices').val(); // Get the selected product ID
      $.ajax({
         url: "<?php echo e(url('admin/Quotes/get_product_addon')); ?>",
         method: 'GET',
   ...
   function addNewRow(mod_price_unit, mod_description, productservices, mod_billing_cycle, mod_tax, modTaxrate) {
    var newRow = 
    '<div class="row newa' + (modalCounter++) + ' mb-4">' +
        '<div class="col-md-3">' +
            '<label for="description" class="form-label">Description <span class="text-danger">*</span></label>' +
            '<textarea class="form-control"  name="description[]" placeholder="...." rows="1" required>'+mod_description+'</textarea>' +
        '</div>' +
        '<div class="col-md-2">' +
            '<label for="qty" class="form-label">Qty <span class="text-danger">*</span></label>' +
        ...
        '<div class="col-md-2">' +
            '<label for="unit_price" class="form-label">Unit Price <span class="text-danger">*</span></label>' +
            '<input type="number"  class="form-control unit_price" value="'+mod_price_unit+'" name="unit_price[]" placeholder="01" required/>' +
        '</div>' +
        '<div class="col-md-2">' +
            '<label for="discount" class="form-label">Discount% <span class="text-danger">*</span></label>' +
        ...
        '<div class="col-md-2">' +
            '<label for="total" class="form-label">Tax% <span class="text-danger">*</span></label>' +
            '<input type="number" class="form-control taxs" name="tax_rate[]" id="unit_tax" placeholder="0"  required value="' + modTaxrate + '">' +
            '<input type="hidden" id="unit_tax_id" class="form-control tax" name="tax[]"  value="' + mod_tax + '">' +
        '</div>' +
        '<div class="col-md-2">' +
            '<label for="total" class="form-label">Total <span class="text-danger">*</span></label>' +
            '<input type="number" class="form-control total" name="total[]" placeholder="01"  required step="0.01"/>' +
        '</div>' +
        '<div class="col-md-1">' +
            '<button type="button" class="btn btn-label-danger mt-4 waves-effect" onclick="removeFields(this)">' +
            '<i class="ti ti-x ti-xs"></i>' +
   ...
   $(".qty, .unit_price, .discount, .taxs").on('input', function () {
      // Parse input values or default to 0 if empty
      var qty = parseFloat($('.qty').val()) || 0;
      var price_unit = parseFloat($('.unit_price').val()) || 0;
      var discount = parseFloat($('.discount').val()) || 0;
      var unit_tax = parseFloat($('.taxs').val()) || 0;

      // Calculate subtotal (Qty x Unit Price)
      var subtotal = qty * price_unit;
      ...
      // Calculate tax amount (Taxable Amount x Tax %)
      var taxAmount = taxableAmount * (unit_tax / 100);

      // Calculate final total (Taxable Amount + Tax)
      var totalWithTax = taxableAmount + taxAmount;
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/insighthub/public_html/resources/views/admin/sales/Quotes/edit.blade.php ENDPATH**/ ?>