  ...
  <div class="card">
    <div class="row">
      ...
      <div class="col-md-6 text-end">
         <a href="<?php echo e(url('admin/Task/EXPORTCSV')); ?>" class="btn btn-info mt-3 m-3"><i class="fa-solid fa-file-csv"></i></a>
          <a href="<?php echo e(url('admin/Task/home')); ?>" class="btn btn-warning mt-3 m-3"><i class="fas fa-sync-alt"></i></a>
          <a href="<?php echo e(url('admin/Task/add')); ?>" class="btn btn-primary mt-3 m-3">Add</a>
      </div>
    </div>
...
//         $.ajax({
//             url: "<?php echo e(url('admin/Task/StartTimer')); ?>",
//             method: 'GET',
//             data: {
...
function updatepro(status,value,id){
  $.ajax({
        url: "<?php echo e(url('admin/Task/UpdateStatus')); ?>",
        method: 'GET',
        data: { id: id,
                status_pro: value, 
                status : status
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/insighthub/public_html/resources/views/admin/Task/home.blade.php ENDPATH**/ ?>