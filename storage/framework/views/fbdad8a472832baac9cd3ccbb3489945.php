      ...
      <div class="row">
         ...
         <div class="col-md-6 text-end">
            <form id="downloadPDFForm" method="POST">
               ...
               <a href="<?php echo e(url('admin/Quotes/home')); ?>" class="btn btn-warning mt-3 m-3"><i class="fas fa-sync-alt"></i></a>
               <a href="<?php echo e(url('admin/Quotes/add')); ?>" class="btn btn-primary mt-3 m-3">Add</a>
            </form>
         </div>
      </div>
                     ...
                     <tr class="odd">
                        ...
                        <td  >
                           <div class="d-flex">
                              ...
                              <img class="rounded-circle"  src="<?php echo e($user_data->profile_img); ?>" height="30" width="30" alt="User avatar" style="width:45px;border-radius:50%;height:auto;">
                              <?php else: ?>
                              ...
                              <?php endif; ?>
                              <div >                              
                                 <a href="<?php echo e(url('admin/Quotes/view/'.$user->id)); ?>">
                              ...
                              <?php if($user_data2): ?>
                              <img src="https://i.pinimg.com/564x/8b/16/7a/8b167af653c2399dd93b952a48740620.jpg" style="width:45px;border-radius:50%;height:auto;">
                              <a href="<?php echo e(url('admin/Quotes/view/'.$user->id)); ?>"><?php echo e($user_data2->first_name); ?> <?php echo e($user_data2->last_name); ?> (#<?php echo e($user_data2->client_id); ?>)</a>
                        ...
                        <td>
                           <div class="btn-group">
                              ...
                              <ul class="dropdown-menu dropdown-menu-end" style="">
                                 <!-- <li><a class="dropdown-item" href="<?php echo e(url('admin/Quotes/downloadPDF/'.$user->id)); ?>">Download</a></li> -->
                                  <?php if($user->status == '3'): ?>
                                    <li><a class="dropdown-item" href="<?php echo e(url('admin/Quotes/MakeQuotesInvoice/'.$user->id)); ?>">Make Invoice</a></li>
                                  <?php endif; ?>
                                 <li><a class="dropdown-item" href="<?php echo e(url('admin/Quotes/SendQuotes/'.$user->id)); ?>">Send</a></li>
                                 <li><a class="dropdown-item" href="<?php echo e(url('admin/Quotes/edit/'.$user->id)); ?>">Edit</a></li>
                              </ul>
                           </div>
                        </td>
                     </tr>
...
<script>
   ...
   function downloadPDF() {
       ...
       if (selectedIds.length > 0) {
           ...
           window.location.href = "<?php echo e(url('admin/Quotes/downloadPDF')); ?>?ids=" + selectedIds.join(',');
       } else {
   ...
   function submitForm() {
       ...
       form.action = "<?php echo e(url('admin/Quotes/downloadPDF')); ?>"; // Set action to download PDF route
       form.submit();
   }
</script>
<script>
   ...
   $.ajaxSetup({
       ...
       $.ajax({
         type: 'POST',
         url: "<?php echo e(url('admin/Quotes/changeQuotesStatus')); ?>",
         data: {
             userId: userId,
             status: status
         },
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/insighthub_db/resources/views/admin/sales/Quotes/home.blade.php ENDPATH**/ ?>