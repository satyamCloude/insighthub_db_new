  ...
  <div class="col-xl">
    <div class="card mb-4">
      <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <small class="text-muted float-end"><a href="<?php echo e(url('admin/Ticket/home')); ?>" class="btn btn-sm btn-primary">Back</a></small>
      </div>
      <div class="card-body">
 <?php if($errors->any()): ?>
      ...
      <?php endif; ?>
        ...
        <form id="ticketForm" method="post" action="<?php echo e(url('admin/Ticket/store')); ?>" enctype="multipart/form-data">
          <?php echo csrf_field(); ?>
        <div class="mb-3">
            ...
            <div class="input-group">
              ...
              <!-- <select class="form-control select2" name="client_id" id="clientid" onchange="Client(value)" >
                <?php $__currentLoopData = $Client; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Clie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($Clie->id); ?>"><?php echo e($Clie->first_name); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </select> -->
                <div class="dropdown">
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-3">
              ...
              <div class="dropdown" style="width:100%;">
                  ...
                  <div class="dropdown-content">
                    <?php $__currentLoopData = $CCID; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $CCID): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="outer" id="clients_<?php echo e($CCID->id); ?>" style="display:flex;margin:6px;padding:4px;color:black;" onclick="selectClient2(<?php echo e($CCID->id); ?>)">
                      <?php if($CCID->profile_img): ?><img src="<?php echo e($CCID->profile_img); ?>" style="width:45px;border-radius:50%;height:45px;">
                      <?php else: ?>
                      <img src="<?php echo e(url('public/images/emp_proa4NN.jpg')); ?>" style="width:45px;border-radius:50%;height:45px;">
                      <?php endif; ?>
                      <div class="sie_cont" style="display:flex;flex-direction:column;margin:5px;">
                        <span><?php echo e($CCID->first_name); ?> <?php echo e($CCID->last_name); ?> (#<?php echo e($CCID->id); ?>) <br/><?php echo e($CCID->jobrole); ?></span>
  ...
  function selectClient(id) {
   ...
   $('#selected_client_img').show();
    ...
    $('#client_' + id).addClass('selected');
      ...
      if (id) {
        $.ajax({
          url: "<?php echo e(url('admin/Ticket/ClientData')); ?>",
          type: 'GET',
          data: {
            'id': id,
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/insighthub_db/resources/views/admin/Ticket/create.blade.php ENDPATH**/ ?>