...
<!-- Users List Table -->
    <!--tabs-->
                <section class="emp_table">
                   ...
                   <button onclick="FollowUps(); "class="btn btn-primary mt-3 m-3 leadbtn">Followup's</button>
                    <?php if($RoleAccess[array_search('Leads', array_column($RoleAccess, 'per_name'))]['add'] == 1): ?>
                         <a href="<?php echo e(url('Employee/Leads/add')); ?>" class="btn btn-primary waves-effect waves-light"> Add</a>
                    <?php endif; ?>
                              <a href="<?php echo e(url('Employee/Leads/home')); ?>" class="btn btn-warning mt-3 m-3"><i class="fas fa-sync-alt"></i></a>
                              <!--<a href="<?php echo e(url('Employee/recent_follow_ups')); ?>" class="btn btn-primary mt-3 m-3">All Follow UPs</a>-->
                        </div>
                    </div>
    ...
    <div class="card-datatable table-responsive">
        ...
        <!--        <form id="downloadPDF" action="<?php echo e(url('Employee/Invoices/downloadPDF')); ?>">-->
        ...
        <!--            <a href="<?php echo e(url('Employee/Invoices/EXPORTCSV')); ?>" class="btn btn-info mt-3 m-3"><i class="fa-solid fa-file-csv"></i></a>-->
        <!--            <a href="<?php echo e(url('Employee/Invoices/home')); ?>" class="btn btn-warning mt-3 m-3"><i class="fas fa-sync-alt"></i></a>-->
        <!--            <a href="<?php echo e(url('Employee/Invoices/gst')); ?>" class="btn btn-primary mt-3 m-3">GST</a>-->
        <!--            <a href="<?php echo e(url('Employee/Invoices/tds')); ?>" class="btn btn-primary mt-3 m-3">TDS</a>-->
        <!--            <a href="<?php echo e(url('Employee/Invoices/add')); ?>" class="btn btn-primary mt-3 m-3">Add</a>-->
        <!--        </form>-->
        <!--    </div>-->
        <!--</div>-->
                ...
                <div class="dataTables_length" id="DataTables_Table_3_length">
                    ...
                    <div class="col-sm-12 col-md-4 d-flex justify-content-center justify-content-md-end">
                                            <div id="DataTables_Table_3_filter" class="dataTables_filter">
                                                <form method="GET" action="<?php echo e(url('Employee/Leads/home')); ?>">
                                                    <label>Search:
    ...
    <tbody id="result">
        ...
        <?php if(count($users) > 0): ?>
            ...
            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                    $leadStatus = DB::table('lead_statuses')->where('id', $user->status)->first();
                ?>
                <tr class="odd">
                            ...
                            <div class="parent d-flex">
                                   <div class="child1">
                                       <img 
                                        ...
                                        src="<?php echo e(isset($Emp->profile_img) ? $Emp->profile_img : url('public/images/21104.png')); ?>" 
                                        height="30" 
                                       width="30" 
                                        alt="User avatar" 
                                    />
...
<?php endif; ?>
                    ...
                    <td>
                        <div style="display:flex;align-items:center;">
                            ...
                            <span style="padding: 5px;border-radius: 4px;">
                                <?php if($leadStatus): ?>
                                    <?php echo e(ucfirst($leadStatus->lead_status)); ?>
                    ...
                    <td>                     <?php if(in_array('Leads', array_column($RoleAccess, 'per_name'))): ?>

              <div class="d-flex">
                                <?php if($RoleAccess[array_search('Leads', array_column($RoleAccess, 'per_name'))]['view'] == 1 || $RoleAccess[array_search('Leads', array_column($RoleAccess, 'per_name'))]['view'] == 2): ?>

                <a href="<?php echo e(url('Employee/Leads/view/'.$user->id)); ?>"><svg style="margin-left: 10px" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" font-size="1.375rem" class="iconify iconify--tabler" width="1em" height="1em" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><circle cx="12" cy="12" r="2"></circle><path d="M22 12c-2.667 4.667-6 7-10 7s-7.333-2.333-10-7c2.667-4.667 6-7 10-7s7.333 2.333 10 7"></path></g></svg></a>

<?php endif; ?>
                                <?php if($RoleAccess[array_search('Leads', array_column($RoleAccess, 'per_name'))]['delete'] == 1): ?>

                <a href="<?php echo e(url('Employee/Leads/delete/'.$user->id)); ?>" id="<?php echo e($user->id); ?>" class="delete_debtcase">
                    <svg style="margin-left: 10px" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" font-size="1.375rem" class="iconify iconify--tabler" width="1em" height="1em" viewBox="0 0 24 24">
                       ...
                       <?php endif; ?>
        <?php if($empDetl && $empDetl->department_id != 1): ?>
<a href="<?php echo e(url('Employee/Quotes/add/?id='.$user->id)); ?>">
...
<script>
    ...
    function LeadAssigned(id, value) {
        $.ajax({
            url: "<?php echo e(url('Employee/Leads/LeadAssignUpdate')); ?>",
            method: 'GET',
    ...
    $(document).ready(function () {
        ...
        function fetchData() {
            ...
            var selectedMonth = $selectMonth.val();
                  $.ajax({
                url: "<?php echo e(url('Employee/Leads/getleadsYearfilterdata')); ?>",
                method: 'GET',
            ...
            $.ajax({
                url: "<?php echo e(url('Employee/Leads/get_leads_yeardata')); ?>",
                method: 'GET',
                data: { year: selectedYear, month: selectedMonth },
    ...
    function Leads() {
        $.ajax({
            url: "<?php echo e(url('Employee/Leads/ShowLeads')); ?>",
            method: 'GET',
            success: function(data) {
                // Handle the successful response
    ...
    function FollowUps() {
        $.ajax({
            url: "<?php echo e(url('Employee/Leads/ShowFollowUps')); ?>",
            method: 'GET',
            success: function(data) {
                // Handle the successful response
                $('#newpayroll').empty(); // Clear previous content
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/insighthub/public_html/resources/views/Employee/sales/Leads/home.blade.php ENDPATH**/ ?>