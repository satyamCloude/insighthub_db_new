...
<div class="modal-dialog modal-lg" style="width:50%">
  <form class="modal-content" action="<?php echo e(url('Employee/MyProfile/update/')); ?>" method="post" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
                ...
                <div class="row mb-4"> 
                  <div class="col-md-6">
                        <div class="avatar-preview">
                           <img id="uploadedProfile" width="100" height="100"  name="profile_img" <?php if($user && $user->profile_img): ?> src="<?php echo e($user->profile_img); ?>" <?php endif; ?> alt="Preview" />
                        </div>
                  </div>
                  <div class="col-md-6">
...
<?php /**PATH /home/insighthub/public_html/resources/views/Employee/MyProfile/edit.blade.php ENDPATH**/ ?>