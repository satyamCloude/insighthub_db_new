   ...
   <div class="card">
      <div class="row">
         ...
         <div class="col-md-6 text-end">
            <a href="<?php echo e(url('Employee/Goal/home')); ?>" class="btn btn-warning mt-3 m-3"><i class="fas fa-sync-alt"></i></a>
            <?php if($RoleAccess[array_search('Goal', array_column($RoleAccess, 'per_name'))]['add'] == 1): ?>
            <a href="<?php echo e(url('Employee/Goal/add')); ?>" class="btn btn-primary mt-3 m-3">Add Goal</a>
            <?php endif; ?>
         </div>
      </div>
            ...
            <table class="dt-responsive table dataTable dtr-column" id="DataTables_Table_3" aria-describedby="DataTables_Table_3_info">
               ...
               <tbody id="result">
                ...
                <tr class="odd">
                     ...
                     <td>
                        <img class="rounded-circle" style="margin-right: 15px;margin-top: 10px;" src="<?php echo e(isset($user->profile_img) ? $user->profile_img : url('public/images/21104.png')); ?>" height="30" width="30" alt="User avatar" /><a href="<?php echo e(url('Employee/Goal/view/'.$user->id.'/'.$user->employee_id)); ?>"><?php echo e($user->first_name); ?></a>
                    ...
                    <td>
                        ...
                        <div class="btn-group">
                          ...
                          <ul class="dropdown-menu dropdown-menu-end" style="">
                              <!--<?php if($RoleAccess[array_search('Goal', array_column($RoleAccess, 'per_name'))]['update'] == 1): ?>-->
                              <!--    <li><a class="dropdown-item" href="<?php echo e(url('Employee/Goal/edit/'.$user->id)); ?>">Edit</a></li>-->
                              <!--<?php endif; ?>-->
                              <li><a class="dropdown-item" href="<?php echo e(url('Employee/Goal/edit/'.$user->id)); ?>">Edit</a></li>
                              <?php if($RoleAccess[array_search('Goal', array_column($RoleAccess, 'per_name'))]['delete'] == 1): ?>
                              <li><button class="dropdown-item delete_debtcase" url="<?php echo e(url('Employee/Goal/delete/'.$user->id)); ?>" id="<?php echo e($user->id); ?>">Delete</button></li>
                              <?php endif; ?>
                          </ul>
                        </div>
                        <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/insighthub/public_html/resources/views/Employee/sales/Goal/home.blade.php ENDPATH**/ ?>